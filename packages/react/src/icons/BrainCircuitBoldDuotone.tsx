...
const BrainCircuitBoldDuotone = memo(
  forwardRef<SVGSVGElement, BrainCircuitBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14.69 15a1 1 0 0 1 .87.5l.9 1.55a3 3 0 0 0-1.74 1l-.6-1.05H13v-2zM17.17 12a3 3 0 0 0 0 2H13v-2zM18 9a1 1 0 0 1-1 1h-4V8h3V6.83a3 3 0 0 0 2 0z" />
...
export { BrainCircuitBoldDuotone };
