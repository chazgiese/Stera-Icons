...
const ChevronSquareLeftIconBoldDuotone = memo(
...
ChevronSquareLeftIconBoldDuotone.displayName =
  "ChevronSquareLeftIconBoldDuotone";
export { ChevronSquareLeftIconBoldDuotone };
