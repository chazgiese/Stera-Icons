...
const UserBanRegularDuotone = memo(
  forwardRef<SVGSVGElement, UserBanRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M18.5 14.25a4.25 4.25 0 0 1 3.02 7.24l-.01.01-.01.01a4.23 4.23 0 0 1-7.25-3.01c0-1.17.47-2.22 1.23-2.99l.02-.02.03-.03a4.2 4.2 0 0 1 2.97-1.21m-2.4 2.9q-.34.6-.35 1.35a2.75 2.75 0 0 0 4.1 2.4zm2.4-1.4q-.73.01-1.34.35l3.74 3.73q.34-.6.35-1.33a2.75 2.75 0 0 0-2.75-2.75" clipRule="evenodd" />
