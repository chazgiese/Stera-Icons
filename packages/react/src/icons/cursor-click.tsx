    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M8.329 10.24c-.393-1.181.73-2.305 1.912-1.912l10.475 3.492c1.404.468 1.369 2.466-.051 2.884l-4.607 1.355-1.353 4.605c-.418 1.42-2.417 1.456-2.885.051zm1.426-.486-.005.007 3.493 10.48q.002.006.003.007l.009.001.008-.002.003-.006 1.47-4.998.032-.088a.75.75 0 0 1 .476-.42l4.997-1.47.007-.002.002-.009-.001-.009-.007-.002L9.767 9.75l-.006-.002z"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
          d="M4.47 12.469a.751.751 0 0 1 1.061 1.06l-1.415 1.416a.75.75 0 0 1-1.06-1.062zM1.514 6.995a.75.75 0 0 1 .92-.53l1.931.518a.75.75 0 1 1-.389 1.448l-1.931-.518a.75.75 0 0 1-.53-.918M13.884 3.055a.751.751 0 0 1 1.061 1.06L13.53 5.532a.75.75 0 0 1-1.06-1.062zM6.995 1.514c.4-.107.81.13.918.53l.517 1.932a.75.75 0 1 1-1.448.388l-.517-1.932a.75.75 0 0 1 .53-.918"
        />
      </svg>
    ))
);
