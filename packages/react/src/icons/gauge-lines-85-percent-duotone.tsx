...
const GaugeLines85PercentIconDuotone = memo(
...
GaugeLines85PercentIconDuotone.displayName = "GaugeLines85PercentIconDuotone";
export { GaugeLines85PercentIconDuotone };
