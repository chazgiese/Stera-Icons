...
const TvPlayAltIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.393 9.729c.322-.035.715.19 1.5.64l2.175 1.242c.797.455 1.196.683 1.33.981a1 1 0 0 1 0 .816c-.134.298-.533.526-1.33.98l-2.174 1.244c-.786.45-1.18.673-1.501.639a1 1 0 0 1-.703-.408c-.19-.262-.19-.714-.19-1.62v-2.486c0-.905 0-1.358.19-1.62a1 1 0 0 1 .703-.408M9.054 1.606a1 1 0 0 1 1.34.448L11.865 5H9.63L8.606 2.946a1 1 0 0 1 .448-1.34M13.106 3.053a1 1 0 0 1 1.789.894L14.368 5h-2.236z"
        />
      </svg>
    ))
);
TvPlayAltIconFillDuotone.displayName = "TvPlayAltIconFillDuotone";
export { TvPlayAltIconFillDuotone };
