...
const GaugeLines15PercentIconDuotone = memo(
...
GaugeLines15PercentIconDuotone.displayName = "GaugeLines15PercentIconDuotone";
export { GaugeLines15PercentIconDuotone };
