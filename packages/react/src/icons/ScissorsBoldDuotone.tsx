...
const ScissorsBoldDuotone = memo(
  forwardRef<SVGSVGElement, ScissorsBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M22.28 16.48a.5.5 0 0 1 .2.66 1.8 1.8 0 0 1-2.14.9l-9.04-2.77-.4-.16 4.51-2.6z" />
        <path fillRule="evenodd" d="M1.5 5.63a3.5 3.5 0 0 1 6.43 2.56l1.33.77q-.31.4-.5.88l-.37.93-1.46-.85A3.5 3.5 0 0 1 1.5 5.63m3.78.45a1.5 1.5 0 1 0-1.5 2.6 1.5 1.5 0 0 0 1.5-2.6" clipRule="evenodd" />
