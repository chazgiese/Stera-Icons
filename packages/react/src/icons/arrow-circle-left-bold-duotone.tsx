...
const ArrowCircleLeftIconBoldDuotone = memo(
...
ArrowCircleLeftIconBoldDuotone.displayName = "ArrowCircleLeftIconBoldDuotone";
export { ArrowCircleLeftIconBoldDuotone };
