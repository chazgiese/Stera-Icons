...
const ChartDonutFillDuotone = memo(
  forwardRef<SVGSVGElement, ChartDonutFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M22.5 8.73a11 11 0 0 1-2.05 10.3l-5.15-5.15a3.8 3.8 0 0 0 .47-2.36zM13 1.05a11 11 0 0 1 8.74 5.83L15 9.68a3.8 3.8 0 0 0-2-1.34z" />
