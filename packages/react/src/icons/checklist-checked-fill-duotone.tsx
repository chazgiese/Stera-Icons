...
const ChecklistCheckedIconFillDuotone = memo(
...
ChecklistCheckedIconFillDuotone.displayName = "ChecklistCheckedIconFillDuotone";
export { ChecklistCheckedIconFillDuotone };
