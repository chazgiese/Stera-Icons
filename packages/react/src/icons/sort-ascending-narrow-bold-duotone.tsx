...
const SortAscendingNarrowIconBoldDuotone = memo(
...
SortAscendingNarrowIconBoldDuotone.displayName =
  "SortAscendingNarrowIconBoldDuotone";
export { SortAscendingNarrowIconBoldDuotone };
