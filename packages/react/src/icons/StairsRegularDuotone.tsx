...
const StairsRegularDuotone = memo(
  forwardRef<SVGSVGElement, StairsRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M2.75 16.83c0 .42.34.75.75.75h.75v4.92a.75.75 0 0 1-1.5 0z" />
        <path fillRule="evenodd" d="M10.16 17.58" clipRule="evenodd" />
        <path d="M16.08 3.5c0 .41.34.75.75.75h.75v5.92a.75.75 0 0 0-.75-.75h-.75zM10.17 10.92a.75.75 0 0 1-.75-.75v5.91h.75c.41 0 .75.34.75.75v-5.91z" />
