...
const ChartWaterfallXYIconFillDuotone = memo(
...
ChartWaterfallXYIconFillDuotone.displayName = "ChartWaterfallXYIconFillDuotone";
export { ChartWaterfallXYIconFillDuotone };
