...
const CurveEaseIconLinetone = memo(
      ...
      >
        <g fill="currentColor" opacity={0.32}>
          <path
            ...
            clipRule="evenodd"
          />
          <path d="M10.54 4.005a1 1 0 0 1 0 1.99L10.438 6H10a1 1 0 0 1 0-2h.438zM13.603 4.005a1 1 0 0 1 0 1.99L13.5 6h-.437a1 1 0 1 1 0-2h.437z" />
          <path
            fillRule="evenodd"
            d="M19 16a3 3 0 1 1 0 6 3 3 0 0 1 0-6m0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2"
            clipRule="evenodd"
          />
          <path d="M10.938 18a1 1 0 1 1 0 2H10.5a1 1 0 1 1 0-2zM14 18a1 1 0 0 1 0 2h-.437a1 1 0 1 1 0-2z" />
        </g>
        <path
          fill="currentColor"
...
CurveEaseIconLinetone.displayName = "CurveEaseIconLinetone";
export { CurveEaseIconLinetone };
