...
const BracketsCurlyCircleIconDuotone = memo(
...
BracketsCurlyCircleIconDuotone.displayName = "BracketsCurlyCircleIconDuotone";
export { BracketsCurlyCircleIconDuotone };
