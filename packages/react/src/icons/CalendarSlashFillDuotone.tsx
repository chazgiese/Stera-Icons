...
const CalendarSlashFillDuotone = memo(
  forwardRef<SVGSVGElement, CalendarSlashFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12.97 17.78a2.25 2.25 0 0 1-3-3zM11.03 13.72a2.25 2.25 0 0 1 3 3z" />
        <path fillRule="evenodd" d="M21.5 10.4v4.2q.02 1.65-.06 2.7a5 5 0 0 1-.48 1.97 5 5 0 0 1-2.19 2.19c-.6.3-1.23.42-1.96.48q-1.06.08-2.71.06H9.9q-1.65.02-2.7-.06a5 5 0 0 1-1.97-.48 5 5 0 0 1-2.19-2.19c-.3-.6-.42-1.23-.48-1.96q-.07-1.06-.06-2.71V10h19zm-6.85 2.7a3.75 3.75 0 1 0-5.3 5.3 3.75 3.75 0 0 0 5.3-5.3" clipRule="evenodd" />
...
export { CalendarSlashFillDuotone };
