...
const BracketsSquareSquareIconLinetone = memo(
...
BracketsSquareSquareIconLinetone.displayName =
  "BracketsSquareSquareIconLinetone";
export { BracketsSquareSquareIconLinetone };
