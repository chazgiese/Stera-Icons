...
const AudioBarsCircleIconFillDuotone = memo(
...
AudioBarsCircleIconFillDuotone.displayName = "AudioBarsCircleIconFillDuotone";
export { AudioBarsCircleIconFillDuotone };
