...
const FlowMergeFillDuotone = memo(
  forwardRef<SVGSVGElement, FlowMergeFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.8 13.8a1 1 0 0 1 1.4 1.4l-6.5 6.5a1 1 0 0 1-1.4-1.4zM1.3 2.3a1 1 0 0 1 1.4 0l7.25 7.24A5 5 0 0 0 13.49 11h3.01v2h-3.01a7 7 0 0 1-4.95-2.05L1.29 3.71a1 1 0 0 1 0-1.42" />
