...
const ChartPieAltRegular = memo(
  forwardRef<SVGSVGElement, ChartPieAltRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M7.7 2.14a.75.75 0 0 1 .6 1.38 9.25 9.25 0 0 0 7.08 17.1.75.75 0 1 1 .54 1.4q-1.83.72-3.92.73a10.75 10.75 0 0 1-4.3-20.6" />
