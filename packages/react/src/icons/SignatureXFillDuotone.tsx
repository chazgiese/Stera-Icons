...
const SignatureXFillDuotone = memo(
  forwardRef<SVGSVGElement, SignatureXFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.57 16.5a21 21 0 0 1-1.73 2.55q-.18.22-.25.45H2a1.5 1.5 0 0 1 0-3zM22 16.5a1.5 1.5 0 1 1 0 3H9.23q.93-1.38 1.76-3h5.1c.36.28.82.5 1.41.5.62 0 1.19-.24 1.63-.5zM4.3 11.3a1 1 0 1 1 1.4 1.4l-.79.8.8.8a1 1 0 0 1-1.42 1.4l-.79-.79-.8.8a1 1 0 1 1-1.4-1.42l.79-.79-.8-.8a1 1 0 0 1 1.42-1.4l.79.79z" />
