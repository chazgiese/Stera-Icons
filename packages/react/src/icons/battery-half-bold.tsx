...
const BatteryHalfIconBold = memo(
  ...
  IconProps >
    ((
      ...
      <svg
        ...
        {...props}
      >
        <g fill="currentColor" clipPath="url(#clip0_5049_7657)">
...
BatteryHalfIconBold.displayName = "BatteryHalfIconBold";
export { BatteryHalfIconBold };
