...
const FlowSplitSquareRightIconBoldDuotone = memo(
...
FlowSplitSquareRightIconBoldDuotone.displayName =
  "FlowSplitSquareRightIconBoldDuotone";
export { FlowSplitSquareRightIconBoldDuotone };
