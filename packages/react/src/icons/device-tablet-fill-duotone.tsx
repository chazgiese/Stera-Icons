...
const DeviceTabletIconFillDuotone = memo(
...
DeviceTabletIconFillDuotone.displayName = "DeviceTabletIconFillDuotone";
export { DeviceTabletIconFillDuotone };
