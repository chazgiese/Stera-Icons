  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M.793 4.293a1 1 0 0 1 1.414 0L9.5 11.586l2.793-2.793a1 1 0 0 1 1.414 0l9.5 9.5a1 1 0 0 1-1.414 1.414L13 10.914l-2.793 2.793a1 1 0 0 1-1.34.066l-.074-.066-8-8a1 1 0 0 1 0-1.414"
          opacity={0.32}
        />
        <path
          fill="currentColor"
