...
const ChevronFullSquareDownIconFilltone = memo(
...
ChevronFullSquareDownIconFilltone.displayName =
  "ChevronFullSquareDownIconFilltone";
export { ChevronFullSquareDownIconFilltone };
