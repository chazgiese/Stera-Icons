...
const UserBanIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 3.5a5 5 0 0 1 2.593 9.275c1.273.288 2.39.8 3.302 1.518a4.24 4.24 0 0 0-2.398 1.198l-.178.19A4.23 4.23 0 0 0 14.25 18.5c0 .723.181 1.404.5 2H7.2c-.948 0-1.614.016-2.278-.441-.253-.175-.489-.465-.662-.739s-.337-.61-.387-.914a2.3 2.3 0 0 1 .016-.94c.066-.272.187-.526.31-.786.953-2.027 2.805-3.362 5.207-3.905A5 5 0 0 1 12 3.5"
          opacity={0.4}
        />
      </svg>
    ))
);
UserBanIconFillDuotone.displayName = "UserBanIconFillDuotone";
export { UserBanIconFillDuotone };
