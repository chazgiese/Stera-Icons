    ...
    ((
      ...
      >
        ...
        <g fill="currentColor" opacity={0.4}>
          <path d="M4.815 4.593c.286-.133.617-.124.895.024l2.797 1.495a9 9 0 0 0-1.139 1.66l-1.426-.763-.445 2.119A9 9 0 0 0 4 9h-.52l.78-3.707.03-.114c.087-.257.276-.471.525-.587M18.398 4.567a1.002 1.002 0 0 1 1.343.727L20.521 9h-.524q-.764 0-1.494.126l-.444-2.118-1.428.762a9 9 0 0 0-1.139-1.659l2.799-1.495z" />
        </g>
      </svg>
    ))
);
LotusIconLinetone.displayName = "LotusIconLinetone";
export { LotusIconLinetone };
