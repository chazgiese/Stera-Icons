...
const ChevronFullSquareRightIconLinetone = memo(
...
ChevronFullSquareRightIconLinetone.displayName =
  "ChevronFullSquareRightIconLinetone";
export { ChevronFullSquareRightIconLinetone };
