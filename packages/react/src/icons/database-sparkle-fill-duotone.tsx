    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M4.47 14.518c1.383.736 3.553 1.287 6.114 1.438-.584 1.076-.192 2.596 1.179 3.074l.692.241a3.7 3.7 0 0 1 2.274 2.274l.24.692q.104.29.261.52A21 21 0 0 1 12 23c-2.297 0-4.422-.348-6.008-.942-.79-.296-1.498-.673-2.027-1.142C3.437 20.448 3 19.803 3 19v-5.265z" />
          <path
            fillRule="evenodd"
