...
const RotateCircleLeftIconFillDuotone = memo(
...
RotateCircleLeftIconFillDuotone.displayName = "RotateCircleLeftIconFillDuotone";
export { RotateCircleLeftIconFillDuotone };
