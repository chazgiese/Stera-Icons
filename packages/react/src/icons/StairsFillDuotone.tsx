...
const StairsFillDuotone = memo(
  forwardRef<SVGSVGElement, StairsFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M2 16.83c0 .83.67 1.5 1.5 1.5H5v4.17a1.5 1.5 0 0 1-3 0zM10.19 8.67h-.02a1.5 1.5 0 1 0 0 3h1.5v5.16c0 .83-.67 1.5-1.5 1.5h-.02.02a1.5 1.5 0 0 0 0-3h-1.5v-5.16c0-.83.67-1.5 1.5-1.5zM15.33 3.5c0 .83.67 1.5 1.5 1.5h1.5v5.15a1.5 1.5 0 0 0-1.5-1.48h-1.5z" />
