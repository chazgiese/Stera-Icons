...
const BracketsCurlyCircleIconLinetone = memo(
...
BracketsCurlyCircleIconLinetone.displayName = "BracketsCurlyCircleIconLinetone";
export { BracketsCurlyCircleIconLinetone };
