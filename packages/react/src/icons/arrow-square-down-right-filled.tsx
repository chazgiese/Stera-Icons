...
const ArrowSquareDownRightIconFilled = memo(
...
ArrowSquareDownRightIconFilled.displayName = "ArrowSquareDownRightIconFilled";
export { ArrowSquareDownRightIconFilled };
