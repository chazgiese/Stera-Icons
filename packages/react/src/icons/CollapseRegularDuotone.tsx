...
const CollapseRegularDuotone = memo(
  forwardRef<SVGSVGElement, CollapseRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8.25 15.75v1.06l-3.72 3.72a.75.75 0 1 1-1.06-1.06l3.72-3.72zM20.53 19.47a.75.75 0 1 1-1.06 1.06l-3.72-3.72v-1.06h1.06zM19.47 3.47a.75.75 0 1 1 1.06 1.06l-3.72 3.72h-1.06V7.19zM3.47 3.47c.3-.3.77-.3 1.06 0l3.72 3.72v1.06H7.19L3.47 4.53a.75.75 0 0 1 0-1.06" />
