...
const HourglassFullIconLinetone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15.578 4.506a1 1 0 0 1 .88 1.147 3.5 3.5 0 0 1-1.271 2.197l-1.285 1.027c-.437.35-.777.767-1.022 1.22a1 1 0 0 1-1.76 0 4 4 0 0 0-1.022-1.22L8.814 7.85a3.5 3.5 0 0 1-1.272-2.197A1 1 0 0 1 8.53 4.5h6.94z"
        />
      </svg>
    ))
);
HourglassFullIconLinetone.displayName = "HourglassFullIconLinetone";
export { HourglassFullIconLinetone };
