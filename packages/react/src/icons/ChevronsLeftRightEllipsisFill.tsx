...
const ChevronsLeftRightEllipsisFill = memo(
  forwardRef<SVGSVGElement, ChevronsLeftRightEllipsisFillProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M5.94 5.94a1.5 1.5 0 1 1 2.12 2.12L4.12 12l3.94 3.94a1.5 1.5 0 1 1-2.12 2.12l-5-5a1.5 1.5 0 0 1 0-2.12zM15.94 5.94a1.5 1.5 0 0 1 2.12 0l5 5a1.5 1.5 0 0 1 0 2.12l-5 5a1.5 1.5 0 1 1-2.12-2.12L19.88 12l-3.94-3.94a1.5 1.5 0 0 1 0-2.12" />
...
export { ChevronsLeftRightEllipsisFill };
