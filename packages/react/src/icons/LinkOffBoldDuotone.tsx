...
const LinkOffBoldDuotone = memo(
  forwardRef<SVGSVGElement, LinkOffBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.06 10.46a1 1 0 0 1 1.41 1.41l-1.5 1.51a3.3 3.3 0 0 0 4.65 4.66l1.5-1.51a1 1 0 0 1 1.42 1.41l-1.5 1.51a5.3 5.3 0 0 1-7.49-7.48zM11.97 4.55a5.3 5.3 0 0 1 7.48 7.48l-1.5 1.51a1 1 0 0 1-1.42-1.41l1.5-1.51a3.3 3.3 0 0 0-4.65-4.66l-1.5 1.51a1 1 0 0 1-1.42-1.41z" />
