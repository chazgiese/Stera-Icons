...
const ChatBubbleAlertIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 12.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 6.75a.75.75 0 0 1 .75.75v3a.75.75 0 0 1-1.5 0v-3a.75.75 0 0 1 .75-.75"
        />
      </svg>
    ))
);
ChatBubbleAlertIconDuotone.displayName = "ChatBubbleAlertIconDuotone";
export { ChatBubbleAlertIconDuotone };
