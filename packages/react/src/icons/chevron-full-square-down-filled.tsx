...
const ChevronFullSquareDownIconFilled = memo(
...
ChevronFullSquareDownIconFilled.displayName = "ChevronFullSquareDownIconFilled";
export { ChevronFullSquareDownIconFilled };
