  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 4a4.5 4.5 0 0 1 2.788 8.032 1 1 0 0 0-.275 1.232l2.688 5.375a.25.25 0 0 1-.224.361H7.022a.25.25 0 0 1-.224-.361l2.688-5.375a1 1 0 0 0-.274-1.232A4.5 4.5 0 0 1 12 4"
          opacity={0.4}
        />
        <path
          fill="currentColor"
