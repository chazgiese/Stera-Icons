...
const FlowSplitSquareDownIconBoldDuotone = memo(
...
FlowSplitSquareDownIconBoldDuotone.displayName =
  "FlowSplitSquareDownIconBoldDuotone";
export { FlowSplitSquareDownIconBoldDuotone };
