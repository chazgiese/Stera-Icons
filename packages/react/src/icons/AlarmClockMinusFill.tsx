...
const AlarmClockMinusFill = memo(
  forwardRef<SVGSVGElement, AlarmClockMinusFillProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 4a9 9 0 0 1 6.25 15.47l1.53 1.9a1 1 0 0 1-1.56 1.25l-1.55-1.93a9 9 0 0 1-9.34 0l-1.55 1.93a1 1 0 0 1-1.56-1.25l1.52-1.9A9 9 0 0 1 12 4m-3 8a1 1 0 0 0 0 2h6.1a1 1 0 0 0 0-2H9" clipRule="evenodd" />
