...
const MacWindowCursorIconFill = memo(
  ...
  IconProps >
    ((
      ...
      <svg
        ...
        {...props}
      >
        <g fill="currentColor" clipPath="url(#clip0_3676_594)">
...
MacWindowCursorIconFill.displayName = "MacWindowCursorIconFill";
export { MacWindowCursorIconFill };
