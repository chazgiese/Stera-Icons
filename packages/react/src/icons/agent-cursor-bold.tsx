...
const AgentCursorIconBold = memo(
    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M11.127 13.111c-.396-1.188.687-2.32 1.87-2.017l.114.033 7.817 2.605c1.457.486 1.42 2.56-.054 2.994l-3.206.942-.942 3.206c-.434 1.473-2.508 1.51-2.994.054zm4.067 5.878.71-2.408a1 1 0 0 1 .677-.677l2.41-.71-5.694-1.897z"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
          d="M8.354 14.323a1 1 0 0 1 1.414 1.414l-1.055 1.056-.076.068a1.001 1.001 0 0 1-1.408-1.407l.069-.075zM6.034 10.436a1 1 0 0 1 1.225-.707l1.441.386a1 1 0 0 1-.517 1.932L6.74 11.66a1 1 0 0 1-.707-1.225M15.379 7.299a1 1 0 0 1 1.414 1.414l-1.055 1.055a1.001 1.001 0 0 1-1.415-1.414zM10.435 6.034a1 1 0 0 1 1.224.707l.387 1.442a1 1 0 0 1-1.933.517L9.728 7.26a1 1 0 0 1 .707-1.225"
        />
      </svg>
    ))
);
AgentCursorIconBold.displayName = "AgentCursorIconBold";
export { AgentCursorIconBold };
