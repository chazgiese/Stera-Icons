...
const ArrowLeftRightIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="m20.586 12-1 1H4.414l-1-1 1-1h15.172z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
ArrowLeftRightIconBoldDuotone.displayName = "ArrowLeftRightIconBoldDuotone";
export { ArrowLeftRightIconBoldDuotone };
