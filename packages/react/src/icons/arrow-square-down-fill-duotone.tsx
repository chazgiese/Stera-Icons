...
const ArrowSquareDownIconFillDuotone = memo(
...
ArrowSquareDownIconFillDuotone.displayName = "ArrowSquareDownIconFillDuotone";
export { ArrowSquareDownIconFillDuotone };
