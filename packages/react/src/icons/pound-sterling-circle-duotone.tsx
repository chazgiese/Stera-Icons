...
const PoundSterlingCircleIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M11.965 6.038c1.44-.207 3.088.428 4.1 2.055a.75.75 0 0 1-1.273.793c-.701-1.127-1.769-1.485-2.614-1.363-.851.122-1.428.694-1.428 1.517v2.004h2.393a.75.75 0 1 1 0 1.5H10.75v2.003c0 .58-.226 1.065-.52 1.453H16a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1-.287-1.443l.01-.004.048-.022q.069-.03.192-.094c.163-.086.376-.212.584-.37.459-.347.703-.703.703-1.02v-2.003H8a.75.75 0 0 1 0-1.5h1.25V9.04c0-1.715 1.28-2.795 2.715-3.002"
        />
      </svg>
    ))
);
PoundSterlingCircleIconDuotone.displayName = "PoundSterlingCircleIconDuotone";
export { PoundSterlingCircleIconDuotone };
