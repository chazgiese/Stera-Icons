...
const MusicFillDuotone = memo(
  forwardRef<SVGSVGElement, MusicFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M5.94 16.5c.58 0 1.06.48 1.06 1.06C7 18.91 5.9 20 4.56 20c-.58 0-1.06-.48-1.06-1.06 0-1.35 1.1-2.44 2.44-2.44M17.94 14.5c.58 0 1.06.48 1.06 1.06 0 1.35-1.1 2.44-2.44 2.44-.58 0-1.06-.48-1.06-1.06 0-1.35 1.1-2.44 2.44-2.44M18.7 4.23c.16-.03.3.1.3.25v1.67L9 7.82V6.06c0-.12.09-.23.2-.25z" />
