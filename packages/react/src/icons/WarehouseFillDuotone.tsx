...
const WarehouseFillDuotone = memo(
  forwardRef<SVGSVGElement, WarehouseFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M10.66 2.55a3 3 0 0 1 2.68 0l8 4A3 3 0 0 1 23 9.24V18a3 3 0 0 1-3 3h-2v-8.75c0-1.24-1-2.25-2.25-2.25h-7.5C7.01 10 6 11 6 12.25V21H4a3 3 0 0 1-3-3V9.24a3 3 0 0 1 1.66-2.69z" />
        <path d="M16 18v1H8v-1zM16 15v1H8v-1zM15.75 12q.23.02.25.25V13H8v-.75q.02-.23.25-.25z" />
