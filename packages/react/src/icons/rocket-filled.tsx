  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M13.5 19a1 1 0 0 1 1 1h-1c1 0 1 .002 1 .002v.024l-.002.033a1.7 1.7 0 0 1-.044.322c-.04.186-.113.423-.246.69-.27.542-.766 1.17-1.648 1.76l-.554.371-.555-.37c-.886-.588-1.385-1.216-1.657-1.759a3 3 0 0 1-.248-.691 2 2 0 0 1-.044-.323l-.002-.033v-.024s0-.002 1-.002h-1a1 1 0 0 1 1-1z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M11.575 1.095a1 1 0 0 1 .98.073C14.95 2.765 16.4 4.6 17.188 6.49c.425 1.02.647 2.037.73 3.014l2.789 2.789c.225.225.33.544.281.86l-1 6.5a1 1 0 0 1-1.518.695L14.714 18H9.286L5.53 20.348a1 1 0 0 1-1.518-.696l-1-6.5a1 1 0 0 1 .28-.86L6.08 9.506c.083-.977.306-1.994.731-3.015C7.6 4.6 9.05 2.765 11.445 1.168zm-6.51 12.253.692 4.499 1.898-1.187a14.7 14.7 0 0 1-1.47-4.433zm12.748-1.12a14.5 14.5 0 0 1-1.47 4.432l1.9 1.187.693-4.499zM12 7a1.75 1.75 0 1 0 0 3.5A1.75 1.75 0 0 0 12 7"
          clipRule="evenodd"
        />
      </svg>
    ))
