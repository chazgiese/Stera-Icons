  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M13.5 19a1 1 0 0 1 1 1h-1c1 0 1 .002 1 .002v.024l-.002.034a2 2 0 0 1-.044.321c-.04.186-.113.423-.246.69-.27.542-.766 1.17-1.647 1.76l-.555.371-.555-.369c-.885-.589-1.385-1.217-1.657-1.76a3 3 0 0 1-.248-.691 2 2 0 0 1-.044-.322l-.002-.034v-.024s0-.002 1-.002h-1a1 1 0 0 1 1-1z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
        ...
        <path
          fill="currentColor"
          d="M13.5 19a1 1 0 0 1 1 1h-1c1 0 1 .002 1 .002v.024l-.002.033a2 2 0 0 1-.044.322c-.04.186-.113.423-.246.69-.27.542-.766 1.17-1.647 1.76l-.555.371-.555-.37c-.885-.588-1.385-1.216-1.657-1.759a3 3 0 0 1-.248-.691 2 2 0 0 1-.044-.323l-.002-.033v-.024s0-.002 1-.002h-1a1 1 0 0 1 1-1z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
