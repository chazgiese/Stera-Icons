...
const ChevronFullCircleRightIconBoldDuotone = memo(
...
ChevronFullCircleRightIconBoldDuotone.displayName =
  "ChevronFullCircleRightIconBoldDuotone";
export { ChevronFullCircleRightIconBoldDuotone };
