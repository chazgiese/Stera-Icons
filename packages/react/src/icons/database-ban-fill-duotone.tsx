...
const DatabaseBanIconFillDuotone = memo(
    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M4.47 14.518c1.383.736 3.553 1.287 6.114 1.438q-.083.51-.084 1.044a6.5 6.5 0 0 0 3.74 5.885c-.719.074-1.47.115-2.24.115-2.297 0-4.422-.348-6.008-.942-.79-.296-1.498-.673-2.027-1.142C3.437 20.448 3 19.803 3 19v-5.265z" />
          <path
            fillRule="evenodd"
...
DatabaseBanIconFillDuotone.displayName = "DatabaseBanIconFillDuotone";
export { DatabaseBanIconFillDuotone };
