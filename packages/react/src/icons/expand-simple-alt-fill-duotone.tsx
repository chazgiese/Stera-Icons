...
const ExpandSimpleAltIconFillDuotone = memo(
...
ExpandSimpleAltIconFillDuotone.displayName = "ExpandSimpleAltIconFillDuotone";
export { ExpandSimpleAltIconFillDuotone };
