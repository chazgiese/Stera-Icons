...
const HourglassEmptyIconBold = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 13.911c.383 0 .814.129 1.15.44l.14.146.191.215c.464.49 1.029.897 1.706 1.438a3.5 3.5 0 0 1 1.271 2.197 1 1 0 0 1-.988 1.153H8.53a1 1 0 0 1-.988-1.153 3.5 3.5 0 0 1 1.271-2.197c.774-.618 1.401-1.061 1.898-1.653l.139-.145c.336-.312.767-.44 1.15-.44"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
...
HourglassEmptyIconBold.displayName = "HourglassEmptyIconBold";
export { HourglassEmptyIconBold };
