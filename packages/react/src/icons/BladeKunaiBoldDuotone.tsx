...
const BladeKunaiBoldDuotone = memo(
  forwardRef<SVGSVGElement, BladeKunaiBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="m14.67 12.08-.68 4.08a1 1 0 0 1-.51.72l-11 6a1 1 0 0 1-1.36-1.36l6-11 .06-.1a1 1 0 0 1 .66-.4l4.08-.69zm-6.03-.17-4.13 7.58 7.58-4.14.7-4.13z" clipRule="evenodd" />
        <path d="M17.3 5.29a3 3 0 0 0 1.4 1.41L15.42 10 14 8.59z" />
