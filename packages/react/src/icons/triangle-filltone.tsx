  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M10.775 3.308a3 3 0 0 1 2.45 0c.894.4 1.577 1.595 2.942 3.985l3.73 6.526c1.347 2.358 2.02 3.537 1.916 4.504a3 3 0 0 1-1.222 2.106c-.788.57-2.146.571-4.862.571H8.272c-2.716 0-4.075 0-4.863-.571a3 3 0 0 1-1.222-2.106c-.105-.967.57-2.146 1.917-4.504l3.728-6.526c1.366-2.39 2.049-3.585 2.943-3.985"
          opacity={0.32}
        />
        <path
          fill="currentColor"
