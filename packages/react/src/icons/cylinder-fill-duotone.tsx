...
const CylinderIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 3c2.121 0 3.996.325 5.306.815.658.247 1.121.516 1.402.765.282.25.292.394.292.42s-.01.17-.292.42c-.28.249-.744.518-1.402.765C15.996 6.675 14.12 7 12 7s-3.997-.325-5.306-.815c-.658-.247-1.121-.516-1.402-.765C5.01 5.17 5 5.026 5 5s.01-.17.292-.42c.28-.249.744-.518 1.402-.765C8.004 3.325 9.88 3 12 3"
          opacity={0.4}
        />
      </svg>
    ))
);
CylinderIconFillDuotone.displayName = "CylinderIconFillDuotone";
export { CylinderIconFillDuotone };
