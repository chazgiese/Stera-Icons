  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M4.673 3.783c1.07-1.71 3.586-1.71 4.655 0l.101.177 3.897 7.335q.002.007.006.014L17 18.213l3.676-6.918a1.5 1.5 0 0 1 2.649 1.408l-3.896 7.332-.102.177c-1.07 1.71-3.584 1.71-4.653 0l-.102-.177-3.893-7.326-.004-.007-3.674-6.92-3.675 6.92a1.5 1.5 0 0 1-2.65-1.407L4.571 3.96z"
        />
      </svg>
    ))
);
