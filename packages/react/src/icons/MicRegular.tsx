...
const MicRegular = memo(
  forwardRef<SVGSVGElement, MicRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M20 10.25c.41 0 .75.34.75.75a8.75 8.75 0 0 1-8 8.72v1.53H15a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5h2.25v-1.53a8.75 8.75 0 0 1-8-8.72.75.75 0 0 1 1.5 0 7.25 7.25 0 1 0 14.5 0c0-.41.34-.75.75-.75" />
