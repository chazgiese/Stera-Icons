  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M15.5 8.919c0 .531.14 1.053.408 1.512l4.701 8.057c1.167 2-.276 4.512-2.591 4.512H5.982c-2.315 0-3.758-2.512-2.591-4.512l4.7-8.057c.268-.459.409-.981.409-1.512V3h2v5.919c0 .885-.235 1.754-.68 2.518l-4.702 8.06A1 1 0 0 0 5.982 21h12.036a1 1 0 0 0 .864-1.504l-3.652-6.26-1.05-1.799a5 5 0 0 1-.68-2.518V3h2z"
          opacity={0.4}
        />
