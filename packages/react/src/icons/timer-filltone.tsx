  ...
  IconProps >
    ((
      ...
      <svg
        ...
        {...props}
      >
        <g fill="currentColor" clipPath="url(#clip0_3425_16300)">
          <path
            ...
            opacity={0.32}
          />
          <path d="M6.344 6.342a1 1 0 0 1 1.249-.133l5.477 3.544c.303.196.985.608 1.269 1.36a2.501 2.501 0 0 1-3.224 3.224c-.752-.284-1.164-.966-1.36-1.269L6.21 7.591l-.044-.075a1 1 0 0 1 .177-1.174" />
        </g>
      </svg>
    ))
);
