...
const SquarePlaceholderRegularDuotone = memo(
  forwardRef<SVGSVGElement, SquarePlaceholderRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.76 20.25H9.64l-5.88-5.89L3.75 13v-.76zM17.75 19.87c-.38.16-.85.26-1.53.31l-.26.02L3.8 8.04q0-.14.02-.26c.05-.68.15-1.15.3-1.53zM20.2 15.96q0 .14-.02.26a5 5 0 0 1-.31 1.53L6.25 4.13c.38-.16.85-.26 1.53-.31l.26-.02zM13 3.75h1.36l5.88 5.89.01 1.36v.77l-8.02-8.02z" />
...
export { SquarePlaceholderRegularDuotone };
