...
const UserXIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 3.5a5 5 0 0 1 2.593 9.275c1.77.4 3.24 1.232 4.273 2.452a1 1 0 0 0-.072.065L17.5 16.584l-1.294-1.292a1 1 0 0 0-1.412 1.416l1.291 1.29-1.293 1.296a1 1 0 0 0-.156 1.206H7.2c-.948 0-1.614.016-2.278-.441-.253-.175-.488-.465-.662-.739s-.337-.61-.387-.914a2.3 2.3 0 0 1 .016-.94c.066-.272.187-.526.31-.786.953-2.027 2.805-3.362 5.207-3.905A5 5 0 0 1 12 3.5"
          opacity={0.4}
        />
      </svg>
    ))
);
UserXIconFillDuotone.displayName = "UserXIconFillDuotone";
export { UserXIconFillDuotone };
