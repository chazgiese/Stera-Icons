...
const AlertSquareIconFillDuotone = memo(
...
AlertSquareIconFillDuotone.displayName = "AlertSquareIconFillDuotone";
export { AlertSquareIconFillDuotone };
