...
const VideoIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M21.375 6.219a1.001 1.001 0 0 1 1.625.78v10a1 1 0 0 1-1.625.782l-3.408-2.726c.03-.513.033-1.127.033-1.855v-.682l3 2.4V9.08l-3 2.4V10.8c0-.729-.002-1.343-.033-1.856z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
VideoIconBoldDuotone.displayName = "VideoIconBoldDuotone";
export { VideoIconBoldDuotone };
