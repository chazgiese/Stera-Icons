  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M18.97 15.469a.751.751 0 0 1 1.06 1.062l-1.47 1.466 1.471 1.473a.751.751 0 0 1-1.062 1.06l-1.47-1.471-1.468 1.471a.751.751 0 0 1-1.062-1.06l1.47-1.473-1.47-1.466a.751.751 0 0 1 1.061-1.062l1.47 1.467z"
        />
      </svg>
    ))
);
