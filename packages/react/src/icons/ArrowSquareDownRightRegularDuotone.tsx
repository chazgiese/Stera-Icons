...
const ArrowSquareDownRightRegularDuotone = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownRightRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M7.47 7.47c.3-.3.77-.3 1.06 0l6.72 6.72V9a.75.75 0 0 1 1.5 0v7c0 .41-.34.75-.75.75H9a.75.75 0 0 1 0-1.5h5.19L7.47 8.53a.75.75 0 0 1 0-1.06" />
