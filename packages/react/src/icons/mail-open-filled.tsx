  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M9.517 2.583a4.2 4.2 0 0 1 4.966 0l5.801 4.253c.44.323.805.722 1.084 1.173l-.95.679-.01.007-6.708 4.919a2 2 0 0 1-1.182.387h-1.37c-.442 0-.872-.146-1.222-.417L3.61 8.71l-.014-.01-.016-.011-.95-.679c.28-.45.646-.85 1.085-1.173z"
        />
      </svg>
    ))
);
