...
const GitPullRequestDraftIconFillDuotone = memo(
...
GitPullRequestDraftIconFillDuotone.displayName =
  "GitPullRequestDraftIconFillDuotone";
export { GitPullRequestDraftIconFillDuotone };
