...
const DatabasePlusIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M16.005 11.25a.75.75 0 0 1 .75.75v3.25h3.25a.75.75 0 0 1 0 1.5h-3.25V20a.75.75 0 0 1-1.5 0v-3.25h-3.25a.75.75 0 0 1 0-1.5h3.25V12a.75.75 0 0 1 .75-.75"
        />
      </svg>
    ))
);
DatabasePlusIconDuotone.displayName = "DatabasePlusIconDuotone";
export { DatabasePlusIconDuotone };
