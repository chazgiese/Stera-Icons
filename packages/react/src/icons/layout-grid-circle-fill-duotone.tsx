...
const LayoutGridCircleIconFillDuotone = memo(
...
LayoutGridCircleIconFillDuotone.displayName = "LayoutGridCircleIconFillDuotone";
export { LayoutGridCircleIconFillDuotone };
