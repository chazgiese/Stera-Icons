...
const LayersAltBoldDuotone = memo(
  forwardRef<SVGSVGElement, LayersAltBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M20.55 15.6a1 1 0 0 1 .9 1.8L14.24 21a5 5 0 0 1-4.48 0l-7.2-3.6a1 1 0 0 1 .89-1.8l7.2 3.61a3 3 0 0 0 2.7 0z" />
        <path d="M20.55 11.6a1 1 0 0 1 .9 1.8L14.24 17a5 5 0 0 1-4.48 0l-7.2-3.6a1 1 0 0 1 .89-1.8l7.2 3.61a3 3 0 0 0 2.7 0z" />
