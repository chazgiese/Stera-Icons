...
const FlowSplitArrowUpIconBoldDuotone = memo(
...
FlowSplitArrowUpIconBoldDuotone.displayName = "FlowSplitArrowUpIconBoldDuotone";
export { FlowSplitArrowUpIconBoldDuotone };
