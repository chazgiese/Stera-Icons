    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M19 14a5 5 0 1 1 0 10 5 5 0 0 1 0-10m-2 4.25a.75.75 0 0 0 0 1.5h4a.75.75 0 0 0 0-1.5z"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
...
MailMinusIconBold.displayName = "MailMinusIconBold";
export { MailMinusIconBold };
