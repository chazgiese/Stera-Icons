    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M22.281 16.475a.5.5 0 0 1 .195.661c-.4.78-1.301 1.16-2.138.903l-9.04-2.77a2.5 2.5 0 0 1-.393-.16l4.506-2.6z" />
          <path
            fillRule="evenodd"
            d="M1.5 5.63a3.5 3.5 0 0 1 6.435 2.562l1.326.766c-.209.266-.38.564-.506.886l-.36.922-1.46-.842A3.5 3.5 0 0 1 1.5 5.63m3.781.45a1.5 1.5 0 1 0-1.498 2.6 1.5 1.5 0 0 0 1.498-2.6"
            clipRule="evenodd"
          />
        </g>
        <path
