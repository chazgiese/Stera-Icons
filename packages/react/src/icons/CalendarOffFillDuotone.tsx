...
const CalendarOffFillDuotone = memo(
  forwardRef<SVGSVGElement, CalendarOffFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M19.55 20.96q-.37.28-.78.5c-.6.3-1.23.42-1.96.48q-1.06.08-2.71.06H9.9q-1.65.02-2.7-.06a5 5 0 0 1-1.97-.48 5 5 0 0 1-2.19-2.19c-.3-.6-.42-1.23-.48-1.96q-.07-1.06-.06-2.71V10H8.6zM21.5 10.4v4.2q.02 1.65-.06 2.7l-.02.2-7.5-7.5h7.58z" />
