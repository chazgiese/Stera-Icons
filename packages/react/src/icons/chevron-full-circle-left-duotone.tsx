...
const ChevronFullCircleLeftIconDuotone = memo(
...
ChevronFullCircleLeftIconDuotone.displayName =
  "ChevronFullCircleLeftIconDuotone";
export { ChevronFullCircleLeftIconDuotone };
