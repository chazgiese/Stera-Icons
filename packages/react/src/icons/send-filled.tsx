  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M19.178 2.113c1.675-.557 3.268 1.036 2.71 2.711l-5.237 15.711c-.664 1.991-3.497 1.941-4.09-.072l-1.729-5.882 5.875-5.874a1 1 0 0 0-1.414-1.414l-5.875 5.874-5.88-1.727c-2.013-.593-2.063-3.426-.072-4.09z"
        />
      </svg>
    ))
);
