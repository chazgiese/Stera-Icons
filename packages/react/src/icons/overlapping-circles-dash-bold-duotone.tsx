...
const OverlappingCirclesDashIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M8.5 4.5a7.47 7.47 0 0 1 4.04 1.18 1 1 0 0 1-.218 1.787.999.999 0 0 0-1.388-1.417q-.421.323-.791.702a5.5 5.5 0 1 0 0 10.495q.37.38.79.703a1 1 0 0 0 1.39-1.418 1 1 0 0 1 .217 1.788A7.5 7.5 0 1 1 8.5 4.5"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
OverlappingCirclesDashIconBoldDuotone.displayName =
  "OverlappingCirclesDashIconBoldDuotone";
export { OverlappingCirclesDashIconBoldDuotone };
