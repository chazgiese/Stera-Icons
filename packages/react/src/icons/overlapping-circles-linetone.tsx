...
const OverlappingCirclesIconLinetone = memo(
...
OverlappingCirclesIconLinetone.displayName = "OverlappingCirclesIconLinetone";
export { OverlappingCirclesIconLinetone };
