    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M15.88 1.436a.75.75 0 0 1 1.208.793l-2.4 7.483 4.557 1.579a.75.75 0 0 1 .25 1.272l-11.375 10a.75.75 0 0 1-1.21-.793l2.401-7.483-4.556-1.578a.752.752 0 0 1-.25-1.273zM6.462 11.712l4.033 1.397a.75.75 0 0 1 .469.938l-1.796 5.597 8.369-7.357-4.032-1.397a.75.75 0 0 1-.47-.937l1.796-5.599z"
          clipRule="evenodd"
        />
      </svg>
    ))
