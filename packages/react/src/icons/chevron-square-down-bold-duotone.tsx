...
const ChevronSquareDownIconBoldDuotone = memo(
...
ChevronSquareDownIconBoldDuotone.displayName =
  "ChevronSquareDownIconBoldDuotone";
export { ChevronSquareDownIconBoldDuotone };
