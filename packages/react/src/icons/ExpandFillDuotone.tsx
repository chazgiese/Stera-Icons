...
const ExpandFillDuotone = memo(
  forwardRef<SVGSVGElement, ExpandFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8.3 14.3a1 1 0 1 1 1.4 1.4L7.42 18 6 16.59zM14.3 14.3a1 1 0 0 1 1.4 0l2.3 2.29L16.59 18l-2.3-2.3a1 1 0 0 1 0-1.4M9.7 8.3a1 1 0 0 1-1.4 1.4L6 7.42 7.41 6zM18 7.41l-2.3 2.3a1 1 0 1 1-1.4-1.42L16.58 6z" />
