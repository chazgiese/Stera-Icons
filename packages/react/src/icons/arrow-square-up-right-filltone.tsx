...
const ArrowSquareUpRightIconFilltone = memo(
...
ArrowSquareUpRightIconFilltone.displayName = "ArrowSquareUpRightIconFilltone";
export { ArrowSquareUpRightIconFilltone };
