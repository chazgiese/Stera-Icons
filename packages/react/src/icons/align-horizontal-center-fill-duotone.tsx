...
const AlignHorizontalCenterIconFillDuotone = memo(
...
AlignHorizontalCenterIconFillDuotone.displayName =
  "AlignHorizontalCenterIconFillDuotone";
export { AlignHorizontalCenterIconFillDuotone };
