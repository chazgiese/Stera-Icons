  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M22 19.25a.75.75 0 1 1 0 1.5H2a.75.75 0 0 1 0-1.5zM20.4 3.55a.75.75 0 0 1 1.2.9l-6 8a.75.75 0 0 1-.935.22L9.207 9.942l-5.621 7.027a.75.75 0 0 1-1.172-.937l6-7.5a.75.75 0 0 1 .921-.202l5.44 2.72z"
        />
      </svg>
    ))
);
