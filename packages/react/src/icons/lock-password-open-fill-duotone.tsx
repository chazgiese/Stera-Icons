...
const LockPasswordOpenIconFillDuotone = memo(
...
LockPasswordOpenIconFillDuotone.displayName = "LockPasswordOpenIconFillDuotone";
export { LockPasswordOpenIconFillDuotone };
