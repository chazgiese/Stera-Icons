...
const AgentCursorIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M11.127 13.111c-.396-1.188.687-2.32 1.87-2.017l.114.033 7.817 2.605c1.457.486 1.42 2.56-.054 2.993l-3.206.943-.943 3.206c-.433 1.473-2.507 1.51-2.993.054zm4.067 5.878.71-2.408a1 1 0 0 1 .677-.677l2.41-.71-5.694-1.897z"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
          d="M8.353 14.323a1 1 0 0 1 1.414 1.414l-1.054 1.056-.076.07a1 1 0 0 1-1.408-1.409l.07-.075zM6.034 10.435a1 1 0 0 1 1.225-.707l1.441.387a1 1 0 1 1-.518 1.932l-1.441-.386a1 1 0 0 1-.707-1.226M15.379 7.299a1 1 0 0 1 1.414 1.414l-1.055 1.054a1 1 0 1 1-1.414-1.414zM10.434 6.034a1 1 0 0 1 1.225.707l.387 1.441a1 1 0 0 1-1.932.518l-.387-1.441a1 1 0 0 1 .707-1.225"
        />
      </svg>
    ))
);
AgentCursorIconBoldDuotone.displayName = "AgentCursorIconBoldDuotone";
export { AgentCursorIconBoldDuotone };
