...
const ArrowSquareDownLeftIconBoldDuotone = memo(
...
ArrowSquareDownLeftIconBoldDuotone.displayName =
  "ArrowSquareDownLeftIconBoldDuotone";
export { ArrowSquareDownLeftIconBoldDuotone };
