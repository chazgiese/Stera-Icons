    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M12.999 20.231V22a1 1 0 1 1-2 0v-1.769l1-.577zM5.37 15.827v1.154l-1.532.885a1 1 0 0 1-1-1.732l1.532-.885zM21.159 16.134a1 1 0 0 1-1 1.732l-1.531-.885v-1.154l1-.578zM12.999 10.268l3.629-2.096v.578c0 .357.191.688.5.866l.499.288L13.999 12l3.63 2.096-.5.29a1 1 0 0 0-.5.865l-.002.577L13 13.731v4.192l-.5-.288a1 1 0 0 0-.881-.059l-.12.059-.5.288V13.73L7.37 15.826v-.576a1 1 0 0 0-.39-.792l-.11-.073-.502-.29 3.63-2.096L6.37 9.904l.5-.288c.27-.156.45-.428.49-.733l.01-.133v-.578l3.629 2.096v-4.19l.5.288c.309.179.69.178 1 0l.5-.289zM2.473 6.5a1 1 0 0 1 1.365-.366l1.532.884v1.155l-1 .577-1.532-.884A1 1 0 0 1 2.473 6.5M20.159 6.134a1 1 0 0 1 1 1.732l-1.532.884-1-.577V7.018zM11.999 1a1 1 0 0 1 1 1v1.768l-1 .578-1-.578V2a1 1 0 0 1 1-1" />
        </g>
        <path
          fill="currentColor"
