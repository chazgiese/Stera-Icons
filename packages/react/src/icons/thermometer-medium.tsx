...
const ThermometerMediumIcon = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 7.75c.69 0 1.25.56 1.25 1.25v4.113c0 .521.355.998.827 1.39a3.25 3.25 0 1 1-4.154 0c.472-.392.827-.869.827-1.39V9c0-.69.56-1.25 1.25-1.25"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
