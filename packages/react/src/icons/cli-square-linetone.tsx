...
const CliSquareIconLinetone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M6.793 7.793a1 1 0 0 1 1.414 0l3.5 3.5a1 1 0 0 1 0 1.414l-3.5 3.5a1 1 0 1 1-1.414-1.414L9.586 12 6.793 9.207a1 1 0 0 1 0-1.414M17 14.5a1 1 0 0 1 0 2h-4a1 1 0 1 1 0-2z"
        />
      </svg>
    ))
);
CliSquareIconLinetone.displayName = "CliSquareIconLinetone";
export { CliSquareIconLinetone };
