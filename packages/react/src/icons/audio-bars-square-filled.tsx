...
const AudioBarsSquareFilled = memo(
...
AudioBarsSquareFilled.displayName = "AudioBarsSquareFilled";
export { AudioBarsSquareFilled };
export default AudioBarsSquareFilled;
