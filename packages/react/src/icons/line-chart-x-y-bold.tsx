...
const LineChartXYIconBold = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M19.192 5.411a1 1 0 1 1 1.616 1.178l-4.666 6.4a1 1 0 0 1-1.293.285l-3.61-1.999-4.47 5.366a1.001 1.001 0 0 1-1.538-1.282l5-6a1 1 0 0 1 1.253-.234l3.56 1.973z"
        />
      </svg>
    ))
);
LineChartXYIconBold.displayName = "LineChartXYIconBold";
export { LineChartXYIconBold };
