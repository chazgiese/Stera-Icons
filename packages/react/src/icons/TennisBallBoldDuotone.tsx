...
const TennisBallBoldDuotone = memo(
  forwardRef<SVGSVGElement, TennisBallBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.43 4.93a10.96 10.96 0 0 1 0 14.14q-.79-.63-1.43-1.42a8.95 8.95 0 0 0 0-11.3q.63-.8 1.43-1.42M17.57 4.93q.79.63 1.43 1.42a8.96 8.96 0 0 0 0 11.3q-.63.8-1.43 1.42a10.96 10.96 0 0 1 0-14.14" opacity={0.4} />
