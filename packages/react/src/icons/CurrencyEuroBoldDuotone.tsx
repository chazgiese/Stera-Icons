...
const CurrencyEuroBoldDuotone = memo(
  forwardRef<SVGSVGElement, CurrencyEuroBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.02 13q.05 1.07.2 2H4a1 1 0 1 1 0-2zM16 13a1 1 0 1 1 0 2H9.25q-.17-.9-.22-2zM7.22 9q-.15.93-.2 2H4a1 1 0 1 1 0-2zM16 9a1 1 0 1 1 0 2H9.03q.05-1.1.22-2z" />
...
export { CurrencyEuroBoldDuotone };
