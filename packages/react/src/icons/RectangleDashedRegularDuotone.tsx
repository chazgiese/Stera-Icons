...
const RectangleDashedRegularDuotone = memo(
  forwardRef<SVGSVGElement, RectangleDashedRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M15 19.25a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5zM2 10.25c.42 0 .75.34.75.75v2a.75.75 0 0 1-1.5 0v-2c0-.41.34-.75.75-.75M22 10.25c.41 0 .75.34.75.75v2a.75.75 0 0 1-1.5 0v-2c0-.41.34-.75.75-.75M15 3.25a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5z" />
...
export { RectangleDashedRegularDuotone };
