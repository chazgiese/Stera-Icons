...
const CrosshairRegularDuotone = memo(
  forwardRef<SVGSVGElement, CrosshairRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M5.8 12.75a6.25 6.25 0 0 0 5.45 5.45v1.51a7.75 7.75 0 0 1-6.96-6.96zM19.71 12.75a7.75 7.75 0 0 1-6.96 6.96v-1.5a6.25 6.25 0 0 0 5.45-5.46zM12.75 4.29a7.75 7.75 0 0 1 6.96 6.96h-1.5a6.25 6.25 0 0 0-5.46-5.45zM11.25 5.8a6.25 6.25 0 0 0-5.45 5.45H4.29a7.75 7.75 0 0 1 6.96-6.96z" />
...
export { CrosshairRegularDuotone };
