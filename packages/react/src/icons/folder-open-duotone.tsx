    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M21.266 10.25a2 2 0 0 1 1.898 2.633l-1.768 5.303a3.75 3.75 0 0 1-3.558 2.564H4.775a2.75 2.75 0 0 1-2.608-3.62l1.837-5.513a2 2 0 0 1 1.898-1.367zm-15.364 1.5a.5.5 0 0 0-.475.342L3.59 17.605a1.25 1.25 0 0 0 1.186 1.645h13.063c.968 0 1.829-.62 2.135-1.538l1.768-5.304a.5.5 0 0 0-.475-.658z"
          clipRule="evenodd"
        />
      </svg>
    ))
