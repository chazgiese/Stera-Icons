...
const ChartLineXYDescIconBoldDuotone = memo(
...
ChartLineXYDescIconBoldDuotone.displayName = "ChartLineXYDescIconBoldDuotone";
export { ChartLineXYDescIconBoldDuotone };
