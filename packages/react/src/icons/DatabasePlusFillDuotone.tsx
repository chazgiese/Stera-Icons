...
const DatabasePlusFillDuotone = memo(
  forwardRef<SVGSVGElement, DatabasePlusFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.47 14.52c1.09.58 2.67 1.04 4.54 1.29V16a3 3 0 0 0 3 3h1v1a3 3 0 0 0 1.93 2.8q-1.4.2-2.94.2c-2.3 0-4.42-.35-6-.94q-1.22-.44-2.04-1.14A2.6 2.6 0 0 1 3 19v-5.26z" />
...
export { DatabasePlusFillDuotone };
