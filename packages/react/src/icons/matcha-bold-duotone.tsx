...
const MatchaIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M21.07 11.542C22.2 12.435 23 13.603 23 15c0 1.963-1.566 3.472-3.481 4.43C17.543 20.418 14.883 21 12 21s-5.543-.582-7.519-1.57C2.566 18.472 1 16.963 1 15c0-1.397.8-2.565 1.93-3.458q.405.947 1.004 1.764C3.27 13.896 3 14.488 3 15c0 .798.673 1.789 2.376 2.64C7.019 18.463 9.36 19 12 19s4.98-.538 6.624-1.36C20.327 16.79 21 15.799 21 15c0-.512-.272-1.103-.935-1.694a9 9 0 0 0 1.004-1.764"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
MatchaIconBoldDuotone.displayName = "MatchaIconBoldDuotone";
export { MatchaIconBoldDuotone };
