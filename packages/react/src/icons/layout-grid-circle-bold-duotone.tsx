...
const LayoutGridCircleIconBoldDuotone = memo(
...
LayoutGridCircleIconBoldDuotone.displayName = "LayoutGridCircleIconBoldDuotone";
export { LayoutGridCircleIconBoldDuotone };
