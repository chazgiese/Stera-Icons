...
const CollapseFillDuotone = memo(
  forwardRef<SVGSVGElement, CollapseFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m7 18.41-2.3 2.3a1 1 0 0 1-1.4-1.42L5.58 17zM20.7 19.3a1 1 0 0 1-1.4 1.4L17 18.42 18.41 17zM3.3 3.3a1 1 0 0 1 1.4 0L7 5.58 5.59 7l-2.3-2.3a1 1 0 0 1 0-1.4M19.3 3.3a1 1 0 0 1 1.4 1.4L18.42 7 17 5.59z" />
