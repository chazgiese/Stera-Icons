...
const ScanFaceIconLinetone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M14.201 13.55a.75.75 0 0 1 1.2.9 4.247 4.247 0 0 1-6.8 0 .75.75 0 1 1 1.199-.9c.503.67 1.301 1.1 2.2 1.1s1.698-.43 2.201-1.1M9.55 9.023a1.226 1.226 0 1 1 0 2.451 1.226 1.226 0 0 1 0-2.45M14.45 9.023a1.225 1.225 0 1 1 0 2.45 1.225 1.225 0 0 1 0-2.45"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
...
ScanFaceIconLinetone.displayName = "ScanFaceIconLinetone";
export { ScanFaceIconLinetone };
