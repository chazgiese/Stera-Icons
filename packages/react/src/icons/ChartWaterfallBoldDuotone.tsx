...
const ChartWaterfallBoldDuotone = memo(
  forwardRef<SVGSVGElement, ChartWaterfallBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12.75 8C13.99 8 15 9 15 10.25v3.5c0 1.24-1 2.25-2.25 2.25h-1.5C10.01 16 9 15 9 13.75v-3.5C9 9.01 10 8 11.25 8zm-1.5 2a.25.25 0 0 0-.25.25v3.5q.02.23.25.25h1.5q.23-.02.25-.25v-3.5a.25.25 0 0 0-.25-.25z" clipRule="evenodd" opacity={.4} />
