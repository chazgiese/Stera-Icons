...
const AgentWorkflowIconDuotone = memo(
    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M6 11.25a.75.75 0 0 1 0 1.5A2.25 2.25 0 0 0 3.75 15v.25a2.5 2.5 0 0 0 2.5 2.5h12.94l-1.72-1.72a.75.75 0 1 1 1.06-1.06l3 3a.741.741 0 0 1 .116.903.7.7 0 0 1-.116.157l-3 3a.75.75 0 1 1-1.06-1.06l1.72-1.72H6.25a4 4 0 0 1-4-4V15A3.75 3.75 0 0 1 6 11.25" />
          <path
            fillRule="evenodd"
...
AgentWorkflowIconDuotone.displayName = "AgentWorkflowIconDuotone";
export { AgentWorkflowIconDuotone };
