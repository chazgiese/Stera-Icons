...
const BracketsSquareCircleIconLinetone = memo(
...
BracketsSquareCircleIconLinetone.displayName =
  "BracketsSquareCircleIconLinetone";
export { BracketsSquareCircleIconLinetone };
