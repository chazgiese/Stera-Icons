...
const FlowSplitSquareLeftIconBoldDuotone = memo(
...
FlowSplitSquareLeftIconBoldDuotone.displayName =
  "FlowSplitSquareLeftIconBoldDuotone";
export { FlowSplitSquareLeftIconBoldDuotone };
