...
const ImageSquareIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M5.91 11.177a2.25 2.25 0 0 1 3.18 0l4.233 4.232a.25.25 0 0 0 .354 0l1.232-1.232a2.25 2.25 0 0 1 3.182 0l1.857 1.857-.012.167c-.064.772-.183 1.244-.372 1.614a4 4 0 0 1-.245.417l-2.642-2.641a.25.25 0 0 0-.354 0l-1.232 1.232a2.25 2.25 0 0 1-3.182 0l-4.232-4.232a.25.25 0 0 0-.354 0l-3.281 3.281C4.002 15.158 4 14.268 4 13.086zM15 7a2 2 0 1 1 0 4 2 2 0 0 1 0-4"
        />
      </svg>
    ))
);
ImageSquareIconBoldDuotone.displayName = "ImageSquareIconBoldDuotone";
export { ImageSquareIconBoldDuotone };
