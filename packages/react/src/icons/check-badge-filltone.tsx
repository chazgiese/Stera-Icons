  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15.168 8.793a1 1 0 0 1 1.414 1.414l-4.847 4.848c-.1.1-.22.22-.332.315-.12.101-.31.24-.572.313a1.5 1.5 0 0 1-1.005-.07 1.5 1.5 0 0 1-.52-.391c-.098-.11-.2-.247-.284-.36L7.325 12.6a1 1 0 1 1 1.6-1.199l1.558 2.077z"
        />
      </svg>
    ))
);
