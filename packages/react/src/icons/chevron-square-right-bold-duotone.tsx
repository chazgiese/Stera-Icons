...
const ChevronSquareRightIconBoldDuotone = memo(
...
ChevronSquareRightIconBoldDuotone.displayName =
  "ChevronSquareRightIconBoldDuotone";
export { ChevronSquareRightIconBoldDuotone };
