...
const ImageLandscapeIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M5.91 11.177a2.25 2.25 0 0 1 3.18 0l4.233 4.232a.25.25 0 0 0 .354 0l1.232-1.232a2.25 2.25 0 0 1 3.182 0l2.743 2.742c-.044.177-.099.32-.161.442-.244.478-.61.88-1.059 1.167l-2.937-2.937a.25.25 0 0 0-.354 0l-1.232 1.232a2.25 2.25 0 0 1-3.182 0l-4.232-4.232a.25.25 0 0 0-.354 0l-4.188 4.188a6 6 0 0 1-.084-.634C3.008 15.62 3 14.968 3 14.085zM15 7a2 2 0 1 1 0 4 2 2 0 0 1 0-4"
        />
      </svg>
    ))
);
ImageLandscapeIconBoldDuotone.displayName = "ImageLandscapeIconBoldDuotone";
export { ImageLandscapeIconBoldDuotone };
