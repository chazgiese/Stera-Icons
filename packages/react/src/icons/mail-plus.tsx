    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M19 14.25a4.75 4.75 0 1 1 0 9.5 4.75 4.75 0 0 1 0-9.5m0 2a.75.75 0 0 0-.75.75v1.25H17a.75.75 0 0 0 0 1.5h1.25V21a.75.75 0 0 0 1.5 0v-1.25H21a.75.75 0 0 0 0-1.5h-1.25V17a.75.75 0 0 0-.75-.75"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
