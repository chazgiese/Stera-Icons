...
const PlugFillDuotone = memo(
  forwardRef<SVGSVGElement, PlugFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M5.47 10.1a1.5 1.5 0 0 1 2.08.04l6.32 6.31c.53.54.58 1.38.13 1.97l-.1.12-.63.68-.03.02a6 6 0 1 1-8.46-8.5zM21.3 1.3a1 1 0 0 1 1.4 1.4L19.9 5.53a6 6 0 0 0-1.41-1.4z" />
