  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M15.728 2c1.339 0 2.412-.001 3.246.075.829.076 1.587.24 2.203.686a1 1 0 0 1-1.173 1.62c-.172-.124-.487-.247-1.213-.314C18.07 4.001 17.106 4 15.728 4H8.271c-1.377 0-2.342.001-3.063.067-.726.067-1.04.19-1.212.314a1 1 0 0 1-1.174-1.62c.616-.447 1.374-.61 2.203-.686C5.86 2 6.933 2 8.271 2z"
          opacity={0.32}
        />
        <path
          fill="currentColor"
