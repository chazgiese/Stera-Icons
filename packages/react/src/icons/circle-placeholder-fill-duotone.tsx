  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M18.643 20.764a11 11 0 0 1-1.744 1.084L2.15 7.101q.453-.911 1.084-1.745zM5.357 3.234q.833-.63 1.744-1.084L21.85 16.898q-.453.912-1.084 1.744zM13.677 22.87c-.91.14-1.835.166-2.75.077l-9.875-9.874c-.089-.916-.062-1.84.078-2.751zM10.322 1.13c.91-.14 1.835-.167 2.751-.078l9.874 9.874c.09.916.063 1.84-.077 2.751z"
        />
      </svg>
    ))
);
