  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M6.52 7.984a.75.75 0 0 1 .974-.074h.001l.003.003.052.038.16.117a650 650 0 0 1 2.354 1.74c1.311.974 2.755 2.057 3.131 2.38l.043.038a1.75 1.75 0 0 1-2.475 2.476l-.04-.043c-.323-.377-1.405-1.82-2.38-3.131-.492-.664-.966-1.307-1.317-1.783l-.422-.573-.117-.158-.039-.052-.002-.003-.07-.118a.75.75 0 0 1 .144-.857"
        />
      </svg>
    ))
);
