...
const CircleDashSimpleRegularDuotone = memo(
  forwardRef<SVGSVGElement, CircleDashSimpleRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M2.69 6.62a.75.75 0 1 1 1.3.75 9.2 9.2 0 0 0 0 9.25.75.75 0 0 1-1.3.76 10.7 10.7 0 0 1 0-10.76M20.29 6.35a.75.75 0 0 1 1.02.27 10.7 10.7 0 0 1 0 10.76.75.75 0 1 1-1.3-.76 9.2 9.2 0 0 0 0-9.25.75.75 0 0 1 .28-1.02" />
...
export { CircleDashSimpleRegularDuotone };
