...
const ChartCandleAltRegularDuotone = memo(
  forwardRef<SVGSVGElement, ChartCandleAltRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.75 20a.75.75 0 0 1-1.5 0v-1.25h1.5zM20.75 19a.75.75 0 0 1-1.5 0v-1.25h1.5zM12.75 18a.75.75 0 0 1-1.5 0v-3.25h1.5zM4 5.25c.41 0 .75.34.75.75v3.25h-1.5V6c0-.41.34-.75.75-.75M12 5.25c.41 0 .75.34.75.75v1.25h-1.5V6c0-.41.34-.75.75-.75M20 3.25c.41 0 .75.34.75.75v1.25h-1.5V4c0-.41.34-.75.75-.75" />
...
export { ChartCandleAltRegularDuotone };
