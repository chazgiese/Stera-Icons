...
const SquareDashedRegularDuotone = memo(
  forwardRef<SVGSVGElement, SquareDashedRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14 20.25a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1 0-1.5zM3 9.25c.42 0 .75.34.75.75v4a.75.75 0 0 1-1.5 0v-4c0-.41.34-.75.75-.75M21 9.25c.42 0 .75.34.75.75v4a.75.75 0 0 1-1.5 0v-4c0-.41.34-.75.75-.75M14 2.25a.75.75 0 0 1 0 1.5h-4a.75.75 0 0 1 0-1.5z" />
...
export { SquareDashedRegularDuotone };
