...
const BracketsCurlyCircleIconBoldDuotone = memo(
...
BracketsCurlyCircleIconBoldDuotone.displayName =
  "BracketsCurlyCircleIconBoldDuotone";
export { BracketsCurlyCircleIconBoldDuotone };
