...
const LabelAltIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="m20.746 5 .069.01a.25.25 0 0 1 .142.373l-3.142 5.027a3 3 0 0 0 0 3.18l3.142 5.027a.25.25 0 0 1-.212.383H7.11a1 1 0 0 1-.848-.47l-3.75-6a1 1 0 0 1 0-1.06l3.75-6c.16-.256.425-.424.72-.462L7.109 5z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
LabelAltIconFillDuotone.displayName = "LabelAltIconFillDuotone";
export { LabelAltIconFillDuotone };
