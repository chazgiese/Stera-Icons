...
const MicroscopeRegularDuotone = memo(
  forwardRef<SVGSVGElement, MicroscopeRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12.25 7.75h-.75a6.75 6.75 0 0 0 0 13.5H6.76a8.24 8.24 0 0 1 4.74-15h.75zM19 17.25a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1 0-1.5z" />
...
export { MicroscopeRegularDuotone };
