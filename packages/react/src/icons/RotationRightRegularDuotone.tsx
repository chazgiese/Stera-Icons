...
const RotationRightRegularDuotone = memo(
  forwardRef<SVGSVGElement, RotationRightRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M17.13 5.81c.29-.29.76-.29 1.06 0A8.75 8.75 0 0 1 12 20.75h-1.19l-.75-.75.75-.75H12a7.25 7.25 0 0 0 5.13-12.38.75.75 0 0 1 0-1.06M13.94 4l-.75.75H12a7.25 7.25 0 0 0-5.13 12.38.75.75 0 1 1-1.06 1.06A8.75 8.75 0 0 1 12 3.25h1.19z" />
...
export { RotationRightRegularDuotone };
