...
const MedalStarIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M11.064 9.762c.427-.682 1.444-.682 1.871 0l.082.156 1.433 3.313 3.61.334c.963.09 1.363 1.291.627 1.935l-2.72 2.38.795 3.518c.216.954-.816 1.687-1.645 1.197L12 20.75l-3.116 1.844c-.83.49-1.863-.242-1.647-1.197l.795-3.518-2.719-2.38c-.736-.644-.336-1.845.628-1.935l3.609-.334 1.432-3.313z"
        />
        <path
          fill="currentColor"
          d="m8 12.117-2-.999v-10.1C6.343 1 6.746 1 7.2 1H8zM16.8 1c.454 0 .856 0 1.2.019v10.1l-2 .998V1z"
        />
      </svg>
    ))
);
MedalStarIconFillDuotone.displayName = "MedalStarIconFillDuotone";
export { MedalStarIconFillDuotone };
