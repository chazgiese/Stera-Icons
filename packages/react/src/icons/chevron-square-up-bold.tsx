...
const ChevronSquareUpIconBold = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M11.293 8.793a1 1 0 0 1 1.414 0l4.5 4.5a1 1 0 1 1-1.414 1.414L12 10.914l-3.793 3.793a1 1 0 1 1-1.414-1.414z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
...
ChevronSquareUpIconBold.displayName = "ChevronSquareUpIconBold";
export { ChevronSquareUpIconBold };
