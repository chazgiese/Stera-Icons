...
const BrickWallFillDuotone = memo(
  forwardRef<SVGSVGElement, BrickWallFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M20.75 3C21.99 3 23 4 23 5.25v2.42h-5V3zM11 14.33H1V9.67h10zM16 7.67H8V3h8zM23 18.75c0 1.24-1 2.25-2.25 2.25H18v-4.67h5zM6 21H3.25C2.01 21 1 20 1 18.75v-2.42h5z" />
