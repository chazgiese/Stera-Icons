...
const ChevronFullSquareDownIconFillDuotone = memo(
...
ChevronFullSquareDownIconFillDuotone.displayName =
  "ChevronFullSquareDownIconFillDuotone";
export { ChevronFullSquareDownIconFillDuotone };
