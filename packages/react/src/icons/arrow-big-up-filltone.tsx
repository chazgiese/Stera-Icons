  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.41 3.677a2.25 2.25 0 0 1 3.18 0l8.264 8.263c.944.945.275 2.56-1.061 2.56H17a1 1 0 0 1 0-2h2.586l-7.41-7.409a.25.25 0 0 0-.353 0l-7.409 7.41H7a1 1 0 0 1 0 2H3.207c-1.336 0-2.005-1.616-1.06-2.561z"
        />
      </svg>
    ))
);
