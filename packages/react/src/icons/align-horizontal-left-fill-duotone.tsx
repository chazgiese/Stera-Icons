...
const AlignHorizontalLeftIconFillDuotone = memo(
...
AlignHorizontalLeftIconFillDuotone.displayName =
  "AlignHorizontalLeftIconFillDuotone";
export { AlignHorizontalLeftIconFillDuotone };
