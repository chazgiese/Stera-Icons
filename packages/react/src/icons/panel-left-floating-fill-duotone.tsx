...
const PanelLeftFloatingIconFillDuotone = memo(
...
PanelLeftFloatingIconFillDuotone.displayName =
  "PanelLeftFloatingIconFillDuotone";
export { PanelLeftFloatingIconFillDuotone };
