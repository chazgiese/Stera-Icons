...
const CurrencyCircleDollarIconFilled = memo(
...
CurrencyCircleDollarIconFilled.displayName = "CurrencyCircleDollarIconFilled";
export { CurrencyCircleDollarIconFilled };
