  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M19.752 3.168a1.5 1.5 0 1 1 2.496 1.664l-6 9a1.5 1.5 0 0 1-2.309.228l-2.075-2.075-2.544 4.726a1.5 1.5 0 1 1-2.64-1.422l3.5-6.5.093-.15a1.5 1.5 0 0 1 2.288-.2l2.206 2.207z"
        />
      </svg>
    ))
);
ChartLineFilled.displayName = "ChartLineFilled";
export { ChartLineFilled };
