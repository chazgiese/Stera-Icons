...
const ChatBoxCheckIconBold = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M15.168 7.293a1 1 0 1 1 1.414 1.414l-4.848 4.848c-.1.1-.22.22-.332.315-.12.101-.309.24-.57.314a1.5 1.5 0 0 1-1.006-.072 1.5 1.5 0 0 1-.52-.39c-.098-.11-.2-.247-.285-.36L7.325 11.1a1 1 0 1 1 1.6-1.2l1.557 2.077z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
...
ChatBoxCheckIconBold.displayName = "ChatBoxCheckIconBold";
export { ChatBoxCheckIconBold };
