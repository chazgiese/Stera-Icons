...
const FlowDiagramRegularDuotone = memo(
  forwardRef<SVGSVGElement, FlowDiagramRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.97 11.47c-.3.3-.3.77 0 1.06l.22.22H7c-.69 0-1.25.56-1.25 1.25v4c0 .69.56 1.25 1.25 1.25h6.25v1.5H7A2.75 2.75 0 0 1 4.25 18v-4A2.75 2.75 0 0 1 7 11.25h1.19zM17 3.25A2.75 2.75 0 0 1 19.75 6v4A2.75 2.75 0 0 1 17 12.75h-1.19l.22-.22c.3-.3.3-.77 0-1.06l-.22-.22H17c.69 0 1.25-.56 1.25-1.25V6c0-.69-.56-1.25-1.25-1.25h-6.25v-1.5z" />
...
export { FlowDiagramRegularDuotone };
