...
const FlowSplitLeftRegularDuotone = memo(
  forwardRef<SVGSVGElement, FlowSplitLeftRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M10 4.25A2.75 2.75 0 0 1 12.75 7v4.25h2.58a4 4 0 0 0 0 1.5h-2.58V17A2.75 2.75 0 0 1 10 19.75H8.67a4 4 0 0 0 0-1.5H10c.69 0 1.25-.56 1.25-1.25V7c0-.69-.56-1.25-1.25-1.25H8.67a4 4 0 0 0 0-1.5z" opacity={.4} />
...
export { FlowSplitLeftRegularDuotone };
