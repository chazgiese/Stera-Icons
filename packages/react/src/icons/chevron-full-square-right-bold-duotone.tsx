...
const ChevronFullSquareRightIconBoldDuotone = memo(
...
ChevronFullSquareRightIconBoldDuotone.displayName =
  "ChevronFullSquareRightIconBoldDuotone";
export { ChevronFullSquareRightIconBoldDuotone };
