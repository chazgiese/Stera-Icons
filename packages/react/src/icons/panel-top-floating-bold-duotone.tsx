...
const PanelTopFloatingIconBoldDuotone = memo(
...
PanelTopFloatingIconBoldDuotone.displayName = "PanelTopFloatingIconBoldDuotone";
export { PanelTopFloatingIconBoldDuotone };
