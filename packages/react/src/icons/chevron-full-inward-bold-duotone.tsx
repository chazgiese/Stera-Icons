...
const ChevronFullInwardIconBoldDuotone = memo(
...
ChevronFullInwardIconBoldDuotone.displayName =
  "ChevronFullInwardIconBoldDuotone";
export { ChevronFullInwardIconBoldDuotone };
