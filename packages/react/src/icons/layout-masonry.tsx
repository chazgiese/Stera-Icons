    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M8.75 15.25a2 2 0 0 1 2 2v2.5a2 2 0 0 1-2 2h-4.5a2 2 0 0 1-2-2v-2.5a2 2 0 0 1 2-2zm-4.5 1.5a.5.5 0 0 0-.5.5v2.5a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-2.5a.5.5 0 0 0-.5-.5zM19.75 11.25a2 2 0 0 1 2 2v6.5a2 2 0 0 1-2 2h-4.5a2 2 0 0 1-2-2v-6.5a2 2 0 0 1 2-2zm-4.5 1.5a.5.5 0 0 0-.5.5v6.5a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-6.5a.5.5 0 0 0-.5-.5zM8.75 2.25a2 2 0 0 1 2 2v6.5a2 2 0 0 1-2 2h-4.5a2 2 0 0 1-2-2v-6.5a2 2 0 0 1 2-2zm-4.5 1.5a.5.5 0 0 0-.5.5v6.5a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-6.5a.5.5 0 0 0-.5-.5zM19.75 2.25a2 2 0 0 1 2 2v2.5a2 2 0 0 1-2 2h-4.5a2 2 0 0 1-2-2v-2.5a2 2 0 0 1 2-2zm-4.5 1.5a.5.5 0 0 0-.5.5v2.5a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-2.5a.5.5 0 0 0-.5-.5z"
          clipRule="evenodd"
        />
      </svg>
    ))
