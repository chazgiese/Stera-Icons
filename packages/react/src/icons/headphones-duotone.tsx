    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M5.29 13.834a2.75 2.75 0 0 1 3.28 2.088l.65 2.93a2.75 2.75 0 1 1-5.369 1.192l-.65-2.93a2.75 2.75 0 0 1 2.089-3.28m1.816 2.414a1.25 1.25 0 0 0-2.44.542l.65 2.928a1.25 1.25 0 0 0 2.44-.542zM15.43 15.922a2.75 2.75 0 0 1 5.368 1.193l-.65 2.929a2.75 2.75 0 0 1-5.37-1.193zm2.954-.624a1.25 1.25 0 0 0-1.491.95l-.65 2.928a1.25 1.25 0 0 0 2.44.542l.65-2.928a1.25 1.25 0 0 0-.949-1.492"
          clipRule="evenodd"
        />
      </svg>
    ))
