    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M16.14 6.566a1.001 1.001 0 0 1 1.293 1.293l-2.5 6.5a1 1 0 0 1-.574.575l-6.5 2.5a1 1 0 0 1-1.293-1.293l2.5-6.5c.102-.264.31-.473.574-.575zM12 10.75a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5"
          clipRule="evenodd"
        />
      </svg>
    ))
