...
const WristWatchBoldDuotone = memo(
  forwardRef<SVGSVGElement, WristWatchBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M17 21a3 3 0 0 1-3 3h-4a3 3 0 0 1-3-3v-2.76q.9.73 2 1.18V21a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-1.58q1.1-.45 2-1.18zM14 0a3 3 0 0 1 3 3v2.76a8 8 0 0 0-2-1.18V3a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v1.58q-1.1.46-2 1.18V3a3 3 0 0 1 3-3z" />
