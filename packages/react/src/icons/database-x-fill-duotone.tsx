...
const DatabaseXIconFillDuotone = memo(
    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M4.47 14.518c1.59.846 4.218 1.448 7.285 1.48l.003.002-.38.379a3 3 0 1 0 4.243 4.242l.379-.379.379.38a2.98 2.98 0 0 0 2.305.87c.118-.008.193.187.087.239a9 9 0 0 1-.763.327c-1.586.595-3.71.942-6.008.942s-4.422-.348-6.008-.942c-.79-.296-1.498-.673-2.027-1.142C3.437 20.448 3 19.803 3 19v-5.265z" />
          <path
            fillRule="evenodd"
...
DatabaseXIconFillDuotone.displayName = "DatabaseXIconFillDuotone";
export { DatabaseXIconFillDuotone };
