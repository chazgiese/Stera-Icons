...
const PanelBottomFloatingIconBoldDuotone = memo(
...
PanelBottomFloatingIconBoldDuotone.displayName =
  "PanelBottomFloatingIconBoldDuotone";
export { PanelBottomFloatingIconBoldDuotone };
