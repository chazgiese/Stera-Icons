...
const MailboxFillDuotone = memo(
  forwardRef<SVGSVGElement, MailboxFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="M17.5 5a5.5 5.5 0 0 1 5.5 5.5V17a3 3 0 0 1-3 3h-9a1 1 0 0 0 1-1v-8.5A5.5 5.5 0 0 0 6.5 5zm-3 4a1 1 0 1 0 0 2h3v.5a1 1 0 1 0 2 0V10a1 1 0 0 0-1-1z" clipRule="evenodd" />
