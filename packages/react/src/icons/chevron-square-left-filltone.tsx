...
const ChevronSquareLeftIconFilltone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12.793 6.793a1 1 0 1 1 1.414 1.414L10.414 12l3.793 3.793a1 1 0 1 1-1.414 1.414l-4.5-4.5a1 1 0 0 1 0-1.414z"
        />
      </svg>
    ))
);
ChevronSquareLeftIconFilltone.displayName = "ChevronSquareLeftIconFilltone";
export { ChevronSquareLeftIconFilltone };
