...
const ScrollFillDuotone = memo(
  forwardRef<SVGSVGElement, ScrollFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16.5 5a1 1 0 0 1 1 1v9h-6.25c-.97 0-1.75.78-1.75 1.75V18a1 1 0 0 1-.9 1h-.1a1 1 0 0 1-1-1V6a3 3 0 0 0-.17-1z" />
        <path d="M20.5 17v1a1 1 0 0 1-1 1h-8.17a3 3 0 0 0 .17-1v-1zM4.5 5a1 1 0 0 1 1 1v2.5h-2V6a1 1 0 0 1 1-1" />
