...
const FlowSplitRightSquareIconFilled = memo(
...
FlowSplitRightSquareIconFilled.displayName = "FlowSplitRightSquareIconFilled";
export { FlowSplitRightSquareIconFilled };
