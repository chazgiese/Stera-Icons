...
const ArrowBigLeftBoldDuotone = memo(
  forwardRef<SVGSVGElement, ArrowBigLeftBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18 7a3 3 0 0 1 3 3v4a3 3 0 0 1-3 3h-3.5v-1a1 1 0 0 0-1-1H18a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1h-4.5a1 1 0 0 1 1-1V7zM12.73 15.36l-.06.08z" />
...
export { ArrowBigLeftBoldDuotone };
