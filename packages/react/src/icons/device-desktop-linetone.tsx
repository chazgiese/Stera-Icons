    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M15 15a1 1 0 0 1 1 1c0 1.258.46 3.053.755 4.057.279.95-.423 1.943-1.448 1.943H8.693c-1.025 0-1.727-.992-1.448-1.943C7.54 19.054 8 17.258 8 16a1 1 0 0 1 1-1zm-5.062 2c-.116 1.06-.38 2.181-.601 3h5.326c-.221-.819-.485-1.94-.601-3z"
          clipRule="evenodd"
          opacity={0.32}
        />
        <path
