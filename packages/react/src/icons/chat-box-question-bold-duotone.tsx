...
const ChatBoxQuestionIconBoldDuotone = memo(
...
ChatBoxQuestionIconBoldDuotone.displayName = "ChatBoxQuestionIconBoldDuotone";
export { ChatBoxQuestionIconBoldDuotone };
