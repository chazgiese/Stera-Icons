...
const MailBadgeIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M1 6.99c.001.31.144.605.387.8L3 9.08V17a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9.5a4.5 4.5 0 0 0 2-.469V17a4 4 0 0 1-4 4H5a4 4 0 0 1-4-4V6.99"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
MailBadgeIconBoldDuotone.displayName = "MailBadgeIconBoldDuotone";
export { MailBadgeIconBoldDuotone };
