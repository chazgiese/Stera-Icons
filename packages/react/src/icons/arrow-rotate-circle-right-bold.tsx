...
const ArrowRotateCircleRightIconBold = memo(
...
ArrowRotateCircleRightIconBold.displayName = "ArrowRotateCircleRightIconBold";
export { ArrowRotateCircleRightIconBold };
