...
const ClipboardTextIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15.5 13.75a1 1 0 1 1 0 2h-7a1 1 0 1 1 0-2zM15.5 10.25a1 1 0 1 1 0 2h-7a1 1 0 1 1 0-2z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
...
ClipboardTextIconBoldDuotone.displayName = "ClipboardTextIconBoldDuotone";
export { ClipboardTextIconBoldDuotone };
