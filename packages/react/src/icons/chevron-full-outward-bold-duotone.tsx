...
const ChevronFullOutwardIconBoldDuotone = memo(
...
ChevronFullOutwardIconBoldDuotone.displayName =
  "ChevronFullOutwardIconBoldDuotone";
export { ChevronFullOutwardIconBoldDuotone };
