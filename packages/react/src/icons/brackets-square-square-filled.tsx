...
const BracketsSquareSquareIconFilled = memo(
...
BracketsSquareSquareIconFilled.displayName = "BracketsSquareSquareIconFilled";
export { BracketsSquareSquareIconFilled };
