...
const RotationLeftFillDuotone = memo(
  forwardRef<SVGSVGElement, RotationLeftFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M5.64 5.64a1 1 0 0 1 1.41 1.41A7 7 0 0 0 11 18.93v2.01a9 9 0 0 1-5.36-15.3M13 3.06a9 9 0 0 1 5.36 15.3 1 1 0 0 1-1.41-1.41A7 7 0 0 0 13 5.07z" />
...
export { RotationLeftFillDuotone };
