...
const CurrencyEuroCirlceIconBoldDuotone = memo(
...
CurrencyEuroCirlceIconBoldDuotone.displayName =
  "CurrencyEuroCirlceIconBoldDuotone";
export { CurrencyEuroCirlceIconBoldDuotone };
