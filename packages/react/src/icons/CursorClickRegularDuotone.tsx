...
const CursorClickRegularDuotone = memo(
  forwardRef<SVGSVGElement, CursorClickRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M8.33 10.24c-.4-1.18.73-2.3 1.91-1.91l10.48 3.49a1.51 1.51 0 0 1-.05 2.89l-4.61 1.35-1.35 4.6a1.51 1.51 0 0 1-2.89.06zm1.42-.49v.01l3.5 10.48v.01h.01l1.48-5 .03-.1q.15-.31.47-.41l5-1.47.01-.02-10.48-3.5z" clipRule="evenodd" />
...
export { CursorClickRegularDuotone };
