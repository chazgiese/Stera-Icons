...
const GaugeLines66PercentIconBold = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M16.357 7.709a1 1 0 0 1 1.399 1.396l-.001.001-.002.004-.008.01-.031.042-.116.158-.422.573c-.351.476-.826 1.118-1.32 1.783-.97 1.306-2.06 2.76-2.39 3.145q-.025.03-.052.057a2 2 0 0 1-2.828-2.828l.057-.053c.385-.33 1.84-1.42 3.145-2.39.664-.493 1.306-.968 1.782-1.319l.574-.422.158-.116.042-.031.01-.008z"
        />
      </svg>
    ))
);
GaugeLines66PercentIconBold.displayName = "GaugeLines66PercentIconBold";
export { GaugeLines66PercentIconBold };
