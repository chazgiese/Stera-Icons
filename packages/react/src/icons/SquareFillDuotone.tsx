...
const SquareFillDuotone = memo(
  forwardRef<SVGSVGElement, SquareFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M13 4c1.42 0 2.42 0 3.2.06.77.07 1.25.19 1.62.38a4 4 0 0 1 1.74 1.74c.2.37.31.85.38 1.62.06.78.06 1.78.06 3.2v2c0 1.42 0 2.42-.06 3.2a4 4 0 0 1-.38 1.62 4 4 0 0 1-1.74 1.74c-.37.2-.85.31-1.62.38-.78.06-1.78.06-3.2.06h-2c-1.42 0-2.42 0-3.2-.06a4 4 0 0 1-1.62-.38 4 4 0 0 1-1.74-1.74c-.2-.37-.31-.85-.38-1.62C4 15.42 4 14.42 4 13v-2c0-1.42 0-2.42.06-3.2.07-.77.19-1.25.38-1.62a4 4 0 0 1 1.74-1.74c.37-.2.85-.31 1.62-.38C8.58 4 9.58 4 11 4z" opacity={.4} />
