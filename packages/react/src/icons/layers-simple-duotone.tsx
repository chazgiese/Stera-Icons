    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M9.726 3.387a4.75 4.75 0 0 1 4.548 0l7.074 3.857c1.39.758 1.39 2.754 0 3.512l-7.074 3.857a4.75 4.75 0 0 1-4.548 0l-7.074-3.857c-1.389-.758-1.389-2.754 0-3.512zm3.83 1.316a3.25 3.25 0 0 0-3.113 0L3.371 8.562a.5.5 0 0 0 0 .877l7.072 3.858c.97.53 2.144.53 3.114 0l7.072-3.858a.5.5 0 0 0 0-.877z"
          clipRule="evenodd"
        />
      </svg>
    ))
