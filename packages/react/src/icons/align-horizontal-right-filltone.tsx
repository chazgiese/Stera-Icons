...
const AlignHorizontalRightIconFilltone = memo(
...
AlignHorizontalRightIconFilltone.displayName =
  "AlignHorizontalRightIconFilltone";
export { AlignHorizontalRightIconFilltone };
