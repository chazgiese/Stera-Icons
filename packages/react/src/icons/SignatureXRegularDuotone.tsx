...
const SignatureXRegularDuotone = memo(
  forwardRef<SVGSVGElement, SignatureXRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8 17.25q-.49.8-1 1.5H2a.75.75 0 0 1 0-1.5zM22 17.25a.75.75 0 0 1 0 1.5H8.83q.46-.72.9-1.5zM4.47 11.47a.75.75 0 1 1 1.06 1.06l-.97.97.97.97a.75.75 0 1 1-1.06 1.06l-.97-.97-.97.97a.75.75 0 1 1-1.06-1.06l.97-.97-.97-.97a.75.75 0 1 1 1.06-1.06l.97.97z" />
...
export { SignatureXRegularDuotone };
