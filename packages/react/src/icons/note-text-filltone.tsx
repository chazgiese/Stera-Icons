...
const NoteTextIconFilltone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M16.2 13H20v.337c0 .245 0 .367-.028.482a1 1 0 0 1-.12.29c-.061.1-.148.187-.32.36l-5.063 5.062c-.173.173-.26.26-.36.322a1 1 0 0 1-.29.12c-.115.027-.237.027-.482.027H13v-3.8c0-1.12 0-1.68.218-2.108a2 2 0 0 1 .874-.874C14.52 13 15.08 13 16.2 13M6 11a1 1 0 0 1 1-1h4a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1M6 7a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1"
        />
      </svg>
    ))
);
NoteTextIconFilltone.displayName = "NoteTextIconFilltone";
export { NoteTextIconFilltone };
