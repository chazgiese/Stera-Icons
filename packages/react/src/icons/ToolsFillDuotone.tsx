...
const ToolsFillDuotone = memo(
  forwardRef<SVGSVGElement, ToolsFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.2 13.02q.72.12 1.45.06l3.27 3.27q-.06.72.06 1.46L7.78 21A3.39 3.39 0 0 1 3 16.2zM19.8 2.07a1 1 0 0 1 1.06.22l.85.85a1 1 0 0 1 .15 1.22l-1.27 2.1a1 1 0 0 1-1.56.2l-.14-.14L15.42 10 14 8.58l3.46-3.47-.13-.14a1 1 0 0 1 .19-1.56l2.11-1.27z" />
