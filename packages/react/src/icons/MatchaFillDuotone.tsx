...
const MatchaFillDuotone = memo(
  forwardRef<SVGSVGElement, MatchaFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M21.07 11.55C22.21 12.45 23 13.6 23 15c0 1.96-1.57 3.47-3.48 4.43A17 17 0 0 1 12 21a17 17 0 0 1-7.52-1.57C2.57 18.47 1 16.96 1 15c0-1.4.79-2.55 1.93-3.45q.18.4.4.8A9 9 0 0 0 11.2 17h1.6a9 9 0 0 0 8.27-5.45" opacity={.4} />
