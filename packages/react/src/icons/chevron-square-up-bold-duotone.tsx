...
const ChevronSquareUpIconBoldDuotone = memo(
...
ChevronSquareUpIconBoldDuotone.displayName = "ChevronSquareUpIconBoldDuotone";
export { ChevronSquareUpIconBoldDuotone };
