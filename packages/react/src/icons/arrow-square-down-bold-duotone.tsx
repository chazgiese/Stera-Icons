...
const ArrowSquareDownIconBoldDuotone = memo(
...
ArrowSquareDownIconBoldDuotone.displayName = "ArrowSquareDownIconBoldDuotone";
export { ArrowSquareDownIconBoldDuotone };
