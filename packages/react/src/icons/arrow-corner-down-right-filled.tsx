...
const ArrowCornerDownRightIconFilled = memo(
...
ArrowCornerDownRightIconFilled.displayName = "ArrowCornerDownRightIconFilled";
export { ArrowCornerDownRightIconFilled };
