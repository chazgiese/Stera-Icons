...
const AudioBarsSquareIconFillDuotone = memo(
...
AudioBarsSquareIconFillDuotone.displayName = "AudioBarsSquareIconFillDuotone";
export { AudioBarsSquareIconFillDuotone };
