...
const SquareDashedBoldDuotone = memo(
  forwardRef<SVGSVGElement, SquareDashedBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14 20a1 1 0 1 1 0 2h-4a1 1 0 1 1 0-2zM3 9a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0v-4a1 1 0 0 1 1-1M21 9a1 1 0 0 1 1 1v4a1 1 0 0 1-2 0v-4a1 1 0 0 1 1-1M14 2a1 1 0 1 1 0 2h-4a1 1 0 0 1 0-2z" opacity={0.4} />
