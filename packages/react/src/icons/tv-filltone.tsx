  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M4.748 18.955c.532.044 1.184.043 1.972.043l-.772 2.317a1 1 0 0 1-1.896-.632l.58-1.742zM19.948 20.683a1 1 0 0 1-1.896.632l-.773-2.317c.788 0 1.44 0 1.973-.043q.058-.006.115-.014z"
        />
      </svg>
    ))
);
