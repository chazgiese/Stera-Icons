...
const GitPullRequestClosedBoldDuotone = memo(
  forwardRef<SVGSVGElement, GitPullRequestClosedBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.5 15.15a3.5 3.5 0 0 0-2 0v-6.3a3.5 3.5 0 0 0 2 0zM18.5 10a1 1 0 0 1 1 1v4.15a3.5 3.5 0 0 0-2 0V11a1 1 0 0 1 1-1" />
...
export { GitPullRequestClosedBoldDuotone };
