  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 2c5.523 0 10 4.477 10 10s-4.477 10-10 10H9a1 1 0 1 0 0-2H6.2c-.576 0-.949-.001-1.232-.024-.272-.023-.373-.06-.422-.085a1 1 0 0 1-.437-.437c-.025-.05-.063-.15-.085-.422A17 17 0 0 1 4 17.8V15a1 1 0 1 0-2 0v-3C2 6.477 6.477 2 12 2"
          opacity={0.4}
        />
        <path
          fill="currentColor"
