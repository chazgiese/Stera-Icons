...
const GitPullRequestRegularDuotone = memo(
  forwardRef<SVGSVGElement, GitPullRequestRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.25 15.34a3 3 0 0 0-1.5 0V8.66a3 3 0 0 0 1.5 0zM15.5 4.75a3.75 3.75 0 0 1 3.75 3.75v6.84a3 3 0 0 0-1.5 0V8.5c0-1.24-1-2.25-2.25-2.25h-2.19l-.75-.75.75-.75z" />
...
export { GitPullRequestRegularDuotone };
