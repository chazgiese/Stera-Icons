  ...
  forwardRef<SVGSVGElement, ExpandSimpleRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8.47 14.47a.75.75 0 1 1 1.06 1.06l-4.72 4.72H3.75v-1.06zM20.25 3.75v1.06l-4.72 4.72a.75.75 0 1 1-1.06-1.06l4.72-4.72z" />
        <path fill="currentColor" d="M3 14.25c.41 0 .75.34.75.75v5.25H9a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75v-6c0-.41.34-.75.75-.75M21 2.25c.41 0 .75.34.75.75v6a.75.75 0 0 1-1.5 0V3.75H15a.75.75 0 0 1 0-1.5z" />
    </IconBase>
  ))
);
...
export { ExpandSimpleRegularDuotone };
