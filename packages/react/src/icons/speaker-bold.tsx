    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M13.16 4.425C14.575 3.008 17 4.012 17 6.015v11.966c0 2.004-2.423 3.008-3.84 1.59l-3.5-3.5a.25.25 0 0 0-.178-.073H7.25a2.25 2.25 0 0 1-2.238-2.02L5 13.749v-3.5a2.25 2.25 0 0 1 2.25-2.25h2.232a.25.25 0 0 0 .177-.073zM15 6.015a.25.25 0 0 0-.427-.176l-3.5 3.5a2.25 2.25 0 0 1-1.59.66H7.25a.25.25 0 0 0-.25.25v3.5l.005.05a.25.25 0 0 0 .245.2h2.232a2.25 2.25 0 0 1 1.591.658l3.5 3.5a.25.25 0 0 0 .427-.176z"
          clipRule="evenodd"
        />
      </svg>
    ))
