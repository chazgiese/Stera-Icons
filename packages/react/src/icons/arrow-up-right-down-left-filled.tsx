...
const ArrowUpRightDownLeftIconFilled = memo(
...
ArrowUpRightDownLeftIconFilled.displayName = "ArrowUpRightDownLeftIconFilled";
export { ArrowUpRightDownLeftIconFilled };
