...
const CircleDivideVerticalIconFilled = memo(
...
CircleDivideVerticalIconFilled.displayName = "CircleDivideVerticalIconFilled";
export { CircleDivideVerticalIconFilled };
