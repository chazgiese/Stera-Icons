...
const CalendarMinusIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15 14.5a1 1 0 1 1 0 2H9a1 1 0 1 1 0-2zM8 1a1 1 0 0 1 1 1v4a1 1 0 0 1-2 0V2a1 1 0 0 1 1-1M16 1a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0V2a1 1 0 0 1 1-1"
        />
      </svg>
    ))
);
CalendarMinusIconBoldDuotone.displayName = "CalendarMinusIconBoldDuotone";
export { CalendarMinusIconBoldDuotone };
