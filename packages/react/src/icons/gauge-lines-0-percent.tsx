...
const GaugeLines0PercentIcon = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.763 12.227a1.75 1.75 0 1 1 2.474 2.474l-.042.04c-.376.322-1.82 1.404-3.132 2.378-.664.494-1.307.968-1.783 1.32l-.571.42-.16.118-.051.038-.003.002-.117.072a.75.75 0 0 1-.932-1.12l.003-.003.037-.053.118-.158.421-.572c.351-.476.826-1.119 1.32-1.783.974-1.311 2.056-2.755 2.379-3.131z"
        />
      </svg>
    ))
);
