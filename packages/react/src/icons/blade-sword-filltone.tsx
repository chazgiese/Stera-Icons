...
const BladeSwordIconFilltone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M2.47 2.47a.75.75 0 0 1 .712-.197l4 1a.75.75 0 0 1 .348.197l9.293 9.293-4.06 4.06L3.47 7.53a.8.8 0 0 1-.166-.252l-.032-.096-1-4a.75.75 0 0 1 .198-.712"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
BladeSwordIconFilltone.displayName = "BladeSwordIconFilltone";
export { BladeSwordIconFilltone };
