...
const CreditCardRegular = memo(
  forwardRef<SVGSVGElement, CreditCardRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M12 15.25a.75.75 0 0 1 0 1.5h-1a.75.75 0 0 1 0-1.5zM18 15.25a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1 0-1.5z" />
