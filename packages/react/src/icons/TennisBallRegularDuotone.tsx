...
const TennisBallRegularDuotone = memo(
  forwardRef<SVGSVGElement, TennisBallRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.07 4.9a10.7 10.7 0 0 1 0 14.2A9 9 0 0 1 5 18.04 9.2 9.2 0 0 0 5 5.96 9 9 0 0 1 6.07 4.9M17.93 4.9q.57.48 1.07 1.06a9.2 9.2 0 0 0 0 12.08 9 9 0 0 1-1.07 1.06 10.7 10.7 0 0 1 0-14.2" />
...
export { TennisBallRegularDuotone };
