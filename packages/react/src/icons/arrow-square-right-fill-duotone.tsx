...
const ArrowSquareRightIconFillDuotone = memo(
...
ArrowSquareRightIconFillDuotone.displayName = "ArrowSquareRightIconFillDuotone";
export { ArrowSquareRightIconFillDuotone };
