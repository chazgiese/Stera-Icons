...
const CurrencyCircleDollarIconBoldDuotone = memo(
...
CurrencyCircleDollarIconBoldDuotone.displayName =
  "CurrencyCircleDollarIconBoldDuotone";
export { CurrencyCircleDollarIconBoldDuotone };
