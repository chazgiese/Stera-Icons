  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M14.68 5.573a1.5 1.5 0 0 1 .819 2.666l-1.284 1.028a3.5 3.5 0 0 0-.896 1.068c-.082.152-.19.282-.314.394l-.005.018c-.111.416-.25.832-.25 1.247q0 1.54.444 3.08l2.867 2.865A1.5 1.5 0 0 1 15 20.5H9a1.5 1.5 0 0 1-1.06-2.56l2.865-2.867a11 11 0 0 0 .445-3.079c0-.415-.139-.831-.25-1.247l-.006-.018a1.5 1.5 0 0 1-.313-.394 3.5 3.5 0 0 0-.896-1.068L8.501 8.239a1.5 1.5 0 0 1 .938-2.67h5.123z"
        />
      </svg>
    ))
);
