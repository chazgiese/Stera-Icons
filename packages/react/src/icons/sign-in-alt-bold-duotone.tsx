...
const SignInAltIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M9.793 6.293a1 1 0 0 1 1.414 0l5 5a1 1 0 0 1 0 1.414l-5 5a1 1 0 0 1-1.414-1.414L13.086 13H3.5a1 1 0 0 1 0-2h9.586L9.793 7.707a1 1 0 0 1 0-1.414"
        />
      </svg>
    ))
);
SignInAltIconBoldDuotone.displayName = "SignInAltIconBoldDuotone";
export { SignInAltIconBoldDuotone };
