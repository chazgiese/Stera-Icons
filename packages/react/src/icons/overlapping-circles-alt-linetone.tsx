...
const OverlappingCirclesAltIconLinetone = memo(
...
OverlappingCirclesAltIconLinetone.displayName =
  "OverlappingCirclesAltIconLinetone";
export { OverlappingCirclesAltIconLinetone };
