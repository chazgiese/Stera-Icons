...
const ArrowRotateCircleLeftIconFilled = memo(
...
ArrowRotateCircleLeftIconFilled.displayName = "ArrowRotateCircleLeftIconFilled";
export { ArrowRotateCircleLeftIconFilled };
