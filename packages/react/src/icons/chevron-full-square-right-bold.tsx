...
const ChevronFullSquareRightIconBold = memo(
...
ChevronFullSquareRightIconBold.displayName = "ChevronFullSquareRightIconBold";
export { ChevronFullSquareRightIconBold };
