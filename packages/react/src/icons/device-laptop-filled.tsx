  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M22.929 19.629a1 1 0 0 1-.93 1.371H2a1 1 0 0 1-.928-1.371l1.326-3.315A.5.5 0 0 1 2.86 16h18.278a.5.5 0 0 1 .464.314zM17.6 3c.403 0 .767-.001 1.067.023.312.026.643.084.968.25.47.24.853.622 1.092 1.092.166.325.224.656.25.968.024.3.023.664.023 1.067v7.1a.5.5 0 0 1-.5.5h-17a.5.5 0 0 1-.5-.5V6.4c0-.403-.001-.767.023-1.067.026-.312.084-.643.25-.968.24-.47.622-.853 1.092-1.093.325-.165.656-.223.968-.249C5.633 3 5.997 3 6.4 3z"
        />
      </svg>
    ))
);
