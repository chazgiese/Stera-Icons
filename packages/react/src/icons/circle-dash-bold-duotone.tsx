...
const CircleDashIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M3.128 16.725a1 1 0 0 1 1.388.274A9.1 9.1 0 0 0 7 19.484a1 1 0 0 1-1.112 1.662 11.1 11.1 0 0 1-3.035-3.035 1 1 0 0 1 .275-1.386M19.484 17a1 1 0 0 1 1.662 1.111 11.1 11.1 0 0 1-3.034 3.035A1 1 0 1 1 17 19.484a9.1 9.1 0 0 0 2.484-2.485M5.888 2.853A1 1 0 1 1 7 4.515a9.1 9.1 0 0 0-2.484 2.484 1 1 0 0 1-1.663-1.112 11.1 11.1 0 0 1 3.035-3.034M16.726 3.127a1 1 0 0 1 1.386-.274c1.2.802 2.232 1.835 3.034 3.034a1 1 0 1 1-1.662 1.112A9.1 9.1 0 0 0 17 4.515a1 1 0 0 1-.274-1.388" />
        </g>
        <path
          fill="currentColor"
...
CircleDashIconBoldDuotone.displayName = "CircleDashIconBoldDuotone";
export { CircleDashIconBoldDuotone };
