...
const VolleyballRegularDuotone = memo(
  forwardRef<SVGSVGElement, VolleyballRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.76 11.74a6 6 0 0 1 1.5-.02 14 14 0 0 0 2.2 6.26c.85 1.28 1.9 2.34 3.05 3.26a9 9 0 0 1-2.89-.63q-.76-.82-1.41-1.8a16 16 0 0 1-2.45-7.07M20 7.35q.74 1.28 1.06 2.77c-.86 2.83-3 5.63-6.8 7.91a7 7 0 0 1-.75-1.3c4.64-2.78 6.4-6.26 6.49-9.38M5.98 4.98a10 10 0 0 1 4.76.03 13 13 0 0 1 4.69 2.22q-.36.6-.85 1.24a11.35 11.35 0 0 0-4.2-2A7.7 7.7 0 0 0 3.87 7.6q.82-1.52 2.12-2.63" />
...
export { VolleyballRegularDuotone };
