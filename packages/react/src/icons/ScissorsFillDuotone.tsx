...
const ScissorsFillDuotone = memo(
  forwardRef<SVGSVGElement, ScissorsFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M22.4 16.26c.35.2.48.64.3 1a2.06 2.06 0 0 1-2.44 1.02l-9.03-2.77 4.93-2.86z" />
        <path fillRule="evenodd" d="M1.28 5.5a3.75 3.75 0 0 1 6.94 2.57l.76.44a4 4 0 0 0-.7 1.15l-.41 1.09-.9-.52A3.75 3.75 0 0 1 1.28 5.5m3.88.8A1.25 1.25 0 1 0 3.9 8.46 1.25 1.25 0 0 0 5.16 6.3" clipRule="evenodd" />
