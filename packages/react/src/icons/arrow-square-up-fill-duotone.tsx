...
const ArrowSquareUpIconFillDuotone = memo(
...
ArrowSquareUpIconFillDuotone.displayName = "ArrowSquareUpIconFillDuotone";
export { ArrowSquareUpIconFillDuotone };
