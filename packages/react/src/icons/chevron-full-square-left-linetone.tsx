...
const ChevronFullSquareLeftIconLinetone = memo(
...
ChevronFullSquareLeftIconLinetone.displayName =
  "ChevronFullSquareLeftIconLinetone";
export { ChevronFullSquareLeftIconLinetone };
