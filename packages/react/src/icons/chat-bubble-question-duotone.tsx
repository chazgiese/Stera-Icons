...
const ChatBubbleQuestionIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 12.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 6.25c1.354 0 2.75.905 2.75 2.35 0 1.072-.8 1.866-1.72 2.181a.6.6 0 0 0-.238.147c-.044.048-.042.072-.042.072a.75.75 0 0 1-1.5 0c0-.893.718-1.44 1.293-1.638.507-.173.707-.514.707-.762 0-.322-.395-.85-1.25-.85-.745 0-1.199.421-1.273.715a.75.75 0 0 1-1.453-.37C9.57 6.93 10.81 6.25 12 6.25"
        />
      </svg>
    ))
);
ChatBubbleQuestionIconDuotone.displayName = "ChatBubbleQuestionIconDuotone";
export { ChatBubbleQuestionIconDuotone };
