...
const MailboxRegularDuotone = memo(
  forwardRef<SVGSVGElement, MailboxRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M17.5 5.25c2.9 0 5.25 2.35 5.25 5.25V17A2.75 2.75 0 0 1 20 19.75h-9c.41 0 .75-.34.75-.75v-.75H20c.69 0 1.25-.56 1.25-1.25v-6.5a3.75 3.75 0 0 0-3.75-3.75h-7.33a5.2 5.2 0 0 0-3.67-1.5zM7.25 10.25a.75.75 0 0 1 0 1.5h-1.5a.75.75 0 0 1 0-1.5z" />
