...
const LayersAltRegularDuotone = memo(
  forwardRef<SVGSVGElement, LayersAltRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M20.67 15.83a.75.75 0 0 1 .66 1.34l-7.2 3.6a4.8 4.8 0 0 1-4.25 0l-7.21-3.6a.75.75 0 0 1 .66-1.34l7.22 3.6c.91.46 1.99.46 2.9 0z" />
        <path d="M20.67 11.83a.75.75 0 0 1 .66 1.34l-7.2 3.6a4.8 4.8 0 0 1-4.25 0l-7.21-3.6a.75.75 0 0 1 .66-1.34l7.22 3.6c.91.46 1.99.46 2.9 0z" />
...
export { LayersAltRegularDuotone };
