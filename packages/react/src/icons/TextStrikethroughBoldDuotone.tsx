...
const TextStrikethroughBoldDuotone = memo(
  forwardRef<SVGSVGElement, TextStrikethroughBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M17.74 13a5.5 5.5 0 0 1-4.24 9H7a1 1 0 1 1 0-2h6.5a3.5 3.5 0 1 0 0-7zM17 2a1 1 0 1 1 0 2h-5.5a3.5 3.5 0 0 0-.14 7h-4.1a5.5 5.5 0 0 1 4.25-9z" />
...
export { TextStrikethroughBoldDuotone };
