...
const PoundSterlingCircleIconLinetone = memo(
...
PoundSterlingCircleIconLinetone.displayName = "PoundSterlingCircleIconLinetone";
export { PoundSterlingCircleIconLinetone };
