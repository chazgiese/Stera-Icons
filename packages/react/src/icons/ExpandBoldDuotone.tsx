...
const ExpandBoldDuotone = memo(
  forwardRef<SVGSVGElement, ExpandBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14.3 14.3a1 1 0 0 1 1.4 0l3.3 3.29V19h-1.41l-3.3-3.3a1 1 0 0 1 0-1.4M8.3 14.3a1 1 0 1 1 1.4 1.4L6.42 19H5v-1.41zM9.7 8.3a1 1 0 0 1-1.4 1.4L5 6.42V5h1.41zM19 5v1.41l-3.3 3.3a1 1 0 1 1-1.4-1.42L17.58 5z" />
