...
const TvPlayAltIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M10.395 2.054a1 1 0 1 0-1.79.892L9.63 5h2.234zM12.132 5h2.236l.527-1.053a1 1 0 0 0-1.79-.894z"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
          d="M10.393 9.729c.322-.035.715.19 1.5.639l2.176 1.243c.797.455 1.195.683 1.329.98.116.26.116.558 0 .818-.134.298-.532.525-1.328.98l-2.176 1.243c-.786.45-1.18.674-1.501.639a1 1 0 0 1-.702-.407c-.19-.263-.19-.716-.19-1.621v-2.486c0-.905 0-1.358.19-1.62a1 1 0 0 1 .702-.408"
        />
      </svg>
    ))
);
TvPlayAltIconBoldDuotone.displayName = "TvPlayAltIconBoldDuotone";
export { TvPlayAltIconBoldDuotone };
