  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.393 9.729c.322-.035.715.19 1.5.639l2.176 1.243c.797.455 1.195.683 1.329.98.116.26.116.558 0 .818-.134.298-.532.525-1.329.98l-2.175 1.243c-.786.45-1.18.674-1.501.639a1 1 0 0 1-.703-.407c-.19-.263-.19-.716-.19-1.621v-2.486c0-.905 0-1.358.19-1.62a1 1 0 0 1 .703-.408"
        />
      </svg>
    ))
);
