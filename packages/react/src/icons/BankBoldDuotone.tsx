...
const BankBoldDuotone = memo(
  forwardRef<SVGSVGElement, BankBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.75 17c1.24 0 2.25 1 2.25 2.25V20h-2v-.75a.25.25 0 0 0-.25-.25H5.25a.25.25 0 0 0-.25.25V20H3v-.75C3 18.01 4 17 5.25 17z" />
        <path fillRule="evenodd" d="M11.58 2.1a1 1 0 0 1 .97.07l9 6A1 1 0 0 1 21 10H3a1 1 0 0 1-.55-1.83l9-6zM6.3 8h11.4L12 4.2z" clipRule="evenodd" />
