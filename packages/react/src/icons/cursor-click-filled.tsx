  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M8.092 10.32c-.459-1.377.851-2.687 2.228-2.228l10.475 3.491c1.637.546 1.595 2.876-.06 3.362l-4.474 1.316-1.316 4.474c-.487 1.656-2.816 1.697-3.362.06zM4.293 12.293a1 1 0 0 1 1.414 1.414l-1.414 1.414a1 1 0 1 1-1.414-1.414zM1.273 6.93a1 1 0 0 1 1.225-.706l1.932.517a1 1 0 0 1-.518 1.932l-1.931-.518a1 1 0 0 1-.708-1.224M13.707 2.879a1 1 0 0 1 1.414 1.414l-1.414 1.414a1 1 0 0 1-1.414-1.414zM6.93 1.273a1 1 0 0 1 1.224.707l.518 1.931a1 1 0 1 1-1.932.518l-.517-1.932a1 1 0 0 1 .707-1.224"
        />
      </svg>
    ))
);
