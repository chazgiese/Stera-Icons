...
const ScanSearchIconFilltone = memo(
    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M10.5 5a6 6 0 0 1 5.295 8.82l2.442 2.443a1.75 1.75 0 1 1-2.474 2.474l-2.443-2.442A6 6 0 1 1 10.5 5m0 3a3 3 0 1 0 0 6 3 3 0 0 0 0-6"
          clipRule="evenodd"
        />
      </svg>
    ))
);
ScanSearchIconFilltone.displayName = "ScanSearchIconFilltone";
export { ScanSearchIconFilltone };
