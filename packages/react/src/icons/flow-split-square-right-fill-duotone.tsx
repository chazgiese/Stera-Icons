...
const FlowSplitSquareRightIconFillDuotone = memo(
...
FlowSplitSquareRightIconFillDuotone.displayName =
  "FlowSplitSquareRightIconFillDuotone";
export { FlowSplitSquareRightIconFillDuotone };
