...
const ChevronSquareRightIconFilltone = memo(
...
ChevronSquareRightIconFilltone.displayName = "ChevronSquareRightIconFilltone";
export { ChevronSquareRightIconFilltone };
