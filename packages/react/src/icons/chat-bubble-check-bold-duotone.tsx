...
const ChatBubbleCheckIconBoldDuotone = memo(
...
ChatBubbleCheckIconBoldDuotone.displayName = "ChatBubbleCheckIconBoldDuotone";
export { ChatBubbleCheckIconBoldDuotone };
