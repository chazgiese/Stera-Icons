...
const ArrowUpLeftDownRightIconFilled = memo(
...
ArrowUpLeftDownRightIconFilled.displayName = "ArrowUpLeftDownRightIconFilled";
export { ArrowUpLeftDownRightIconFilled };
