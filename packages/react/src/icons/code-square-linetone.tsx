...
const CodeSquareIconLinetone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12.552 7.184a1 1 0 1 1 1.896.633l-3 9a1 1 0 0 1-1.896-.633zM7.293 9.293a1 1 0 1 1 1.414 1.414L7.414 12l1.293 1.293a1 1 0 0 1-1.414 1.414l-2-2a1 1 0 0 1 0-1.414zM15.293 9.293a1 1 0 0 1 1.414 0l2 2a1 1 0 0 1 0 1.414l-2 2a1 1 0 0 1-1.414-1.414L16.586 12l-1.293-1.293a1 1 0 0 1 0-1.414"
        />
      </svg>
    ))
);
CodeSquareIconLinetone.displayName = "CodeSquareIconLinetone";
export { CodeSquareIconLinetone };
