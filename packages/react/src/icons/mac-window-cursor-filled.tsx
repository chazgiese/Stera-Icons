...
const MacWindowCursorIconFilled = memo(
  ...
  IconProps >
    ((
      ...
      <svg
        ...
        {...props}
      >
        <g fill="currentColor" clipPath="url(#clip0_5072_11120)">
          <path d="M13.128 13.111c-.396-1.188.687-2.32 1.87-2.017l.114.033 7.817 2.605c1.457.486 1.42 2.56-.054 2.994l-3.206.942-.942 3.206c-.434 1.473-2.508 1.51-2.994.054z" />
...
MacWindowCursorIconFilled.displayName = "MacWindowCursorIconFilled";
export { MacWindowCursorIconFilled };
