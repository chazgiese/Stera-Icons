...
const AudioBarsCircleIconBoldDuotone = memo(
...
AudioBarsCircleIconBoldDuotone.displayName = "AudioBarsCircleIconBoldDuotone";
export { AudioBarsCircleIconBoldDuotone };
