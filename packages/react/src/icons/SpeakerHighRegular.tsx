...
const SpeakerHighRegular = memo(
  forwardRef<SVGSVGElement, SpeakerHighRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M19.92 3.42a.75.75 0 0 1 1.05.15A14 14 0 0 1 23.75 12c0 3.17-1.04 6.1-2.78 8.43a.75.75 0 0 1-1.2-.9A12.5 12.5 0 0 0 22.25 12c0-2.84-.93-5.45-2.48-7.53a.75.75 0 0 1 .15-1.05" />
        ...
        <path fill="currentColor" d="M17.16 5.55a.75.75 0 0 1 1.05.14 9.96 9.96 0 0 1-.27 12.45.75.75 0 0 1-1.15-.96A8.46 8.46 0 0 0 17 6.6a.75.75 0 0 1 .15-1.05" />
        <path fill="currentColor" d="M14.3 7.75c.33-.25.8-.2 1.05.13a6.7 6.7 0 0 1 0 8.24.75.75 0 0 1-1.19-.92 5.2 5.2 0 0 0 0-6.4.75.75 0 0 1 .14-1.05" />
    </IconBase>
  ))
);
