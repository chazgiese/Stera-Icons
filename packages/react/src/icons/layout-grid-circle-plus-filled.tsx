...
const LayoutGridCirclePlusIconFilled = memo(
...
LayoutGridCirclePlusIconFilled.displayName = "LayoutGridCirclePlusIconFilled";
export { LayoutGridCirclePlusIconFilled };
