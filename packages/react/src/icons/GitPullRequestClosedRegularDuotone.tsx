...
const GitPullRequestClosedRegularDuotone = memo(
  forwardRef<SVGSVGElement, GitPullRequestClosedRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.25 15.34a3 3 0 0 0-1.5 0V8.66a3 3 0 0 0 1.5 0zM18.5 10.25c.41 0 .75.34.75.75v4.34a3 3 0 0 0-1.5 0V11c0-.41.34-.75.75-.75" />
...
export { GitPullRequestClosedRegularDuotone };
