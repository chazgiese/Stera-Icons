...
const HeartFillDuotone = memo(
  forwardRef<SVGSVGElement, HeartFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M16.76 4A4.3 4.3 0 0 1 21 8.34a7.6 7.6 0 0 1-1.54 4.26c-2.1 3-4.94 5.1-7.46 7.12-2.52-2.02-5.36-4.12-7.46-7.12A7.6 7.6 0 0 1 3 8.34 4.3 4.3 0 0 1 7.24 4c1.7 0 3.17 1.03 3.85 2.53a1 1 0 0 0 1.82 0A4.2 4.2 0 0 1 16.76 4" opacity={.4} />
