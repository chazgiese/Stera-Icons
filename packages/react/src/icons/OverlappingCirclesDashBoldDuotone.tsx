...
const OverlappingCirclesDashBoldDuotone = memo(
  forwardRef<SVGSVGElement, OverlappingCirclesDashBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M8.5 4.5c1.49 0 2.87.43 4.04 1.18a1 1 0 0 1-.22 1.79 1 1 0 0 0-1.39-1.42q-.42.33-.79.7a5.5 5.5 0 1 0 0 10.5q.37.37.8.7a1 1 0 0 0 1.38-1.42 1 1 0 0 1 .22 1.79A7.5 7.5 0 1 1 8.5 4.5" opacity={.4} />
...
export { OverlappingCirclesDashBoldDuotone };
