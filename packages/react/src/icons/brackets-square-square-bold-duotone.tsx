...
const BracketsSquareSquareIconBoldDuotone = memo(
...
BracketsSquareSquareIconBoldDuotone.displayName =
  "BracketsSquareSquareIconBoldDuotone";
export { BracketsSquareSquareIconBoldDuotone };
