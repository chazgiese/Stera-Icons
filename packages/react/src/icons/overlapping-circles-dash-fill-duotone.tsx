...
const OverlappingCirclesDashIconFillDuotone = memo(
...
OverlappingCirclesDashIconFillDuotone.displayName =
  "OverlappingCirclesDashIconFillDuotone";
export { OverlappingCirclesDashIconFillDuotone };
