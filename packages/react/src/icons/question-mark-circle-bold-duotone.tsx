...
const QuestionMarkCircleIconBoldDuotone = memo(
...
QuestionMarkCircleIconBoldDuotone.displayName =
  "QuestionMarkCircleIconBoldDuotone";
export { QuestionMarkCircleIconBoldDuotone };
