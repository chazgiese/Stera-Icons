...
const ChevronFullCircleRightIconLinetone = memo(
...
ChevronFullCircleRightIconLinetone.displayName =
  "ChevronFullCircleRightIconLinetone";
export { ChevronFullCircleRightIconLinetone };
