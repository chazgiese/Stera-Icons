...
const BookmarkIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M16 3a3 3 0 0 1 3 3v14.246a.5.5 0 0 1-.825.38l-4.227-3.61a3 3 0 0 0-3.896 0l-4.227 3.61a.5.5 0 0 1-.825-.38V6a3 3 0 0 1 3-3z"
          opacity={0.4}
        />
      </svg>
    ))
);
BookmarkIconFillDuotone.displayName = "BookmarkIconFillDuotone";
export { BookmarkIconFillDuotone };
