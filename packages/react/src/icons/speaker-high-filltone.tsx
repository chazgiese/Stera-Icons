  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M8.16 4.427C9.576 3.01 12 4.014 12 6.017v11.966c0 2.004-2.423 3.008-3.84 1.59l-3.5-3.5A.25.25 0 0 0 4.481 16H2.25A2.25 2.25 0 0 1 0 13.75v-3.5A2.25 2.25 0 0 1 2.25 8h2.232a.25.25 0 0 0 .177-.073z"
        />
      </svg>
    ))
);
