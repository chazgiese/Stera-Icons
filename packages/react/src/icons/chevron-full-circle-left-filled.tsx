...
const ChevronFullCircleLeftIconFilled = memo(
...
ChevronFullCircleLeftIconFilled.displayName = "ChevronFullCircleLeftIconFilled";
export { ChevronFullCircleLeftIconFilled };
