...
const ChatBubbleQuestionIconBoldDuotone = memo(
...
ChatBubbleQuestionIconBoldDuotone.displayName =
  "ChatBubbleQuestionIconBoldDuotone";
export { ChatBubbleQuestionIconBoldDuotone };
