...
const BracketsSquareCircleIconFillDuotone = memo(
...
BracketsSquareCircleIconFillDuotone.displayName =
  "BracketsSquareCircleIconFillDuotone";
export { BracketsSquareCircleIconFillDuotone };
