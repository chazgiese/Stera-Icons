...
const ListBulletSimpleIconBoldDuotone = memo(
...
ListBulletSimpleIconBoldDuotone.displayName = "ListBulletSimpleIconBoldDuotone";
export { ListBulletSimpleIconBoldDuotone };
