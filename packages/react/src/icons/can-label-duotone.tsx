...
const CanLabelIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M17.24 16.25a5.3 5.3 0 0 1-.327 1.5H7.087a5.3 5.3 0 0 1-.326-1.5zM12 10a2 2 0 1 1 0 4 2 2 0 0 1 0-4M16.913 6.25c.18.481.293.986.326 1.5H6.761a5.3 5.3 0 0 1 .326-1.5z"
        />
      </svg>
    ))
);
CanLabelIconDuotone.displayName = "CanLabelIconDuotone";
export { CanLabelIconDuotone };
