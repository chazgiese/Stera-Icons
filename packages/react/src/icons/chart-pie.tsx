  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M7.7 2.145a.75.75 0 0 1 .6 1.375A9.25 9.25 0 1 0 20.48 15.7a.75.75 0 0 1 1.375.6A10.75 10.75 0 0 1 12 22.75C6.063 22.75 1.25 17.937 1.25 12c0-4.41 2.655-8.197 6.45-9.855"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
