...
const ChevronSquareDownIconBold = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M15.793 9.293a1 1 0 0 1 1.414 1.414l-4.5 4.5a1 1 0 0 1-1.414 0l-4.5-4.5a1 1 0 1 1 1.414-1.414L12 13.086z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
...
ChevronSquareDownIconBold.displayName = "ChevronSquareDownIconBold";
export { ChevronSquareDownIconBold };
