...
const BracketsSquareCircleIconDuotone = memo(
...
BracketsSquareCircleIconDuotone.displayName = "BracketsSquareCircleIconDuotone";
export { BracketsSquareCircleIconDuotone };
