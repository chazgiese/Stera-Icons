...
const RectangleDashedBoldDuotone = memo(
  forwardRef<SVGSVGElement, RectangleDashedBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M15 19a1 1 0 1 1 0 2H9a1 1 0 1 1 0-2zM2 10a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1M22 10a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1M15 3a1 1 0 1 1 0 2H9a1 1 0 0 1 0-2z" />
...
export { RectangleDashedBoldDuotone };
