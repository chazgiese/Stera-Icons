...
const PanelTopFloatingIconFillDuotone = memo(
...
PanelTopFloatingIconFillDuotone.displayName = "PanelTopFloatingIconFillDuotone";
export { PanelTopFloatingIconFillDuotone };
