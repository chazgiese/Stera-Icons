...
const FlowSplitSquareDownIconFillDuotone = memo(
...
FlowSplitSquareDownIconFillDuotone.displayName =
  "FlowSplitSquareDownIconFillDuotone";
export { FlowSplitSquareDownIconFillDuotone };
