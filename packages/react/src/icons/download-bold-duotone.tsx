...
const DownloadIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 2a1 1 0 0 1 1 1v10.586l4.293-4.293a1 1 0 0 1 1.414 1.414l-6 6a1 1 0 0 1-1.338.068l-.076-.068-6-6a1 1 0 1 1 1.414-1.414L11 13.586V3a1 1 0 0 1 1-1"
        />
      </svg>
    ))
);
DownloadIconBoldDuotone.displayName = "DownloadIconBoldDuotone";
export { DownloadIconBoldDuotone };
