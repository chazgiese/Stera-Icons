...
const WristWatchRegularDuotone = memo(
  forwardRef<SVGSVGElement, WristWatchRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16.75 21A2.75 2.75 0 0 1 14 23.75h-4A2.75 2.75 0 0 1 7.25 21v-2.88q.69.54 1.5.92V21c0 .69.56 1.25 1.25 1.25h4c.69 0 1.25-.56 1.25-1.25v-1.96a8 8 0 0 0 1.5-.92zM14 .25A2.75 2.75 0 0 1 16.75 3v2.88a8 8 0 0 0-1.5-.92V3c0-.69-.56-1.25-1.25-1.25h-4c-.69 0-1.25.56-1.25 1.25v1.96q-.81.38-1.5.92V3A2.75 2.75 0 0 1 10 .25z" />
...
export { WristWatchRegularDuotone };
