...
const ScanTextIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M13 14.5a1 1 0 1 1 0 2H7a1 1 0 1 1 0-2zM17 11a1 1 0 1 1 0 2H7a1 1 0 1 1 0-2zM17 7.5a1 1 0 1 1 0 2H7a1 1 0 0 1 0-2z"
        />
      </svg>
    ))
);
ScanTextIconBoldDuotone.displayName = "ScanTextIconBoldDuotone";
export { ScanTextIconBoldDuotone };
