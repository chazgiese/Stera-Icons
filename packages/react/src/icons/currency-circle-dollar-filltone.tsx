...
const CurrencyCircleDollarIconFilltone = memo(
...
CurrencyCircleDollarIconFilltone.displayName =
  "CurrencyCircleDollarIconFilltone";
export { CurrencyCircleDollarIconFilltone };
