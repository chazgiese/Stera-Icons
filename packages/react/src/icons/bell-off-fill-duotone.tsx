    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path
            fillRule="evenodd"
            d="M17.335 18.75h-.391a5 5 0 0 1-9.888 0H3.65c-1.749 0-2.83-1.908-1.93-3.407l1.068-1.778a3.25 3.25 0 0 0 .462-1.673V10a8.7 8.7 0 0 1 1.095-4.24zm-8.237 0A3 3 0 0 0 12.001 21a3 3 0 0 0 2.9-2.25z"
            clipRule="evenodd"
          />
