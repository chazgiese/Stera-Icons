...
const ArrowRotateCircleRightIconFilled = memo(
...
ArrowRotateCircleRightIconFilled.displayName =
  "ArrowRotateCircleRightIconFilled";
export { ArrowRotateCircleRightIconFilled };
