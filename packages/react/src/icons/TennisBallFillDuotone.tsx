...
const TennisBallFillDuotone = memo(
  forwardRef<SVGSVGElement, TennisBallFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.62 3.84A10.96 10.96 0 0 1 19 3.51a10.98 10.98 0 0 0 0 16.98 10.96 10.96 0 0 1-14 0A10.98 10.98 0 0 0 5 3.5z" />
        <path d="M3.57 4.93a8.98 8.98 0 0 1 0 14.14 10.95 10.95 0 0 1 0-14.14M20.43 4.93a10.95 10.95 0 0 1 0 14.14 8.98 8.98 0 0 1 0-14.14" />
