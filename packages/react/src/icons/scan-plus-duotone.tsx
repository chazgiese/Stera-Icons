...
const ScanPlusIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 7.25a.75.75 0 0 1 .75.75v3.245h3.255a.75.75 0 0 1 0 1.5H12.75V16a.75.75 0 0 1-1.5 0v-3.255H8.005a.75.75 0 0 1 0-1.5h3.245V8a.75.75 0 0 1 .75-.75"
        />
      </svg>
    ))
);
ScanPlusIconDuotone.displayName = "ScanPlusIconDuotone";
export { ScanPlusIconDuotone };
