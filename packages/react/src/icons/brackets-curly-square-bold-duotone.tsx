...
const BracketsCurlySquareIconBoldDuotone = memo(
...
BracketsCurlySquareIconBoldDuotone.displayName =
  "BracketsCurlySquareIconBoldDuotone";
export { BracketsCurlySquareIconBoldDuotone };
