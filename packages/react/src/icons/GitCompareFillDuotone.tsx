...
const GitCompareFillDuotone = memo(
  forwardRef<SVGSVGElement, GitCompareFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M20 16a4 4 0 0 1-4 4h-2.59l-1-1 1-1H16a2 2 0 0 0 2-2V8.35a3.5 3.5 0 0 0 2 0zM11.59 5l-1 1H8a2 2 0 0 0-2 2v7.65a3.5 3.5 0 0 0-2 0V8a4 4 0 0 1 4-4h2.59z" />
