...
const HourglassIconLinetone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M14.562 6.068a1 1 0 0 1 .625 1.782l-1.285 1.027c-.437.35-.777.767-1.022 1.22a1 1 0 0 1-.15.206 6.4 6.4 0 0 0-.23 1.691q0 1.734.376 3.468l2.831 2.831A1 1 0 0 1 15 20H9a1 1 0 0 1-.707-1.707l2.83-2.831q.376-1.734.377-3.468 0-.846-.232-1.691a1 1 0 0 1-.148-.205 4 4 0 0 0-1.022-1.221L8.813 7.85a1 1 0 0 1 .625-1.782z"
        />
      </svg>
    ))
);
HourglassIconLinetone.displayName = "HourglassIconLinetone";
export { HourglassIconLinetone };
