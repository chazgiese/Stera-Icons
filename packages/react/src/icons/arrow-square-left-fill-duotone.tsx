...
const ArrowSquareLeftIconFillDuotone = memo(
...
ArrowSquareLeftIconFillDuotone.displayName = "ArrowSquareLeftIconFillDuotone";
export { ArrowSquareLeftIconFillDuotone };
