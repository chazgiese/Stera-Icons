...
const FlowSplitArrowDownIconFillDuotone = memo(
...
FlowSplitArrowDownIconFillDuotone.displayName =
  "FlowSplitArrowDownIconFillDuotone";
export { FlowSplitArrowDownIconFillDuotone };
