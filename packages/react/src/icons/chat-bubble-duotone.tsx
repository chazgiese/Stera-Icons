  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M4.368 16.697a.75.75 0 0 1 .628.855c-.014.09-.036.169-.05.216l-.025.088-.555 2.216a.25.25 0 0 0 .355.285l3.55-1.775a.75.75 0 0 1 .67 1.342l-3.55 1.774c-1.337.669-2.842-.539-2.48-1.989l.554-2.217.024-.089.01-.032.008-.025c.009-.031.008-.031.006-.02a.75.75 0 0 1 .855-.629"
        />
        <path
          fill="currentColor"
