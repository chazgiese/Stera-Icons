...
const ShieldBanIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        ...
        <g fill="currentColor" opacity={0.4}>
          <path d="M17.822 15.531a11 11 0 0 1-1.071 1.714L5 7.173v-1.48l.935-.351zM3.2 4.402q.019-.027.041-.052l.013-.014z" />
        </g>
      </svg>
    ))
);
ShieldBanIconBoldDuotone.displayName = "ShieldBanIconBoldDuotone";
export { ShieldBanIconBoldDuotone };
