...
const ChartWaterfallXIconBoldDuotone = memo(
...
ChartWaterfallXIconBoldDuotone.displayName = "ChartWaterfallXIconBoldDuotone";
export { ChartWaterfallXIconBoldDuotone };
