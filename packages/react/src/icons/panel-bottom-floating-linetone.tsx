...
const PanelBottomFloatingIconLinetone = memo(
...
PanelBottomFloatingIconLinetone.displayName = "PanelBottomFloatingIconLinetone";
export { PanelBottomFloatingIconLinetone };
