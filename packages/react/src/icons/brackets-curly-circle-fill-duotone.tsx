...
const BracketsCurlyCircleIconFillDuotone = memo(
...
BracketsCurlyCircleIconFillDuotone.displayName =
  "BracketsCurlyCircleIconFillDuotone";
export { BracketsCurlyCircleIconFillDuotone };
