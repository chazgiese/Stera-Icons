  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M4.622 17.072q.28.361.612.694.396.393.83.717c-.154.209-.326.45-.501.715-.472.713-.906 1.493-1.114 2.118a1 1 0 1 1-1.896-.632c.29-.873.837-1.825 1.342-2.588.246-.372.498-.725.727-1.024"
        />
        <path
          fill="currentColor"
