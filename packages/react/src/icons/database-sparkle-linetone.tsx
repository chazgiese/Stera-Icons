...
const DatabaseSparkleIconLinetone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15.541 10.072a.5.5 0 0 1 .919 0l1.01 2.357a4 4 0 0 0 2.101 2.101l2.357 1.01a.5.5 0 0 1 0 .92l-2.357 1.01a4 4 0 0 0-2.101 2.101l-1.01 2.356a.5.5 0 0 1-.919 0l-1.01-2.356a4 4 0 0 0-2.101-2.102l-2.358-1.01a.5.5 0 0 1 0-.918l2.358-1.011a4 4 0 0 0 2.1-2.1z"
        />
      </svg>
    ))
);
DatabaseSparkleIconLinetone.displayName = "DatabaseSparkleIconLinetone";
export { DatabaseSparkleIconLinetone };
