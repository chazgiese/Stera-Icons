...
const DocumentIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15.2 10H19v-.337c0-.245 0-.367-.028-.482a1 1 0 0 0-.12-.29c-.061-.1-.148-.187-.32-.36L13.468 3.47c-.173-.173-.26-.26-.36-.322a1 1 0 0 0-.29-.12C12.704 3 12.582 3 12.337 3H12v3.8c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874C13.52 10 14.08 10 15.2 10"
        />
      </svg>
    ))
);
DocumentIconFillDuotone.displayName = "DocumentIconFillDuotone";
export { DocumentIconFillDuotone };
