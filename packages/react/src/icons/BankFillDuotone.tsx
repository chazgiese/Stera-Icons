...
const BankFillDuotone = memo(
  forwardRef<SVGSVGElement, BankFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.75 17c1.24 0 2.25 1 2.25 2.25V20H3v-.75C3 18.01 4 17 5.25 17z" />
        <path fillRule="evenodd" d="M11.58 2.1a1 1 0 0 1 .97.07l9 6A1 1 0 0 1 21 10H3a1 1 0 0 1-.55-1.83l9-6zM12 5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3" clipRule="evenodd" />
