...
const PencilTipFillDuotone = memo(
  forwardRef<SVGSVGElement, PencilTipFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m4 12.12 2.66 1.33a3 3 0 0 0 2.68 0l1.66-.83V23H6a2 2 0 0 1-2-2zM20 21a2 2 0 0 1-2 2h-5V12.62l1.66.83a3 3 0 0 0 2.68 0l.66-.33 2-1zM19.16 9.57q.24.31.4.65l-.04-.1-3.07 1.54a1 1 0 0 1-.9 0l-2.2-1.1a3 3 0 0 0-2.7 0l-2.2 1.1a1 1 0 0 1-.9 0l-3.07-1.53-.05.1a4 4 0 0 1 .41-.66L8.02 5.5l.74.62a5.1 5.1 0 0 0 6.48 0l.74-.62z" />
