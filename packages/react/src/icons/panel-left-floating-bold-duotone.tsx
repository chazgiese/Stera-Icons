...
const PanelLeftFloatingIconBoldDuotone = memo(
...
PanelLeftFloatingIconBoldDuotone.displayName =
  "PanelLeftFloatingIconBoldDuotone";
export { PanelLeftFloatingIconBoldDuotone };
