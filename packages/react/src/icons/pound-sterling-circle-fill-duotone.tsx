...
const PoundSterlingCircleIconFillDuotone = memo(
...
PoundSterlingCircleIconFillDuotone.displayName =
  "PoundSterlingCircleIconFillDuotone";
export { PoundSterlingCircleIconFillDuotone };
