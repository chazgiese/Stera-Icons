    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M1.293 1.293a1 1 0 0 1 1.414 0l12.228 12.228a1 1 0 0 1 .12.12l2.724 2.724q.068.055.125.124l.003.004 4.8 4.8a1 1 0 1 1-1.414 1.414l-4.252-4.252a8.96 8.96 0 0 1-4.04 1.487V21h2a1 1 0 0 1 0 2H9a1 1 0 1 1 0-2h2v-1.058c-4.5-.497-8-4.31-8-8.942a1 1 0 1 1 2 0 7 7 0 0 0 10.592 6.007l-1.479-1.479A5 5 0 0 1 7 11V8.414L1.293 2.707a1 1 0 0 1 0-1.414M9 11a3 3 0 0 0 3.536 2.95L9 10.414z"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
