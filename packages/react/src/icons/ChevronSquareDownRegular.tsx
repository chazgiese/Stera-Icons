...
const ChevronSquareDownRegular = memo(
  forwardRef<SVGSVGElement, ChevronSquareDownRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M15.97 9.47a.75.75 0 0 1 1.06 1.06l-4.5 4.5c-.3.3-.77.3-1.06 0l-4.5-4.5a.75.75 0 0 1 1.06-1.06L12 13.44z" />
...
export { ChevronSquareDownRegular };
