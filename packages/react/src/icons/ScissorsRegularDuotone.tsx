...
const ScissorsRegularDuotone = memo(
  forwardRef<SVGSVGElement, ScissorsRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M22.16 16.7c.11.06.15.2.1.32-.35.67-1.13 1-1.85.78l-9.04-2.77q-.38-.12-.7-.36l4-2.3z" />
        <path fillRule="evenodd" d="M1.72 5.75a3.25 3.25 0 0 1 5.92 2.56l1.9 1.1a3 3 0 0 0-.32.62l-.33.84-.05-.13L6.9 9.6a3.25 3.25 0 0 1-5.17-3.86m3.69.11A1.75 1.75 0 1 0 3.66 8.9 1.75 1.75 0 0 0 5.4 5.86" clipRule="evenodd" />
