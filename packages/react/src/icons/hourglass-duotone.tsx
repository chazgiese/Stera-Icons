...
const HourglassIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M14.679 6.327a.751.751 0 0 1 .351 1.327l-1.284 1.028c-.256.204-.48.432-.674.674-.185.233-.304.51-.37.801a8.5 8.5 0 0 0-.202 1.837q0 1.553.3 3.108a2.75 2.75 0 0 0 .773 1.41l1.957 1.958a.75.75 0 0 1-.53 1.28H9a.751.751 0 0 1-.53-1.28l1.957-1.957c.387-.388.667-.874.771-1.411q.302-1.555.302-3.108a8.4 8.4 0 0 0-.204-1.836 2 2 0 0 0-.37-.803 4.3 4.3 0 0 0-.672-.673L8.969 7.654a.751.751 0 0 1 .47-1.336h5.122z"
        />
      </svg>
    ))
);
HourglassIconDuotone.displayName = "HourglassIconDuotone";
export { HourglassIconDuotone };
