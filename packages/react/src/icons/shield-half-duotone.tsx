...
const ShieldHalfIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12.75 3.082v17.704l-.75.375-.75-.375V3.082l.75-.281z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
ShieldHalfIconDuotone.displayName = "ShieldHalfIconDuotone";
export { ShieldHalfIconDuotone };
