...
const SlidersFillDuotone = memo(
  forwardRef<SVGSVGElement, SlidersFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.13 16a4 4 0 0 0 0 2H2a1 1 0 1 1 0-2zM22 16a1 1 0 1 1 0 2h-3.13a4 4 0 0 0 0-2zM5.13 6a4 4 0 0 0 0 2H2a1 1 0 0 1 0-2zM22 6a1 1 0 1 1 0 2h-9.13a4 4 0 0 0 0-2z" />
