...
const OverlappingCirclesAltIconFilled = memo(
...
OverlappingCirclesAltIconFilled.displayName = "OverlappingCirclesAltIconFilled";
export { OverlappingCirclesAltIconFilled };
