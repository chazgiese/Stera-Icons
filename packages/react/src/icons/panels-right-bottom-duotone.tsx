...
const PanelsRightBottomIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M16.75 4.75v14.5h-1.5v-3.5H2.75v-1.5h12.5v-9.5z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
PanelsRightBottomIconDuotone.displayName = "PanelsRightBottomIconDuotone";
export { PanelsRightBottomIconDuotone };
