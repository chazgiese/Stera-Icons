  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M5 1.25c.199 0 .39.08.53.22l3 3a.75.75 0 0 1-1.06 1.06L5 3.06 2.53 5.53a.75.75 0 0 1-1.06-1.06l3-3 .114-.094A.75.75 0 0 1 5 1.25M19 1.25c.199 0 .39.08.53.22l3 3a.75.75 0 0 1-1.06 1.06L19 3.06l-2.47 2.47a.75.75 0 1 1-1.06-1.06l3-3 .114-.094A.75.75 0 0 1 19 1.25"
        />
      </svg>
    ))
);
