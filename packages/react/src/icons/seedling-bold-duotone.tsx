...
const SeedlingIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15.293 9.293a1 1 0 1 1 1.414 1.414l-1.657 1.657a7 7 0 0 0-2.05 4.95V21a1 1 0 0 1-.364.772.997.997 0 0 1-1.407-.136A1 1 0 0 1 11 21v-1.343c0-.795-.316-1.56-.879-2.122l-4.328-4.328a1 1 0 1 1 1.414-1.414l3.936 3.936a9 9 0 0 1 2.493-4.779z"
        />
      </svg>
    ))
);
SeedlingIconBoldDuotone.displayName = "SeedlingIconBoldDuotone";
export { SeedlingIconBoldDuotone };
