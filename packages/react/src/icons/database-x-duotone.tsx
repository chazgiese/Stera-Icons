...
const DatabaseXIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M17.97 12.97a.75.75 0 1 1 1.06 1.06L17.06 16l1.97 1.97a.75.75 0 1 1-1.06 1.06L16 17.06l-1.97 1.97a.75.75 0 1 1-1.06-1.06L14.94 16l-1.97-1.97a.75.75 0 1 1 1.06-1.06L16 14.94z"
        />
      </svg>
    ))
);
DatabaseXIconDuotone.displayName = "DatabaseXIconDuotone";
export { DatabaseXIconDuotone };
