...
const BracketsSquareSquareIconFilltone = memo(
...
BracketsSquareSquareIconFilltone.displayName =
  "BracketsSquareSquareIconFilltone";
export { BracketsSquareSquareIconFilltone };
