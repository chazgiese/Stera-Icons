...
const ChevronFullCircleDownIcon = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M15.897 9.75c.89 0 1.336 1.077.707 1.707l-3.72 3.72a1.25 1.25 0 0 1-1.768 0l-3.72-3.72c-.63-.63-.183-1.707.708-1.707z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
