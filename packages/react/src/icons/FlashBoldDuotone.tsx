...
const FlashBoldDuotone = memo(
  forwardRef<SVGSVGElement, FlashBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M15.71 1.25a1 1 0 1 1 1.32 1.5L6.96 11.62l3.63 1.25a1 1 0 0 1 .62 1.25l-2.62 8.19a1 1 0 0 1-1.9-.62L9 14.44l-4.33-1.5a1 1 0 0 1-.33-1.7z" />
