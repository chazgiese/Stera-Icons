    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M15.207 14.793a1 1 0 0 0-1.414 0l-1.5 1.5-.042.045 1.41 1.411q.024-.02.046-.042l1.5-1.5a1 1 0 0 0 0-1.414M12.207 11.793a1 1 0 0 0-1.414 0l-1.5 1.5-.043.045 1.412 1.411.045-.042 1.5-1.5a1 1 0 0 0 0-1.414M9.207 8.793a1 1 0 0 0-1.414 0l-1.5 1.5-.043.045 1.412 1.411.045-.042 1.5-1.5a1 1 0 0 0 0-1.414"
          clipRule="evenodd"
        />
      </svg>
    ))
