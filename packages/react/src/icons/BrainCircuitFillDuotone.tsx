...
const BrainCircuitFillDuotone = memo(
  forwardRef<SVGSVGElement, BrainCircuitFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M14.69 15a1 1 0 0 1 .87.5l1.03 1.78c-.7.11-1.31.48-1.74 1L14.11 17h-1.36v-2zM17.44 12a2.7 2.7 0 0 0 0 2h-4.69v-2zM18 9a1 1 0 0 1-1 1h-4.25V8H16V6.56a2.7 2.7 0 0 0 2 0z" />
...
export { BrainCircuitFillDuotone };
