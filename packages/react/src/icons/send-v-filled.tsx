  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M9.987 2.79c.83-1.658 3.196-1.657 4.025 0l8.1 16.2c.985 1.97-1.156 4.035-3.09 2.98L13 18.687V10a1 1 0 0 0-2 0v8.684L4.977 21.97c-1.934 1.054-4.074-1.011-3.09-2.982z"
        />
      </svg>
    ))
);
