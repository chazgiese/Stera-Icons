...
const RotateCircleRightIconFillDuotone = memo(
...
RotateCircleRightIconFillDuotone.displayName =
  "RotateCircleRightIconFillDuotone";
export { RotateCircleRightIconFillDuotone };
