...
const PanelRightFloatingIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M17.499 6.5a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H15a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
PanelRightFloatingIconDuotone.displayName = "PanelRightFloatingIconDuotone";
export { PanelRightFloatingIconDuotone };
