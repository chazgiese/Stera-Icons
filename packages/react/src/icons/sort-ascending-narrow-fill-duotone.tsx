...
const SortAscendingNarrowIconFillDuotone = memo(
...
SortAscendingNarrowIconFillDuotone.displayName =
  "SortAscendingNarrowIconFillDuotone";
export { SortAscendingNarrowIconFillDuotone };
