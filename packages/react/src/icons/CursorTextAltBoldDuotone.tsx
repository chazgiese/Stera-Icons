...
const CursorTextAltBoldDuotone = memo(
  forwardRef<SVGSVGElement, CursorTextAltBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13 18a3 3 0 0 0 3 3h1a1 1 0 1 1 0 2h-1a5 5 0 0 1-4-2c.63-.84 1-1.87 1-3M13 11h2a1 1 0 1 1 0 2h-2zM11 13H9a1 1 0 1 1 0-2h2zM8 1a5 5 0 0 1 4 2c-.63.84-1 1.87-1 3a3 3 0 0 0-3-3H7a1 1 0 0 1 0-2z" />
...
export { CursorTextAltBoldDuotone };
