...
const RotationRightFillDuotone = memo(
  forwardRef<SVGSVGElement, RotationRightFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16.95 5.64a1 1 0 0 1 1.41 0A9 9 0 0 1 13 20.94v-2.01a7 7 0 0 0 3.95-11.88 1 1 0 0 1 0-1.41M11 5.07a7 7 0 0 0-3.95 11.88 1 1 0 0 1-1.41 1.41A9 9 0 0 1 11 3.06z" />
...
export { RotationRightFillDuotone };
