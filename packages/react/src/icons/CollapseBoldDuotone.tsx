...
const CollapseBoldDuotone = memo(
  forwardRef<SVGSVGElement, CollapseBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8 16v1.41l-3.3 3.3a1 1 0 0 1-1.4-1.42L6.58 16zM20.7 19.3a1 1 0 0 1-1.4 1.4L16 17.42V16h1.41zM19.3 3.3a1 1 0 0 1 1.4 1.4L17.42 8H16V6.59zM3.3 3.3a1 1 0 0 1 1.4 0L8 6.58V8H6.59l-3.3-3.3a1 1 0 0 1 0-1.4" />
