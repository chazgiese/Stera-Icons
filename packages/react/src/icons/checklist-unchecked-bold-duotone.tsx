...
const ChecklistUncheckedIconBoldDuotone = memo(
...
ChecklistUncheckedIconBoldDuotone.displayName =
  "ChecklistUncheckedIconBoldDuotone";
export { ChecklistUncheckedIconBoldDuotone };
