...
const ChevronFullSquareRightFilled = memo(
...
ChevronFullSquareRightFilled.displayName = "ChevronFullSquareRightFilled";
export { ChevronFullSquareRightFilled };
export default ChevronFullSquareRightFilled;
