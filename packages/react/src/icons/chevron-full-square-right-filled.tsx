...
const ChevronFullSquareRightIconFilled = memo(
...
ChevronFullSquareRightIconFilled.displayName =
  "ChevronFullSquareRightIconFilled";
export { ChevronFullSquareRightIconFilled };
