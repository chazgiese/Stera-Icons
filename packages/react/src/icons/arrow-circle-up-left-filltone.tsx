    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M4.222 4.222c4.295-4.296 11.26-4.296 15.556 0 4.296 4.295 4.296 11.26 0 15.556-4.295 4.296-11.26 4.296-15.556 0s-4.296-11.26 0-15.556m4.243 3.243a1 1 0 0 0-1 1v7.071a1 1 0 0 0 2 0v-4.657l5.363 5.364a1.001 1.001 0 0 0 1.415-1.415L10.88 9.465h4.656a1 1 0 0 0 0-2z"
          clipRule="evenodd"
          opacity={0.4}
        />
        <path
