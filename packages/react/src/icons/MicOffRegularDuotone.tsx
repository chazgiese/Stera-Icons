...
const MicOffRegularDuotone = memo(
  forwardRef<SVGSVGElement, MicOffRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4 10.25c.41 0 .75.34.75.75a7.25 7.25 0 0 0 11.24 6.05l1.08 1.08a8.7 8.7 0 0 1-4.32 1.59v1.53H15a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5h2.25v-1.53a8.75 8.75 0 0 1-8-8.72c0-.41.34-.75.75-.75" />
