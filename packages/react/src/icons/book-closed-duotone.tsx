...
const BookClosedIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M13 10.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5zM16 6.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5z"
        />
      </svg>
    ))
);
BookClosedIconDuotone.displayName = "BookClosedIconDuotone";
export { BookClosedIconDuotone };
