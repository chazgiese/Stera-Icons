...
const ListCheckSimpleIconBoldDuotone = memo(
...
ListCheckSimpleIconBoldDuotone.displayName = "ListCheckSimpleIconBoldDuotone";
export { ListCheckSimpleIconBoldDuotone };
