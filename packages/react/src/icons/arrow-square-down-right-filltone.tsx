...
const ArrowSquareDownRightIconFilltone = memo(
...
ArrowSquareDownRightIconFilltone.displayName =
  "ArrowSquareDownRightIconFilltone";
export { ArrowSquareDownRightIconFilltone };
