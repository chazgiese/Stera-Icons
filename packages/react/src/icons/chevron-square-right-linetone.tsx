...
const ChevronSquareRightIconLinetone = memo(
...
ChevronSquareRightIconLinetone.displayName = "ChevronSquareRightIconLinetone";
export { ChevronSquareRightIconLinetone };
