...
const ShieldCheckRegular = memo(
  forwardRef<SVGSVGElement, ShieldCheckRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M15.34 8.97a.75.75 0 0 1 1.07 1.06l-4.85 4.85-.32.3q-.15.15-.48.26-.42.12-.83-.06c-.2-.08-.34-.22-.44-.33l-.27-.34-1.7-2.26a.75.75 0 0 1 1.2-.9l1.7 2.26.04.05q0-.03.04-.04z" />
