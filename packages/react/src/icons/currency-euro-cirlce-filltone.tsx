...
const CurrencyEuroCirlceIconFilltone = memo(
...
CurrencyEuroCirlceIconFilltone.displayName = "CurrencyEuroCirlceIconFilltone";
export { CurrencyEuroCirlceIconFilltone };
