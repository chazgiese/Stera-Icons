  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M5.013 4.194c.846-1.592 3.129-1.592 3.975 0l7.792 14.668a.25.25 0 0 0 .441 0l3.896-7.332a1 1 0 1 1 1.766.939L18.988 19.8c-.846 1.592-3.129 1.592-3.975 0l-3.895-7.332-.005-.01L7.22 5.133a.25.25 0 0 0-.441 0l-3.897 7.335a1 1 0 1 1-1.766-.938z"
        />
      </svg>
    ))
);
