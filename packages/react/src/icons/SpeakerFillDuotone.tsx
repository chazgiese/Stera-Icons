...
const SpeakerFillDuotone = memo(
  forwardRef<SVGSVGElement, SpeakerFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M14.57 5.84a.25.25 0 0 1 .43.18v11.96c0 .22-.27.34-.43.18l-3.5-3.5c-.42-.42-1-.66-1.59-.66H7.25a.25.25 0 0 1-.25-.2v-3.55c0-.14.11-.25.25-.25h2.23c.6 0 1.17-.24 1.6-.66z" opacity={.4} />
