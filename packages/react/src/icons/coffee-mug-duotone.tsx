  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M18.749 5.01v.015L18.36 16.71a4.75 4.75 0 0 1-4.025 4.537l-.18.027c-2.091.322-4.22.322-6.31 0l-.18-.027a4.75 4.75 0 0 1-4.026-4.537L3.25 5.025v-.017c.004.652.462 1.11.88 1.392q.302.2.68.367l.33 9.892a3.25 3.25 0 0 0 2.754 3.105l.18.027a19.3 19.3 0 0 0 5.853 0l.18-.027a3.25 3.25 0 0 0 2.755-3.105l.328-9.891c.252-.112.482-.233.68-.368.42-.282.875-.739.88-1.39"
          opacity={0.4}
        />
        <path
          fill="currentColor"
