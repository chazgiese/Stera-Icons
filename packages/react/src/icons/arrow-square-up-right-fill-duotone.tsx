...
const ArrowSquareUpRightIconFillDuotone = memo(
...
ArrowSquareUpRightIconFillDuotone.displayName =
  "ArrowSquareUpRightIconFillDuotone";
export { ArrowSquareUpRightIconFillDuotone };
