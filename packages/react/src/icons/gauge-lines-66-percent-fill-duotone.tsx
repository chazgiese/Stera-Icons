...
const GaugeLines66PercentIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M6.34 17.709a1 1 0 1 1 1.414 1.414l-1.06 1.06a1 1 0 0 1-1.415-1.413zM16.246 17.709a1 1 0 0 1 1.414 0l1.06 1.06a1 1 0 0 1-1.413 1.415l-1.06-1.06a1 1 0 0 1 0-1.415M16.357 7.709a1 1 0 0 1 1.399 1.396l-.001.001-.002.004-.008.01-.031.042-.116.158a941 941 0 0 1-1.742 2.356c-.97 1.306-2.06 2.76-2.39 3.145q-.025.03-.052.057a2 2 0 0 1-2.828-2.828l.057-.053c.385-.33 1.84-1.42 3.145-2.39.664-.493 1.306-.968 1.782-1.319l.574-.422.158-.116.042-.031.01-.008zM5 12.465a1 1 0 0 1 0 2H3.5a1 1 0 0 1 0-2zM20.5 12.465a1 1 0 0 1 0 2H19a1 1 0 0 1 0-2zM5.286 6.749a1 1 0 0 1 1.414 0l1.06 1.06a1 1 0 0 1-1.413 1.415l-1.06-1.06a1 1 0 0 1 0-1.415M11.997 3.965A1 1 0 0 1 13 4.962l.005 1.505a1 1 0 0 1-2 .006L11 4.968a1 1 0 0 1 .997-1.003"
        />
      </svg>
    ))
);
GaugeLines66PercentIconFillDuotone.displayName =
  "GaugeLines66PercentIconFillDuotone";
export { GaugeLines66PercentIconFillDuotone };
