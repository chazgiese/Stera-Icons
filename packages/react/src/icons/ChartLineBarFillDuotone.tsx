...
const ChartLineBarFillDuotone = memo(
  forwardRef<SVGSVGElement, ChartLineBarFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M5 18c.83 0 1.5.67 1.5 1.5v.5a1.5 1.5 0 0 1-3 0v-.5c0-.83.67-1.5 1.5-1.5M9 14c.83 0 1.5.67 1.5 1.5V20a1.5 1.5 0 0 1-3 0v-4.5c0-.83.67-1.5 1.5-1.5M13 15.5c.83 0 1.5.67 1.5 1.5v3a1.5 1.5 0 0 1-3 0v-3c0-.83.67-1.5 1.5-1.5M17 13c.83 0 1.5.67 1.5 1.5V20a1.5 1.5 0 0 1-3 0v-5.5c0-.83.67-1.5 1.5-1.5M21 9c.83 0 1.5.67 1.5 1.5V20a1.5 1.5 0 0 1-3 0v-9.5c0-.83.67-1.5 1.5-1.5" opacity={0.4} />
