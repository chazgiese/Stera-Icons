...
const PencilTipBoldDuotone = memo(
  forwardRef<SVGSVGElement, PencilTipBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m4 12.12 2 1V22a1 1 0 0 1-2 0zM20 22a1 1 0 1 1-2 0v-8.88l2-1zM8.02 5.49l.74.62q.4.33.87.57l-3.2 4.12-.16.22-1.79-.9-.05.1a4 4 0 0 1 .41-.65zM19.16 9.57q.24.31.4.65l-.04-.1-1.8.9-.14-.22-3.2-4.12q.45-.24.86-.57l.74-.62z" />
