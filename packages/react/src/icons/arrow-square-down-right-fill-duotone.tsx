...
const ArrowSquareDownRightIconFillDuotone = memo(
...
ArrowSquareDownRightIconFillDuotone.displayName =
  "ArrowSquareDownRightIconFillDuotone";
export { ArrowSquareDownRightIconFillDuotone };
