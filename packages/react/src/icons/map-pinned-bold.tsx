    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="m8.72 3.003.082.007q.024.003.049.01.03.004.062.011l.024.006.067.024.042.014q.035.016.07.033l.043.022.012.007.01.006 6.151 3.69 6.152-3.69A1.001 1.001 0 0 1 23 4L23 9.269a1 1 0 0 1-2 0l-.001-3.503-5.151 3.091a1 1 0 0 1-1.03 0L9.667 5.766v9.668l2.416 1.45a1 1 0 0 1-1.03 1.715l-2.387-1.433-6.151 3.691A1.001 1.001 0 0 1 1 20V8a1 1 0 0 1 .485-.857l6.667-4 .005-.003.016-.01q.034-.019.07-.034l.036-.018.062-.022q.034-.013.07-.023l.008-.002.105-.02.005-.001.083-.007L8.654 3h.025zM3 8.565v9.668l4.666-2.8V5.767z"
          clipRule="evenodd"
        />
      </svg>
    ))
);
MapPinnedIconBold.displayName = "MapPinnedIconBold";
export { MapPinnedIconBold };
