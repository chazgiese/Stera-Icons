  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="m10.182 4.104 6.525 3.728c2.39 1.366 3.585 2.049 3.985 2.943a3 3 0 0 1 0 2.45c-.4.894-1.595 1.577-3.985 2.943l-6.526 3.728c-2.358 1.348-3.537 2.022-4.504 1.917a3 3 0 0 1-2.106-1.223C3 19.804 3 18.446 3 15.73V8.27c0-2.716 0-4.074.57-4.862a3 3 0 0 1 2.107-1.222c.967-.105 2.146.569 4.505 1.917"
          opacity={0.32}
        />
        <path
          fill="currentColor"
...
PlayIconFilltone.displayName = "PlayIconFilltone";
export { PlayIconFilltone };
