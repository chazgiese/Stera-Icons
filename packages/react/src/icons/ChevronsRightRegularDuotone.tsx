...
const ChevronsRightRegularDuotone = memo(
  forwardRef<SVGSVGElement, ChevronsRightRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M4.47 4.47c.3-.3.77-.3 1.06 0l7 7a.75.75 0 0 1 0 1.06l-7 7a.75.75 0 1 1-1.06-1.06L10.94 12 4.47 5.53a.75.75 0 0 1 0-1.06" opacity={.4} />
...
export { ChevronsRightRegularDuotone };
