...
const RotateCircleLeftIconBoldDuotone = memo(
...
RotateCircleLeftIconBoldDuotone.displayName = "RotateCircleLeftIconBoldDuotone";
export { RotateCircleLeftIconBoldDuotone };
