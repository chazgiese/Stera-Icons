    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M9.664 2.783a3.95 3.95 0 0 1 4.672 0l5.8 4.253c.736.54 1.385 1.315 1.598 2.308a.75.75 0 0 1-.29.761l-6.709 4.92a3.75 3.75 0 0 1-2.217.725h-1.37c-.829 0-1.635-.275-2.291-.781l-6.315-4.875a.75.75 0 0 1-.275-.75c.212-.995.861-1.768 1.597-2.308zm3.785 1.21a2.45 2.45 0 0 0-2.898 0l-5.8 4.253c-.393.289-.692.624-.87.987l5.893 4.548c.393.304.877.47 1.375.47h1.369c.478-.001.945-.153 1.33-.436l6.262-4.593c-.178-.359-.473-.691-.86-.976z"
          clipRule="evenodd"
        />
      </svg>
    ))
