...
const BarricadeRegularDuotone = memo(
  forwardRef<SVGSVGElement, BarricadeRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.75 20a.75.75 0 0 1-1.5 0v-4.25h1.5zM18.75 20a.75.75 0 0 1-1.5 0v-4.25h1.5zM9.31 6.75l7.5 7.5H14.7l-7.5-7.5zM9.81 14.25H7.7L2.75 9.31V9.2c0-.57 0-.96.02-1.25s.07-.43.12-.52l.03-.07zM16.31 6.75l4.94 4.94v.11c0 .57 0 .96-.02 1.25a1.4 1.4 0 0 1-.15.59l-6.89-6.89z" />
...
export { BarricadeRegularDuotone };
