  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M17.5 21a1 1 0 0 1 0 2h-11a1 1 0 0 1 0-2zM11.064 1.762c.427-.683 1.444-.682 1.871 0l.082.156L14.45 5.23l3.61.334c.963.09 1.363 1.291.627 1.935l-2.72 2.38.795 3.517c.216.955-.816 1.688-1.645 1.198L12 12.75l-3.116 1.844c-.83.49-1.863-.242-1.647-1.198l.795-3.517L5.313 7.5c-.736-.644-.336-1.845.628-1.935l3.609-.334 1.432-3.313z"
        />
        <path
          fill="currentColor"
