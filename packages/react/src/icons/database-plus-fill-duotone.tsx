...
const DatabasePlusIconFillDuotone = memo(
    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M4.47 14.518c1.09.58 2.667 1.044 4.54 1.29A3 3 0 0 0 12.004 19h1v1c0 1.28.803 2.37 1.931 2.8-.922.13-1.911.2-2.935.2-2.297 0-4.422-.348-6.008-.942-.79-.296-1.498-.673-2.027-1.142C3.437 20.448 3 19.803 3 19v-5.265z" />
          <path
            fillRule="evenodd"
...
DatabasePlusIconFillDuotone.displayName = "DatabasePlusIconFillDuotone";
export { DatabasePlusIconFillDuotone };
