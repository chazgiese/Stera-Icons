...
const CubeFillDuotone = memo(
  forwardRef<SVGSVGElement, CubeFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11 12.59v7.7l-.85-.46-4.2-2.33a6 6 0 0 1-1.42-.91 2 2 0 0 1-.43-.73c-.09-.27-.1-.59-.1-1.68V9.82c0-.52 0-.86.02-1.11zM19.98 8.7c.02.26.02.6.02 1.12v4.36c0 1.1-.01 1.41-.1 1.68a2 2 0 0 1-.43.73 6 6 0 0 1-1.42.9l-4.2 2.34-.85.46v-7.7zM11.6 3.47a2 2 0 0 1 .8 0c.27.06.54.2 1.45.7l4.2 2.33.88.5L12 10.87 5.07 7q.3-.19.88-.5l4.2-2.34c.91-.5 1.18-.64 1.45-.7" />
