...
const ChevronSquareRightIconFillDuotone = memo(
...
ChevronSquareRightIconFillDuotone.displayName =
  "ChevronSquareRightIconFillDuotone";
export { ChevronSquareRightIconFillDuotone };
