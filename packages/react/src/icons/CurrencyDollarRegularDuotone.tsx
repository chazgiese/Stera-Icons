...
const CurrencyDollarRegularDuotone = memo(
  forwardRef<SVGSVGElement, CurrencyDollarRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12.75 22a.75.75 0 0 1-1.5 0v-3.25h1.5zM12.75 12.75v4.5h-1.5v-4.5zM12.75 11.25h-1.5v-4.5h1.5zM12 1.25c.41 0 .75.34.75.75v3.25h-1.5V2c0-.41.34-.75.75-.75" />
...
export { CurrencyDollarRegularDuotone };
