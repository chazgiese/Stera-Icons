...
const ChatBubbleCheckIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M15.345 7.97a.75.75 0 0 1 1.06 1.06l-4.847 4.848c-.103.103-.214.215-.316.3-.109.092-.265.206-.477.265a1.25 1.25 0 0 1-.838-.06 1.3 1.3 0 0 1-.435-.328c-.089-.1-.183-.226-.27-.343L7.526 11.45a.75.75 0 0 1 1.199-.9l1.697 2.263.034.044.041-.04z"
        />
      </svg>
    ))
);
ChatBubbleCheckIconDuotone.displayName = "ChatBubbleCheckIconDuotone";
export { ChatBubbleCheckIconDuotone };
