  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 14.418c.335 0 .7.116.981.385l.115.124.146.17q.228.253.504.475L15.03 16.6a3.25 3.25 0 0 1 1.18 2.038.752.752 0 0 1-.74.865H8.53a.75.75 0 0 1-.741-.865 3.25 3.25 0 0 1 1.18-2.038l1.285-1.028c.246-.196.462-.414.65-.645l.114-.124c.281-.269.647-.385.982-.385"
        />
      </svg>
    ))
);
