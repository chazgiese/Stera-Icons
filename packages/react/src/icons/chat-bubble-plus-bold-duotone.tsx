...
const ChatBubblePlusIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 7a1 1 0 0 1 1 1v2h2a1 1 0 1 1 0 2h-2v2a1 1 0 1 1-2 0v-2H9a1 1 0 1 1 0-2h2V8a1 1 0 0 1 1-1"
        />
      </svg>
    ))
);
ChatBubblePlusIconBoldDuotone.displayName = "ChatBubblePlusIconBoldDuotone";
export { ChatBubblePlusIconBoldDuotone };
