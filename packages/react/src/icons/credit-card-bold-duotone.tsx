...
const CreditCardIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 15a1 1 0 1 1 0 2h-1a1 1 0 1 1 0-2zM18 15a1 1 0 1 1 0 2h-3a1 1 0 1 1 0-2zM21 10H3V8h18z"
        />
      </svg>
    ))
);
CreditCardIconBoldDuotone.displayName = "CreditCardIconBoldDuotone";
export { CreditCardIconBoldDuotone };
