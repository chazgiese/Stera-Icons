  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.41 1.677a2.25 2.25 0 0 1 3.18 0l8.264 8.263c.944.945.275 2.56-1.061 2.56H17V14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-1.5H3.207c-1.336 0-2.005-1.615-1.06-2.56z"
        />
      </svg>
    ))
);
