    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M6.19 4.776a4 4 0 0 1 4.456-3.482L19.25 2.35l.203.03a4 4 0 0 1 3.28 4.428l-1.056 8.602a4 4 0 0 1-2.934 3.375 4 4 0 0 1-.195.541 4.04 4.04 0 0 1-1.327 1.616 4 4 0 0 1-1.834.712l-8.603 1.057a4 4 0 0 1-1.717-.163 4.01 4.01 0 0 1-2.71-3.117l-.03-.204-1.057-8.602a4 4 0 0 1 3.483-4.458l1.286-.158zm2.534 9.687a2.25 2.25 0 0 0-3.159.388l-1.522 1.948.268 2.185.036.201a2 2 0 0 0 2.193 1.54l8.603-1.056q.101-.013.199-.035zm1.68-11.184a2 2 0 0 0-2.23 1.741l-.091.738 5.271-.647.205-.02a4 4 0 0 1 .586 0 4.01 4.01 0 0 1 3.667 3.504l.983 8.003c.477-.311.82-.822.895-1.432l1.057-8.602a2 2 0 0 0-1.54-2.193l-.201-.036zm1.513 6.32a1.834 1.834 0 1 0 .446 3.64 1.834 1.834 0 0 0-.446-3.64"
          clipRule="evenodd"
        />
      </svg>
    ))
