...
const TrophyBoldDuotone = memo(
  forwardRef<SVGSVGElement, TrophyBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M15.6 17.33A4 4 0 0 1 18 21v1a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-1a4 4 0 0 1 2.4-3.67q.36.6.77 1.22l.3.45H10a2 2 0 0 0-2 2h8a2 2 0 0 0-2-2h.53l.3-.45q.42-.61.76-1.22M20.52 3.5a2.25 2.25 0 0 1 2.22 2.62l-.45 2.72a5 5 0 0 1-2.36 3.47l-2.73 1.64q.51-1.44.8-2.82l.9-.54a3 3 0 0 0 1.42-2.08l.45-2.72a.25.25 0 0 0-.25-.29h-2V4q0-.27-.05-.5zM5.53 3.5q-.04.23-.05.5v1.5h-2a.25.25 0 0 0-.25.3l.45 2.71A3 3 0 0 0 5.1 10.6l.9.54q.29 1.38.8 2.82L4.07 12.3A5 5 0 0 1 1.7 8.84l-.45-2.72A2.25 2.25 0 0 1 3.48 3.5z" />
