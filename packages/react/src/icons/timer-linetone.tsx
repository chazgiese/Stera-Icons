  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M6.52 6.519a.75.75 0 0 1 .937-.1l5.478 3.544c.316.205.92.577 1.17 1.24a2.25 2.25 0 0 1-2.9 2.9c-.663-.25-1.036-.853-1.24-1.17L6.42 7.457l-.061-.115a.75.75 0 0 1 .16-.822"
        />
      </svg>
    ))
);
