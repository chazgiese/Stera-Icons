...
const PercentSquareIconFillDuotone = memo(
...
PercentSquareIconFillDuotone.displayName = "PercentSquareIconFillDuotone";
export { PercentSquareIconFillDuotone };
