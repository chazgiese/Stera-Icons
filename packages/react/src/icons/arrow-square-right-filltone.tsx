...
const ArrowSquareRightIconFilltone = memo(
...
ArrowSquareRightIconFilltone.displayName = "ArrowSquareRightIconFilltone";
export { ArrowSquareRightIconFilltone };
