...
const PencilTipRegularDuotone = memo(
  forwardRef<SVGSVGElement, PencilTipRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M5.75 12.71V22a.75.75 0 0 1-1.5 0V11.96zM19.75 12.03V22a.75.75 0 0 1-1.5 0v-9.29l1.5-.75zM8.38 5.43l.14.15.44.36q.29.24.6.42l-3.34 4.29q-.16.22-.28.48l-1.35-.67.1-.2q.15-.27.35-.53zM15.62 5.43l3.34 4.3q.27.34.45.73l-1.35.67a2 2 0 0 0-.28-.48l-3.34-4.29q.32-.18.6-.42l.44-.36z" />
...
export { PencilTipRegularDuotone };
