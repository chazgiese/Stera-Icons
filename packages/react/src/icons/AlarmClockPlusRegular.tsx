...
const AlarmClockPlusRegular = memo(
  forwardRef<SVGSVGElement, AlarmClockPlusRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M12 8.75c.42 0 .75.34.75.75v2.75h2.75a.75.75 0 0 1 0 1.5h-2.75v2.75a.75.75 0 0 1-1.5 0v-2.75H8.5a.75.75 0 0 1 0-1.5h2.75V9.5c0-.4.34-.75.75-.75" />
