  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 9c2.883 0 5.543.582 7.519 1.57C21.434 11.528 23 13.037 23 15s-1.566 3.472-3.481 4.43C17.543 20.418 14.883 21 12 21s-5.543-.582-7.519-1.57C2.566 18.472 1 16.963 1 15s1.566-3.472 3.481-4.43C6.457 9.582 9.117 9 12 9"
          opacity={0.32}
        />
        <path
          fill="currentColor"
