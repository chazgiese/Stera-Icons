...
const ChatBubbleAlertIconBoldDuotone = memo(
...
ChatBubbleAlertIconBoldDuotone.displayName = "ChatBubbleAlertIconBoldDuotone";
export { ChatBubbleAlertIconBoldDuotone };
