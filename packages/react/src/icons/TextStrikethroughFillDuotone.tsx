...
const TextStrikethroughFillDuotone = memo(
  forwardRef<SVGSVGElement, TextStrikethroughFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M18.7 13.5a6 6 0 0 1-5.2 9H7a1.5 1.5 0 0 1 0-3h6.5a3 3 0 1 0 0-6zM17 1.5a1.5 1.5 0 0 1 0 3h-5.5a3 3 0 0 0-.15 6H6.3a6 6 0 0 1 5.2-9z" />
...
export { TextStrikethroughFillDuotone };
