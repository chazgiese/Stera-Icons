    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M12 6.75c3.432 0 6.389 2.03 7.685 4.945a.75.75 0 0 1 0 .61C18.39 15.22 15.432 17.25 12 17.25s-6.39-2.03-7.686-4.945a.75.75 0 0 1 0-.61C5.611 8.78 8.568 6.75 12 6.75m0 1.5c-2.708 0-5.044 1.531-6.17 3.75 1.126 2.219 3.462 3.75 6.17 3.75A6.9 6.9 0 0 0 18.168 12 6.9 6.9 0 0 0 12 8.25"
          clipRule="evenodd"
        />
...
ScanEyeIconDuotone.displayName = "ScanEyeIconDuotone";
export { ScanEyeIconDuotone };
