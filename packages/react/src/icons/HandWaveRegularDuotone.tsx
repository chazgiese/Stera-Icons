...
const HandWaveRegularDuotone = memo(
  forwardRef<SVGSVGElement, HandWaveRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M2.72 16.3c.39-.15.82.04.98.42.3.77 1.3 2.6 2.75 3.68a.75.75 0 0 1-.9 1.2 11 11 0 0 1-3.25-4.32.75.75 0 0 1 .42-.98M19.5 1.75c1.26 0 2.32.63 3.05 1.43s1.2 1.84 1.2 2.82a.75.75 0 0 1-1.5 0 3 3 0 0 0-.8-1.8 2.7 2.7 0 0 0-1.95-.95.75.75 0 0 1 0-1.5" opacity={0.4} />
