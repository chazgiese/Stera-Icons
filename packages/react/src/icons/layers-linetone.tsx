    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M9.763 2a5 5 0 0 1 4.472 0l6.87 3.435c1.29.645 1.29 2.485 0 3.13l-6.87 3.436a5 5 0 0 1-4.472 0l-6.87-3.436c-1.289-.645-1.289-2.485 0-3.13zM13.34 3.79a3 3 0 0 0-2.684 0l-6.422 3.21 6.422 3.212c.845.423 1.84.422 2.684 0L19.763 7z"
          clipRule="evenodd"
        />
      </svg>
    ))
