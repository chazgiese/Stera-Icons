    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M9.763 2a5 5 0 0 1 4.472 0l6.87 3.435c1.29.645 1.29 2.485 0 3.13L14.235 12a5 5 0 0 1-4.472 0L2.894 8.565c-1.29-.645-1.29-2.485 0-3.13zm3.578 1.788a3 3 0 0 0-2.683 0L4.235 7l6.423 3.212c.844.422 1.839.422 2.683 0L19.763 7z"
          clipRule="evenodd"
        />
      </svg>
    ))
