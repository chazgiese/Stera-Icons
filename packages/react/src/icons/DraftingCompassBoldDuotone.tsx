...
const DraftingCompassBoldDuotone = memo(
  forwardRef<SVGSVGElement, DraftingCompassBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.45 16.63a1 1 0 0 1 1.72 1.03l-2.31 3.85a1 1 0 0 1-1.72-1.02zM9.15 8.8a4 4 0 0 0 1.71 1.03l-1.6 2.68a1 1 0 0 1-1.72-1.02z" />
...
export { DraftingCompassBoldDuotone };
