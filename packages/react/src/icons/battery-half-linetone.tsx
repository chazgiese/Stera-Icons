...
const BatteryHalfIconLinetone = memo(
  ...
  IconProps >
    ((
      ...
      <svg
        ...
        {...props}
      >
        <g fill="currentColor" clipPath="url(#clip0_3425_9620)">
          <path
            fillRule="evenodd"
...
BatteryHalfIconLinetone.displayName = "BatteryHalfIconLinetone";
export { BatteryHalfIconLinetone };
