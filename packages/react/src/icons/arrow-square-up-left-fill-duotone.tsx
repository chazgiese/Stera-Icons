...
const ArrowSquareUpLeftIconFillDuotone = memo(
...
ArrowSquareUpLeftIconFillDuotone.displayName =
  "ArrowSquareUpLeftIconFillDuotone";
export { ArrowSquareUpLeftIconFillDuotone };
