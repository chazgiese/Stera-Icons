...
const CodeCircleIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12.781 6.785a.751.751 0 0 1 1.438.431l-3 10a.752.752 0 0 1-1.438-.431zM7.47 8.97a.75.75 0 1 1 1.06 1.06L6.56 12l1.97 1.97a.75.75 0 0 1-1.06 1.06l-2.5-2.5a.75.75 0 0 1 0-1.06zM15.47 8.97a.75.75 0 0 1 1.06 0l2.5 2.5a.75.75 0 0 1 0 1.06l-2.5 2.5a.75.75 0 0 1-1.06-1.06L17.44 12l-1.97-1.97a.75.75 0 0 1 0-1.06"
        />
      </svg>
    ))
);
CodeCircleIconDuotone.displayName = "CodeCircleIconDuotone";
export { CodeCircleIconDuotone };
