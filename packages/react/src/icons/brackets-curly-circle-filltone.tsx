...
const BracketsCurlyCircleIconFilltone = memo(
...
BracketsCurlyCircleIconFilltone.displayName = "BracketsCurlyCircleIconFilltone";
export { BracketsCurlyCircleIconFilltone };
