...
const GaugeLines0PercentIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.586 12.05a2 2 0 1 1 2.828 2.828l-.056.053c-.386.33-1.84 1.42-3.146 2.39-.664.493-1.307.967-1.783 1.318l-.572.423-.159.116-.042.031-.01.008-.08.053a1 1 0 0 1-1.322-1.449l.003-.004.008-.01.03-.042.118-.159a703 703 0 0 1 1.74-2.355c.97-1.306 2.06-2.76 2.39-3.144q.026-.03.053-.057"
        />
      </svg>
    ))
);
GaugeLines0PercentIconBoldDuotone.displayName =
  "GaugeLines0PercentIconBoldDuotone";
export { GaugeLines0PercentIconBoldDuotone };
