...
const EyeClosedBoldDuotone = memo(
  forwardRef<SVGSVGElement, EyeClosedBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8.19 14.56q.93.33 1.94.49l-.65 2.23a1 1 0 0 1-1.92-.56zM16.44 16.72a1 1 0 1 1-1.92.56l-.65-2.23q1-.16 1.94-.49zM3.53 11.46q.66.75 1.46 1.37l-1.81 1.68a1 1 0 0 1-1.36-1.47zM22.18 13.04a1 1 0 0 1-1.36 1.47l-1.81-1.68q.8-.62 1.46-1.37z" />
