  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 4c4.924 0 9.107 3.169 10.926 7.622a1 1 0 0 1 0 .756C21.106 16.83 16.924 20 12 20c-4.923 0-9.106-3.169-10.926-7.622a1 1 0 0 1 0-.756C2.894 7.17 7.077 4 12 4"
          opacity={0.4}
        />
        <path
          fill="currentColor"
