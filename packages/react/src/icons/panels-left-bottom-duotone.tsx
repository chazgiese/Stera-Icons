...
const PanelsLeftBottomIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M8.75 14.25h12.5v1.5H8.75v3.5h-1.5V4.75h1.5z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
PanelsLeftBottomIconDuotone.displayName = "PanelsLeftBottomIconDuotone";
export { PanelsLeftBottomIconDuotone };
