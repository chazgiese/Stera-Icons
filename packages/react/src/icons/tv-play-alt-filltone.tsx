  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.393 9.728c.322-.034.715.191 1.5.64l2.175 1.242c.797.456 1.196.684 1.33.982a1 1 0 0 1 0 .816c-.134.298-.533.525-1.33.98l-2.174 1.244c-.786.449-1.179.673-1.501.638a1 1 0 0 1-.702-.407c-.19-.262-.19-.715-.19-1.62v-2.486c0-.905 0-1.358.19-1.62a1 1 0 0 1 .702-.409M9.054 1.605a1 1 0 0 1 1.34.449L11.865 5H9.63L8.606 2.946a1 1 0 0 1 .448-1.34M13.106 3.053a1 1 0 0 1 1.789.894L14.368 5h-2.236z"
        />
      </svg>
    ))
);
