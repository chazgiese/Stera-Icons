...
const CubePackageRegularDuotone = memo(
  forwardRef<SVGSVGElement, CubePackageRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m12 11.14 2.9-1.62q.16.12.25.22a2.3 2.3 0 0 1 .55 1.06l-2.95 1.64v8.14l-.1.03q-.65.13-1.3 0-.06 0-.1-.03v-8.14L3.91 8.36v-.03q.23-.66.7-1.18l.07-.07zM19.39 7.15q.47.51.7 1.18v.03l-3.04 1.7a4 4 0 0 0-.76-1.3l3.03-1.68z" />
...
export { CubePackageRegularDuotone };
