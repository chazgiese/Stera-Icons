...
const ChevronFullSquareLeftIconFilltone = memo(
...
ChevronFullSquareLeftIconFilltone.displayName =
  "ChevronFullSquareLeftIconFilltone";
export { ChevronFullSquareLeftIconFilltone };
