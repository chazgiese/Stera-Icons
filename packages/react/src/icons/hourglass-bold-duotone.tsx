...
const HourglassIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M14.562 6.068a1 1 0 0 1 .625 1.782l-1.285 1.027c-.437.35-.777.767-1.022 1.22-.31.574-.38 1.237-.38 1.897q0 1.3.212 2.6c.092.57.38 1.085.788 1.492l2.207 2.207A1 1 0 0 1 15 20H9a1 1 0 0 1-.707-1.707l2.206-2.207c.407-.408.695-.923.788-1.491q.212-1.3.213-2.6c0-.66-.07-1.324-.38-1.897a4 4 0 0 0-1.022-1.221L8.814 7.85a1 1 0 0 1 .625-1.782z"
        />
      </svg>
    ))
);
HourglassIconBoldDuotone.displayName = "HourglassIconBoldDuotone";
export { HourglassIconBoldDuotone };
