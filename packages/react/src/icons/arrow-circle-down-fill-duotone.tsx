...
const ArrowCircleDownIconFillDuotone = memo(
...
ArrowCircleDownIconFillDuotone.displayName = "ArrowCircleDownIconFillDuotone";
export { ArrowCircleDownIconFillDuotone };
