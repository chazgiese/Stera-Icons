...
const BarricadeFillDuotone = memo(
  forwardRef<SVGSVGElement, BarricadeFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m7.09 7 7 7H9.9L3.25 7.34a1 1 0 0 1 .3-.23c.05-.03.15-.06.42-.09C4.25 7 4.62 7 5.2 7zM18.8 7c.58 0 .95 0 1.23.02.27.03.37.06.42.09a1 1 0 0 1 .44.44c.03.05.06.15.09.42.02.28.02.65.02 1.23v1.89L16.91 7z" />
