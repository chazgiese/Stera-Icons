...
const CircleDashSimpleIconFillDuotone = memo(
...
CircleDashSimpleIconFillDuotone.displayName = "CircleDashSimpleIconFillDuotone";
export { CircleDashSimpleIconFillDuotone };
