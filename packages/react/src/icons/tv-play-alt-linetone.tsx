  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.393 9.729c.322-.035.715.19 1.5.639l2.176 1.243c.797.455 1.195.682 1.328.98.117.26.117.558 0 .818-.133.297-.531.525-1.328.98l-2.176 1.243c-.785.45-1.178.674-1.5.639a1 1 0 0 1-.703-.407c-.19-.263-.19-.716-.19-1.622v-2.485c0-.905 0-1.358.19-1.621a1 1 0 0 1 .703-.407"
        />
      </svg>
    ))
);
