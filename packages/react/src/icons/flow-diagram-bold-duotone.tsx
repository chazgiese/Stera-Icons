...
const FlowDiagramIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M7.793 11.293a1 1 0 0 0 0 1.414l.293.293H7a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h6.01q-.009.1-.01.2v1.6q.001.1.01.2H7a3 3 0 0 1-3-3v-4a3 3 0 0 1 3-3h1.086zM17 3a3 3 0 0 1 3 3v4a3 3 0 0 1-3 3h-1.086l.293-.293a1 1 0 0 0 0-1.414L15.914 11H17a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1h-6.01q.009-.1.01-.2V3.2a2 2 0 0 0-.009-.2z" />
        </g>
        <path
          fill="currentColor"
          fillRule="evenodd"
...
FlowDiagramIconBoldDuotone.displayName = "FlowDiagramIconBoldDuotone";
export { FlowDiagramIconBoldDuotone };
