...
const CalendarSlashIconFill = memo(
    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M9.349 12.349a3.75 3.75 0 1 1 5.302 5.302 3.75 3.75 0 0 1-5.302-5.302m.622 1.682a2.249 2.249 0 0 0 2.997 2.997zm3.62-.622a2.25 2.25 0 0 0-2.56-.438l2.997 2.997a2.25 2.25 0 0 0-.437-2.559"
          clipRule="evenodd"
        />
        <path
          fill="currentColor"
...
CalendarSlashIconFill.displayName = "CalendarSlashIconFill";
export { CalendarSlashIconFill };
