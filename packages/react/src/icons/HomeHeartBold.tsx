...
const HomeHeartBold = memo(
  forwardRef<SVGSVGElement, HomeHeartBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M13.9 9c1.7 0 3.1 1.37 3.1 3.08 0 1.24-.67 2.17-.88 2.46-1.05 1.47-2.54 2.48-3.5 3.24a1 1 0 0 1-1.24 0c-.96-.76-2.45-1.77-3.5-3.24A4.3 4.3 0 0 1 7 12.08a3.09 3.09 0 0 1 5-2.43A3 3 0 0 1 13.9 9m0 2c-.44 0-.82.26-1 .63a1 1 0 0 1-1.8 0 1.1 1.1 0 0 0-1-.63c-.62 0-1.1.5-1.1 1.08 0 .55.31 1.03.5 1.3.69.95 1.59 1.65 2.5 2.35.91-.7 1.81-1.4 2.5-2.36.19-.26.5-.74.5-1.3 0-.58-.48-1.07-1.1-1.07" clipRule="evenodd" />
