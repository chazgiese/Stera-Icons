  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.586 3.854a2 2 0 0 1 2.828 0l8.262 8.263c.788.787.23 2.133-.883 2.133H16a.75.75 0 0 1 0-1.5h4.189l-7.836-7.836a.5.5 0 0 0-.707 0L3.81 12.75H8a.75.75 0 0 1 0 1.5H3.207c-1.114 0-1.671-1.346-.884-2.133z"
        />
      </svg>
    ))
);
