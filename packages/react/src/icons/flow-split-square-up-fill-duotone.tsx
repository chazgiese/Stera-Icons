...
const FlowSplitSquareUpIconFillDuotone = memo(
...
FlowSplitSquareUpIconFillDuotone.displayName =
  "FlowSplitSquareUpIconFillDuotone";
export { FlowSplitSquareUpIconFillDuotone };
