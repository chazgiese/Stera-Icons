...
const CircleFourConnectedIconFilltone = memo(
...
CircleFourConnectedIconFilltone.displayName = "CircleFourConnectedIconFilltone";
export { CircleFourConnectedIconFilltone };
