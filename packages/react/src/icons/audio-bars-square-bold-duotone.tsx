...
const AudioBarsSquareIconBoldDuotone = memo(
...
AudioBarsSquareIconBoldDuotone.displayName = "AudioBarsSquareIconBoldDuotone";
export { AudioBarsSquareIconBoldDuotone };
