...
const YinYangFillDuotone = memo(
  forwardRef<SVGSVGElement, YinYangFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fillRule="evenodd" d="M12 2h.28-.02q1.1.07 2.03.55l.05.03q.38.21.74.48l.04.03A5 5 0 0 1 17 7a5 5 0 0 1-4.74 5h-.52a5 5 0 0 0 0 10A10 10 0 0 1 12 2m0 3.25a1.75 1.75 0 1 0 0 3.5 1.75 1.75 0 0 0 0-3.5" clipRule="evenodd" />
