...
const ChevronsRightFill = memo(
  forwardRef<SVGSVGElement, ChevronsRightFillProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M3.94 3.94a1.5 1.5 0 0 1 2.12 0l7 7a1.5 1.5 0 0 1 0 2.12l-7 7a1.5 1.5 0 0 1-2.12-2.12L9.88 12 3.94 6.06a1.5 1.5 0 0 1 0-2.12" />
