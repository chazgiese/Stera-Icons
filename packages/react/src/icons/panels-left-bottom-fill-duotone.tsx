...
const PanelsLeftBottomIconFillDuotone = memo(
...
PanelsLeftBottomIconFillDuotone.displayName = "PanelsLeftBottomIconFillDuotone";
export { PanelsLeftBottomIconFillDuotone };
