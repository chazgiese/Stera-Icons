    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M5.106 10.773a2 2 0 0 1 2.778.05l5.293 5.294a2 2 0 0 1 .05 2.777l-.143.154-.019.018a5.75 5.75 0 0 1-7.566.494L2.53 22.53a.75.75 0 0 1-1.06-1.06l2.968-2.97a5.75 5.75 0 0 1 .496-7.565l.02-.02zm1.716 1.11a.5.5 0 0 0-.694-.012l-.144.134a4.251 4.251 0 0 0 6.011 6.01l.134-.143a.5.5 0 0 0-.013-.694zM21.293 1.293a1 1 0 0 1 1.414 1.414L19.71 5.703a5.75 5.75 0 0 1-.645 7.363l-.018.019-.154.142a2 2 0 0 1-2.777-.05l-.617-.617-1.469 1.47a.75.75 0 0 1-1.06-1.06l1.468-1.47L12.5 9.56l-1.469 1.47a.75.75 0 0 1-1.06-1.06l1.468-1.47-.615-.616a2 2 0 0 1-.05-2.778l.142-.153.019-.019a5.75 5.75 0 0 1 7.36-.644zm-3.288 4.702a4.25 4.25 0 0 0-6-.01l-.134.144a.5.5 0 0 0 .013.694l4.136 4.138.01.009.008.008 1.139 1.14c.19.19.498.195.695.012l.143-.135a4.25 4.25 0 0 0-.01-6"
          clipRule="evenodd"
        />
      </svg>
    ))
