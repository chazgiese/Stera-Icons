...
const GaugeLines85PercentIconBoldDuotone = memo(
...
GaugeLines85PercentIconBoldDuotone.displayName =
  "GaugeLines85PercentIconBoldDuotone";
export { GaugeLines85PercentIconBoldDuotone };
