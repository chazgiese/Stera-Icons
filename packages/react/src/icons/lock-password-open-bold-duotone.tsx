...
const LockPasswordOpenIconBoldDuotone = memo(
...
LockPasswordOpenIconBoldDuotone.displayName = "LockPasswordOpenIconBoldDuotone";
export { LockPasswordOpenIconBoldDuotone };
