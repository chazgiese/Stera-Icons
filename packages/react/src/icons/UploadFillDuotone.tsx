...
const UploadFillDuotone = memo(
  forwardRef<SVGSVGElement, UploadFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M12 2a1 1 0 0 1 .7.3l5.5 5.5a1 1 0 0 1-.7 1.7H13V16a1 1 0 0 1-2 0V9.5H6.5a1 1 0 0 1-.7-1.7l5.5-5.5.07-.07A1 1 0 0 1 12 2" />
