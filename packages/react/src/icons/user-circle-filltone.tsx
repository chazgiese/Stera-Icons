  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 1c6.075 0 11 4.925 11 11 0 3.065-1.256 5.836-3.278 7.831a1 1 0 0 0 .278-.69v-.017a1 1 0 0 0-.126-.485 9.03 9.03 0 0 0-4.476-3.974 5 5 0 1 0-6.798 0 9.03 9.03 0 0 0-4.474 3.974 1 1 0 0 0-.126.485v.018a1 1 0 0 0 .277.69A10.97 10.97 0 0 1 1 12C1 5.925 5.925 1 12 1"
          opacity={0.4}
        />
      </svg>
    ))
