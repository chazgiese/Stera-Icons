...
const ChevronSquareDownFilled = memo(
...
ChevronSquareDownFilled.displayName = "ChevronSquareDownFilled";
export { ChevronSquareDownFilled };
export default ChevronSquareDownFilled;
