...
const ApertureIconFillDuotone = memo(
    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M14.5 20.647A9 9 0 0 1 12 21a8.95 8.95 0 0 1-4.502-1.205l6.692-3.863.06-.034.25-.157zM5.001 20.486q.016.014.033.027l-.05-.04zM20.738 14.158a9.02 9.02 0 0 1-4.238 5.637v-7.796q0-.138-.01-.273v-.02zM9.691 15.863l.024.014.01.006.025.015.024.012q.116.066.234.125l-4.243 2.451A8.97 8.97 0 0 1 3 12zM7.5 12q0 .128.007.253 0 .02.002.04L3.26 9.842A9.02 9.02 0 0 1 7.5 4.204zM18.234 5.513A8.97 8.97 0 0 1 21 11.999l-6.665-3.848q-.003 0-.005-.003l-.053-.03-.026-.015-.023-.013a5 5 0 0 0-.238-.127zM12 3c1.64 0 3.177.438 4.501 1.204l-6.685 3.86-.047.028-.006.003q-.034.019-.05.03l-.005.001-.005.005a5 5 0 0 0-.203.127V3.353A9 9 0 0 1 12 3" />
        </g>
        <path
          fill="currentColor"
          fillRule="evenodd"
...
ApertureIconFillDuotone.displayName = "ApertureIconFillDuotone";
export { ApertureIconFillDuotone };
