...
const ChevronCircleRightIconFillDuotone = memo(
...
ChevronCircleRightIconFillDuotone.displayName =
  "ChevronCircleRightIconFillDuotone";
export { ChevronCircleRightIconFillDuotone };
