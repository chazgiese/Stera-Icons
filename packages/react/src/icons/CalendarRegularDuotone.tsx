...
type CalendarRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const CalendarRegularDuotone = memo(
  forwardRef<SVGSVGElement, CalendarRegularDuotoneProps>((props, ref) => (
