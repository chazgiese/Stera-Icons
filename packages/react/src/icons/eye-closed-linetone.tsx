  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M20.07 8.536a1 1 0 1 1 1.771.928c-1.792 3.418-5.545 5.733-9.841 5.733s-8.05-2.315-9.843-5.733a1 1 0 0 1 1.772-.928c1.433 2.734 4.49 4.661 8.071 4.661 3.582 0 6.637-1.927 8.07-4.66"
        />
      </svg>
    ))
);
