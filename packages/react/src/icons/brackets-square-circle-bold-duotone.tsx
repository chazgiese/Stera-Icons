...
const BracketsSquareCircleIconBoldDuotone = memo(
...
BracketsSquareCircleIconBoldDuotone.displayName =
  "BracketsSquareCircleIconBoldDuotone";
export { BracketsSquareCircleIconBoldDuotone };
