...
const AgentCursorIconFilltone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M11.127 13.111c-.396-1.188.687-2.32 1.87-2.017l.114.033 7.817 2.605c1.457.486 1.42 2.56-.054 2.993l-3.206.943-.942 3.206c-.434 1.473-2.508 1.51-2.993.054zM8.354 14.323a1 1 0 0 1 1.414 1.414l-1.055 1.056-.076.07a1 1 0 0 1-1.407-1.409l.069-.075zM6.034 10.435a1 1 0 0 1 1.225-.707l1.441.387a1 1 0 1 1-.517 1.932L6.74 11.66a1 1 0 0 1-.707-1.226M15.38 7.299a1 1 0 1 1 1.413 1.414l-1.055 1.054a1 1 0 1 1-1.414-1.414zM10.435 6.034a1 1 0 0 1 1.224.707l.387 1.441a1 1 0 0 1-1.932.518L9.728 7.26a1 1 0 0 1 .707-1.225"
        />
      </svg>
    ))
);
AgentCursorIconFilltone.displayName = "AgentCursorIconFilltone";
export { AgentCursorIconFilltone };
