...
const ReceiptIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M16 15.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5zM16 11.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5zM16 7.25a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1 0-1.5z"
        />
      </svg>
    ))
);
ReceiptIconFillDuotone.displayName = "ReceiptIconFillDuotone";
export { ReceiptIconFillDuotone };
