...
const PanelsRightTopIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M16.75 19.25h-1.5v-9.5H2.75v-1.5h12.5v-3.5h1.5z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
PanelsRightTopIconDuotone.displayName = "PanelsRightTopIconDuotone";
export { PanelsRightTopIconDuotone };
