...
const PeaceFillDuotone = memo(
  forwardRef<SVGSVGElement, PeaceFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11 22.95a11 11 0 0 1-6.04-2.5L11 14.41zM19.04 20.45a11 11 0 0 1-6.04 2.5v-8.54zM4.58 20.12l.22.2-.2-.18zM19.4 20.14l-.2.17.22-.19zM11 11.59l-7.45 7.45a11 11 0 0 1 7.45-18zM13 1.05a11 11 0 0 1 7.45 17.99L13 11.59z" />
