  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M5.446 6.395a1.5 1.5 0 0 1 2.119.091l4.034 4.4 2.1-1.9a1.5 1.5 0 0 1 2.123.11l4.846 5.402a1.5 1.5 0 0 1-2.232 2.004l-3.841-4.28-2.087 1.89a1.5 1.5 0 0 1-2.113-.098l-5.041-5.5a1.5 1.5 0 0 1 .092-2.12"
        />
      </svg>
    ))
);
