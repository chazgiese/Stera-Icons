  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M3.63 2.63a2.13 2.13 0 0 1 2.193-.518L21.535 7.35c1.99.663 1.94 3.496-.073 4.088-1.381.407-2.478.591-3.518.757-1.037.166-2 .31-3.193.632a.9.9 0 0 0-.404.24l-.14.14-1.414-1.414.14-.14a2.9 2.9 0 0 1 1.298-.757c1.312-.353 2.377-.512 3.398-.675 1.02-.163 2.014-.333 3.268-.702.053-.015.07-.035.078-.045a.16.16 0 0 0 .025-.09q-.002-.06-.023-.088c-.007-.011-.022-.032-.075-.05L5.19 4.01a.13.13 0 0 0-.079-.006.15.15 0 0 0-.067.04z"
        />
      </svg>
    ))
);
