  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M5.044 4.043a.15.15 0 0 0-.04.067.13.13 0 0 0 .006.078L10.247 19.9c.017.053.038.068.049.076a.16.16 0 0 0 .089.022c.04 0 .071-.013.088-.025.01-.007.026-.023.04-.067l1.385-6.534c.12-.568.404-1.088.814-1.499l.08-.081 1.415 1.414-.08.081c-.137.137-.232.31-.272.5l-1.398 6.598-.019.075c-.592 2.013-3.425 2.064-4.089.073L3.112 4.821A2.13 2.13 0 0 1 3.63 2.63z"
          opacity={0.32}
        />
        <path
          fill="currentColor"
