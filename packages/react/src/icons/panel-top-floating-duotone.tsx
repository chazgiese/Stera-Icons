...
const PanelTopFloatingIconDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M17.499 6.5a2 2 0 0 1 2 2V11a2 2 0 0 1-2 2H6.501a2 2 0 0 1-2-2V8.5a2 2 0 0 1 2-2z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
PanelTopFloatingIconDuotone.displayName = "PanelTopFloatingIconDuotone";
export { PanelTopFloatingIconDuotone };
