  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M20.004 19.62a1 1 0 1 1 1.173 1.62c-.616.446-1.374.609-2.203.685-.834.076-1.907.075-3.245.075H8.272c-1.339 0-2.412.002-3.246-.075-.83-.076-1.587-.24-2.203-.686a1 1 0 0 1 1.173-1.619c.172.124.487.247 1.212.314C5.93 20 6.894 20 8.272 20h7.457c1.377 0 2.342 0 3.062-.066.726-.067 1.042-.19 1.213-.314"
          opacity={0.32}
        />
        <path
          fill="currentColor"
