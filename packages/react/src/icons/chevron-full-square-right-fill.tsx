...
const ChevronFullSquareRightIconFill = memo(
...
ChevronFullSquareRightIconFill.displayName = "ChevronFullSquareRightIconFill";
export { ChevronFullSquareRightIconFill };
