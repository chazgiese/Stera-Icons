...
const PanelRightFloatingFillDuotone = memo(
  forwardRef<SVGSVGElement, PanelRightFloatingFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M5 3a4 4 0 0 0-4 4v10a4 4 0 0 0 4 4h14a4 4 0 0 0 4-4V7a4 4 0 0 0-4-4zm12.5 3.5a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H15a2 2 0 0 1-2-2v-7c0-1.1.9-2 2-2z" clipRule="evenodd" opacity={.4} />
...
export { PanelRightFloatingFillDuotone };
