...
const ArrowSquareDownLeftIconFilltone = memo(
...
ArrowSquareDownLeftIconFilltone.displayName = "ArrowSquareDownLeftIconFilltone";
export { ArrowSquareDownLeftIconFilltone };
