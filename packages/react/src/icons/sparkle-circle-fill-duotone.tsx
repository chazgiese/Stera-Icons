...
const SparkleCircleIconFillDuotone = memo(
...
SparkleCircleIconFillDuotone.displayName = "SparkleCircleIconFillDuotone";
export { SparkleCircleIconFillDuotone };
