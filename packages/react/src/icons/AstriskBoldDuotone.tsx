...
const AstriskBoldDuotone = memo(
  forwardRef<SVGSVGElement, AstriskBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11 12.57v1.16l-7.16 4.13a1 1 0 0 1-1-1.73L10 11.99zM21.17 16.13a1 1 0 1 1-1 1.73L13 13.72v-1.15l1-.58zM12 1a1 1 0 0 1 1 1v8.26l-1 .58-1-.58V2a1 1 0 0 1 1-1" />
