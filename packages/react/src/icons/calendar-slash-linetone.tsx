    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M8.995 11.246a4.25 4.25 0 1 1 6.01 6.008 4.25 4.25 0 0 1-6.01-6.009M9.6 12.91a2.75 2.75 0 0 0 3.74 3.739zm4.345-.605a2.75 2.75 0 0 0-3.285-.456l3.74 3.74a2.75 2.75 0 0 0-.455-3.284"
          clipRule="evenodd"
        />
      </svg>
    ))
