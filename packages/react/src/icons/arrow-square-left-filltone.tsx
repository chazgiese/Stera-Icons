...
const ArrowSquareLeftIconFilltone = memo(
...
ArrowSquareLeftIconFilltone.displayName = "ArrowSquareLeftIconFilltone";
export { ArrowSquareLeftIconFilltone };
