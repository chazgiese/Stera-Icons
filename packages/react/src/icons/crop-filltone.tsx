  ...
  IconProps >
    ((
      ...
      <svg
        ...
        {...props}
      >
        <g fill="currentColor" clipPath="url(#clip0_3425_11628)">
          <path
            ...
            opacity={0.32}
          />
          <path d="M14.8 4.5c.535 0 1.027-.001 1.435.032.427.035.893.115 1.354.35a3.5 3.5 0 0 1 1.53 1.53c.234.46.314.926.349 1.353.033.408.032.9.032 1.435V22a1.5 1.5 0 0 1-3 0V9.2c0-.584-.001-.933-.023-1.191-.02-.24-.048-.268-.032-.236a.5.5 0 0 0-.218-.218c.032.016.005-.013-.236-.033-.258-.02-.607-.022-1.191-.022H2a1.5 1.5 0 1 1 0-3z" />
        </g>
      </svg>
    ))
);
