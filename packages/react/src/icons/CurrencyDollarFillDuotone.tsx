...
const CurrencyDollarFillDuotone = memo(
  forwardRef<SVGSVGElement, CurrencyDollarFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13.5 22a1.5 1.5 0 0 1-3 0v-2.5h3zM13.5 13.5v3h-3v-3zM13.5 10.5h-3v-3h3zM12 .5c.83 0 1.5.67 1.5 1.5v2.5h-3V2c0-.83.67-1.5 1.5-1.5" />
...
export { CurrencyDollarFillDuotone };
