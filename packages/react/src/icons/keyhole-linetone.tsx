  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M18.99 17.743C19.738 19.24 18.65 21 16.977 21H7.022c-1.672 0-2.76-1.76-2.012-3.257l2.687-5.374 1.79.895-2.688 5.374a.25.25 0 0 0 .223.362h9.955a.25.25 0 0 0 .224-.362l-2.687-5.374 1.789-.895z"
          opacity={0.32}
        />
      </svg>
    ))
