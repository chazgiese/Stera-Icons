...
const ArrowSquareDownLeftIconLinetone = memo(
...
ArrowSquareDownLeftIconLinetone.displayName = "ArrowSquareDownLeftIconLinetone";
export { ArrowSquareDownLeftIconLinetone };
