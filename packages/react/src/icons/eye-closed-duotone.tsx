    ...
    ((
      ...
      >
        ...
        <g fill="currentColor" opacity={0.4}>
          <path d="M8.494 14.398q.707.23 1.455.365l-.706 2.445a.75.75 0 0 1-1.44-.416zM16.198 16.792a.75.75 0 0 1-1.441.416l-.707-2.445q.748-.135 1.455-.365zM3.883 11.474q.51.551 1.098 1.027L3.01 14.328a.75.75 0 1 1-1.02-1.1zM22.01 13.229a.75.75 0 0 1-1.02 1.1L19.02 12.5q.588-.476 1.096-1.027z" />
        </g>
      </svg>
    ))
);
