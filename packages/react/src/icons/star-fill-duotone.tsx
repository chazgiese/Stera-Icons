...
const StarIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M14.019 8.323c.227.527.725.886 1.294.939l5.07.467-3.822 3.346a1.57 1.57 0 0 0-.496 1.523l1.12 4.95-4.386-2.594-.19-.096a1.57 1.57 0 0 0-1.218 0l-.19.096-4.387 2.594 1.12-4.95a1.57 1.57 0 0 0-.496-1.523L3.615 9.73l5.072-.467a1.57 1.57 0 0 0 1.294-.939L12 3.654z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
StarIconFillDuotone.displayName = "StarIconFillDuotone";
export { StarIconFillDuotone };
