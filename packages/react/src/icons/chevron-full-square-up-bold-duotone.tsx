...
const ChevronFullSquareUpIconBoldDuotone = memo(
...
ChevronFullSquareUpIconBoldDuotone.displayName =
  "ChevronFullSquareUpIconBoldDuotone";
export { ChevronFullSquareUpIconBoldDuotone };
