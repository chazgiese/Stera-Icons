...
const ChevronFullCircleDownIconFilled = memo(
...
ChevronFullCircleDownIconFilled.displayName = "ChevronFullCircleDownIconFilled";
export { ChevronFullCircleDownIconFilled };
