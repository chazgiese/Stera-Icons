...
const PanelRightFloatingIconBoldDuotone = memo(
...
PanelRightFloatingIconBoldDuotone.displayName =
  "PanelRightFloatingIconBoldDuotone";
export { PanelRightFloatingIconBoldDuotone };
