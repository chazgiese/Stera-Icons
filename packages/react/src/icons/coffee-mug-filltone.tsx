  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M18.017 4A1 1 0 0 1 19 5l-.002.032.001.001-.001.04-.388 11.645a5 5 0 0 1-4.237 4.775l-.18.027c-2.116.326-4.27.326-6.386 0l-.18-.027a5 5 0 0 1-4.237-4.775L3.002 5.072l-.001-.039h.001L3 5l.005-.1a1 1 0 0 1 1.984-.043c.027.025.072.061.145.109.242.157.65.334 1.231.498C7.518 5.787 9.155 6 11 6s3.482-.213 4.635-.536c.582-.164.989-.34 1.231-.498.073-.048.118-.084.145-.109A1 1 0 0 1 18.017 4"
          opacity={0.32}
        />
        <path
          fill="currentColor"
