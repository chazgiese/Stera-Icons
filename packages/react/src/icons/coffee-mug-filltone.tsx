  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M18.017 4A1 1 0 0 1 19 5l-.002.032h.001l-.001.04-.388 11.645a5 5 0 0 1-4.237 4.776l-.18.027c-2.116.326-4.27.326-6.386 0l-.18-.027a5 5 0 0 1-4.237-4.776L3.002 5.072l-.001-.04h.001L3 5l.005-.1a1 1 0 0 1 1.984-.043c.027.024.072.061.145.108.242.158.65.335 1.231.499C7.518 5.787 9.155 6 11 6s3.482-.213 4.635-.536c.582-.164.989-.341 1.231-.499.073-.047.118-.084.145-.108A1 1 0 0 1 18.017 4"
          opacity={0.32}
        />
        <path
          fill="currentColor"
