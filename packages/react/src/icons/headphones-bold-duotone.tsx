...
const HeadphonesIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M5.236 13.59a3 3 0 0 1 3.579 2.278l.65 2.93a3 3 0 0 1-5.857 1.3l-.65-2.929a3 3 0 0 1 2.278-3.579m1.627 2.712a1 1 0 0 0-1.953.434l.65 2.928a1 1 0 0 0 1.953-.433zM15.185 15.869a3 3 0 0 1 5.857 1.3l-.65 2.929a3 3 0 0 1-5.857-1.3zm3.145-.327a1 1 0 0 0-1.192.76l-.65 2.929a1 1 0 1 0 1.952.433l.65-2.928a1 1 0 0 0-.76-1.194"
          clipRule="evenodd"
        />
      </svg>
    ))
);
HeadphonesIconBoldDuotone.displayName = "HeadphonesIconBoldDuotone";
export { HeadphonesIconBoldDuotone };
