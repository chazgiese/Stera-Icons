    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M7.573 16.5a20.6 20.6 0 0 1-1.737 2.554 1.5 1.5 0 0 0-.248.446H2a1.5 1.5 0 0 1 0-3zM22 16.5a1.5 1.5 0 0 1 0 3H9.229a29 29 0 0 0 1.763-3h5.1c.355.283.82.5 1.408.5.62 0 1.188-.244 1.63-.5zM4.293 11.293a1 1 0 1 1 1.414 1.414l-.793.793.793.793a1 1 0 0 1-1.414 1.414l-.793-.793-.793.793a1 1 0 0 1-1.414-1.414l.793-.793-.793-.793a1 1 0 0 1 1.414-1.414l.793.793z" />
        </g>
        <path
          fill="currentColor"
          fillRule="evenodd"
