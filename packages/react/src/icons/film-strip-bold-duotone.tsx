...
const FilmStripIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M8.5 4v7h7V4h2v2.5H20v2h-2.5V11H20v2h-2.5v2.5H20v2h-2.5V20h-2v-7h-7v7h-2v-2.5H4v-2h2.5V13H4v-2h2.5V8.5H4v-2h2.5V4z"
        />
      </svg>
    ))
);
FilmStripIconBoldDuotone.displayName = "FilmStripIconBoldDuotone";
export { FilmStripIconBoldDuotone };
