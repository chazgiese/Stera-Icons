...
const TextStrikethroughRegularDuotone = memo(
  forwardRef<SVGSVGElement, TextStrikethroughRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M17.17 12.75a5.23 5.23 0 0 1-3.67 9H7a.75.75 0 0 1 0-1.5h6.5a3.75 3.75 0 1 0 0-7.5z" />
        <path fillRule="evenodd" d="M11.33 11.25h-3.5a5.23 5.23 0 0 1 3.67-9H17a.75.75 0 0 1 0 1.5h-5.5a3.75 3.75 0 0 0-.17 7.5" clipRule="evenodd" />
...
export { TextStrikethroughRegularDuotone };
