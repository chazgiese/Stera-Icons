  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 2a1 1 0 0 1 1 1v10.586l4.293-4.293a1 1 0 1 1 1.414 1.414l-6 6A1 1 0 0 1 12 17c-.273 0-.508-.115-.707-.293l-6-6a1 1 0 1 1 1.414-1.414L11 13.586V3a1 1 0 0 1 1-1"
        />
      </svg>
    ))
);
DownloadIconBold.displayName = "DownloadIconBold";
export { DownloadIconBold };
