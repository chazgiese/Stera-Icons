  ...
  IconProps >
    ((
      ...
      <svg
        ...
        {...props}
      >
        <g fill="currentColor" clipPath="url(#clip0_5049_3639)">
          <path d="M8.57 7.377a1.5 1.5 0 0 1 1.86 2.356q-.192.15-.369.327a4.157 4.157 0 0 0 0 5.879l3 3a4.157 4.157 0 0 0 6.805-4.473 1.5 1.5 0 1 1 2.789-1.104A7.159 7.159 0 0 1 10.94 21.06l-3-3a7.157 7.157 0 0 1 .63-10.683" />
