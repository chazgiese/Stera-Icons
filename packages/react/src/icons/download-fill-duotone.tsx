...
const DownloadIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M12 2a1 1 0 0 1 1 1v6.5h4.5a1 1 0 0 1 .707 1.707l-5.5 5.5a1 1 0 0 1-1.34.066l-.074-.066-5.5-5.5A1 1 0 0 1 6.5 9.5H11V3a1 1 0 0 1 1-1"
        />
      </svg>
    ))
);
DownloadIconFillDuotone.displayName = "DownloadIconFillDuotone";
export { DownloadIconFillDuotone };
