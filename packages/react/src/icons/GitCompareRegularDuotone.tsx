...
const GitCompareRegularDuotone = memo(
  forwardRef<SVGSVGElement, GitCompareRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M19.75 16v.2A3.75 3.75 0 0 1 16 19.74h-3.19l-.75-.75.75-.75H16c1.16 0 2.12-.89 2.24-2.02l.01-.23V8.16a3 3 0 0 0 1.5 0zM11.94 5l-.75.75H8c-1.24 0-2.25 1-2.25 2.25v7.84a3 3 0 0 0-1.5 0V8A3.75 3.75 0 0 1 8 4.25h3.19z" />
...
export { GitCompareRegularDuotone };
