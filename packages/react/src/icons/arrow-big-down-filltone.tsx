  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M7 9.5a1 1 0 0 1 0 2H4.414l7.41 7.41a.25.25 0 0 0 .353 0l7.409-7.41H17a1 1 0 0 1 0-2h3.793c1.336 0 2.005 1.616 1.06 2.56l-8.262 8.263a2.25 2.25 0 0 1-3.182 0L2.146 12.06c-.944-.944-.275-2.56 1.061-2.56z"
        />
      </svg>
    ))
);
