...
const FlowSplitSquareLeftIconFilltone = memo(
...
FlowSplitSquareLeftIconFilltone.displayName = "FlowSplitSquareLeftIconFilltone";
export { FlowSplitSquareLeftIconFilltone };
