...
const AlarmClockPlusBold = memo(
  forwardRef<SVGSVGElement, AlarmClockPlusBoldProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M12 8.5a1 1 0 0 1 1 1V12h2.5a1 1 0 0 1 0 2H13v2.5a1 1 0 1 1-2 0V14H8.5a1 1 0 1 1 0-2H11V9.5a1 1 0 0 1 1-1" />
