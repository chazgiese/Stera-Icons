...
const CursorTextRegularDuotone = memo(
  forwardRef<SVGSVGElement, CursorTextRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M12.75 18c0 1.8 1.46 3.25 3.25 3.25h1a.75.75 0 0 1 0 1.5h-1a4.7 4.7 0 0 1-4-2.19c.47-.74.75-1.62.75-2.56M8 1.25c1.68 0 3.16.87 4 2.19A4.7 4.7 0 0 0 11.25 6c0-1.8-1.46-3.25-3.25-3.25H7a.75.75 0 0 1 0-1.5z" />
...
export { CursorTextRegularDuotone };
