  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M.793 4.293a1 1 0 0 1 1.414 0L9.5 11.586l2.793-2.793a1 1 0 0 1 1.414 0l7.793 7.793V18h-1.414L13 10.914l-2.793 2.793a1 1 0 0 1-1.34.066l-.074-.066-8-8a1 1 0 0 1 0-1.414"
          opacity={0.4}
        />
        <path
          fill="currentColor"
