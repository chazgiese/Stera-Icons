  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M2.939 2.94a7.16 7.16 0 0 1 10.122 0l3 3a7.158 7.158 0 0 1-.632 10.683 1.5 1.5 0 0 1-1.858-2.354q.19-.15.368-.328a4.157 4.157 0 0 0 0-5.88l-3-3a4.156 4.156 0 0 0-6.797 4.49 1.5 1.5 0 0 1-2.784 1.117 7.16 7.16 0 0 1 1.581-7.727"
        />
      </svg>
    ))
);
