...
const SquarePlaceholderBoldDuotone = memo(
  forwardRef<SVGSVGElement, SquarePlaceholderBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M11.87 20H11l-1.97-.01L4 14.97 4 13v-.87zM17.8 19.57c-.37.19-.84.3-1.6.37l-.82.04L4.02 8.62l.04-.82c.07-.76.18-1.23.37-1.6zM19.98 15.38l-.04.82a4 4 0 0 1-.37 1.6L6.2 4.43c.37-.19.84-.3 1.6-.37l.82-.04zM13 4l1.97.01 5.02 5.02L20 11v.87L12.13 4z" />
...
export { SquarePlaceholderBoldDuotone };
