...
const AlertTriangleIconBoldDuotone = memo(
...
AlertTriangleIconBoldDuotone.displayName = "AlertTriangleIconBoldDuotone";
export { AlertTriangleIconBoldDuotone };
