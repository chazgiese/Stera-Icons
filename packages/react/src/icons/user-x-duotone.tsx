  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M18.97 15.468a.752.752 0 0 1 1.06 1.063l-1.47 1.466 1.47 1.472a.751.751 0 0 1-1.062 1.06L17.5 19.06l-1.47 1.47a.751.751 0 0 1-1.062-1.06l1.47-1.472-1.469-1.466a.752.752 0 0 1 1.06-1.063l1.47 1.467z"
        />
      </svg>
    ))
);
UserXIconDuotone.displayName = "UserXIconDuotone";
export { UserXIconDuotone };
