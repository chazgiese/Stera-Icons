...
const CursorPointerIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M10 3a1 1 0 0 1 1 1v7a1 1 0 0 0 2 0V9a1 1 0 0 1 2 0v2.5a1 1 0 0 0 2 0V10a1 1 0 0 1 2 0v4a7 7 0 0 1-13.905 1.158 1 1 0 0 0-.022-.101l-.034-.099-1.221-3.116-.065-.135-.047-.092a1 1 0 0 1 1.779-.908l.005.008 1.65 2.794A1 1 0 0 0 9 13V4a1 1 0 0 1 1-1"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
CursorPointerIconFillDuotone.displayName = "CursorPointerIconFillDuotone";
export { CursorPointerIconFillDuotone };
