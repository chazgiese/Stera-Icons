...
const ArrowSquareDownLeftIconFillDuotone = memo(
...
ArrowSquareDownLeftIconFillDuotone.displayName =
  "ArrowSquareDownLeftIconFillDuotone";
export { ArrowSquareDownLeftIconFillDuotone };
