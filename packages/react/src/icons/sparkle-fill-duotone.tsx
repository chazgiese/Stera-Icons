...
const SparkleIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12.135 5.876a9 9 0 0 0 5.989 5.99l.442.134-.442.135a9 9 0 0 0-5.99 5.989l-.134.442-.135-.442a9 9 0 0 0-5.989-5.99L5.433 12l.443-.135a9 9 0 0 0 5.99-5.989L12 5.433z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
SparkleIconFillDuotone.displayName = "SparkleIconFillDuotone";
export { SparkleIconFillDuotone };
