  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M13.336 4.604c1.26-1.26 3.414-.368 3.414 1.414v11.965c0 1.781-2.154 2.673-3.414 1.414L9.47 15.53a.75.75 0 0 1 1.06-1.06l3.867 3.866a.5.5 0 0 0 .853-.353V6.018a.5.5 0 0 0-.854-.354L10.53 9.53a.75.75 0 0 1-1.06-1.06z"
        />
      </svg>
    ))
);
