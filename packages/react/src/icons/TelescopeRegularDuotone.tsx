...
const TelescopeRegularDuotone = memo(
  forwardRef<SVGSVGElement, TelescopeRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M10.15 15.03q.56.52 1.34.67l-2.82 5.64a.75.75 0 0 1-1.34-.68zM16.67 20.67a.75.75 0 0 1-1.34.66L12.5 15.7q.78-.16 1.34-.67zM14.64 4.58c-.25.55-.32 1.2-.15 1.83l-.05-.17-7.1 2.5.84 3.11 1.47-.27q-.39.63-.4 1.42v.17l-2.16.41-1.55-5.8zM15.53 10.3c.18.63.56 1.15 1.05 1.5l-1.96.37a2.8 2.8 0 0 0-.95-1.35l1.9-.35z" />
        ...
        <path fill="currentColor" fillRule="evenodd" d="M18.13 2.6A2 2 0 0 1 20.58 4L22 9.33a2 2 0 0 1-1.41 2.45l-1.7.45a2.75 2.75 0 0 1-3.36-1.95l-1.04-3.86a2.75 2.75 0 0 1 1.95-3.37zm.38 1.45-1.69.45c-.66.18-1.06.87-.88 1.53l1.04 3.87c.17.66.86 1.06 1.53.88l1.69-.45a.5.5 0 0 0 .35-.62l-1.42-5.3a.5.5 0 0 0-.62-.36" clipRule="evenodd" />
    </IconBase>
  ))
);
...
export { TelescopeRegularDuotone };
