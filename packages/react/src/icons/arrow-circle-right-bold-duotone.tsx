...
const ArrowCircleRightIconBoldDuotone = memo(
...
ArrowCircleRightIconBoldDuotone.displayName = "ArrowCircleRightIconBoldDuotone";
export { ArrowCircleRightIconBoldDuotone };
