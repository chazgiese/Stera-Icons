...
const WifiIconFillDuotone = memo(
    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M12 14a5.7 5.7 0 0 1 3.393 1.119c.436.32.432.947.054 1.335l-2.013 2.071a2 2 0 0 1-2.868 0l-2.013-2.07c-.377-.389-.382-1.015.054-1.336A5.7 5.7 0 0 1 12 14"
          clipRule="evenodd"
          opacity={0.4}
        />
        <path
...
WifiIconFillDuotone.displayName = "WifiIconFillDuotone";
export { WifiIconFillDuotone };
