...
const ChatBoxDashedFillDuotone = memo(
  forwardRef<SVGSVGElement, ChatBoxDashedFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M5 9.6c0-1.26 0-1.89.25-2.37q.33-.65.98-.98C6.7 6 7.34 6 8.6 6h6.8c1.26 0 1.89 0 2.37.25q.65.33.98.98C19 7.7 19 8.34 19 9.6v1.8c0 1.26 0 1.89-.25 2.37q-.33.65-.98.98c-.48.25-1.11.25-2.37.25H8.6c-1.26 0-1.89 0-2.37-.25a2.3 2.3 0 0 1-.98-.98C5 13.3 5 12.66 5 11.4z" opacity={.4} />
...
export { ChatBoxDashedFillDuotone };
