...
const CrosshairFillDuotone = memo(
  forwardRef<SVGSVGElement, CrosshairFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M6.7 13.5a5.5 5.5 0 0 0 3.8 3.8v3.07a8.5 8.5 0 0 1-6.87-6.87zM20.37 13.5a8.5 8.5 0 0 1-6.87 6.87v-3.08a5.5 5.5 0 0 0 3.8-3.79zM13.5 3.63a8.5 8.5 0 0 1 6.87 6.87h-3.08a5.5 5.5 0 0 0-3.79-3.8zM10.5 6.7a5.5 5.5 0 0 0-3.8 3.8H3.64a8.5 8.5 0 0 1 6.87-6.87z" />
