...
const CubePackageBoldDuotone = memo(
  forwardRef<SVGSVGElement, CubePackageBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="m12 10.86 2.43-1.35c.29.17.43.28.54.4q.3.32.43.73c.05.14.07.3.08.57L13 12.59v7.65q-.22.09-.4.12a3 3 0 0 1-1.6-.12v-7.65L4.07 8.74l.08-.33a3 3 0 0 1 .97-1.38zM18.88 7.03q.2.15.33.29a3 3 0 0 1 .72 1.42l-2.59 1.43-.04-.16a4 4 0 0 0-.86-1.46l-.1-.1z" />
