...
const DraftingCompassRegularDuotone = memo(
  forwardRef<SVGSVGElement, DraftingCompassRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.67 16.76a.75.75 0 0 1 1.28.78l-2.3 3.85a.75.75 0 0 1-1.3-.78zM9.47 8.76q.55.51 1.28.78l-1.7 2.85a.75.75 0 0 1-1.3-.78z" />
...
export { DraftingCompassRegularDuotone };
