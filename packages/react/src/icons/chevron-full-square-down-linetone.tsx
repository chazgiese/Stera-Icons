...
const ChevronFullSquareDownIconLinetone = memo(
...
ChevronFullSquareDownIconLinetone.displayName =
  "ChevronFullSquareDownIconLinetone";
export { ChevronFullSquareDownIconLinetone };
