  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M10.409 3.677a2.25 2.25 0 0 1 3.182 0l8.262 8.263c.945.945.276 2.56-1.06 2.56H16a1 1 0 0 1 0-2h3.586l-7.41-7.409a.25.25 0 0 0-.353 0l-7.41 7.41H8a1 1 0 0 1 0 2H3.207c-1.336 0-2.005-1.616-1.06-2.561z"
        />
      </svg>
    ))
);
