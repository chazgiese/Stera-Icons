...
const ArrowSquareLeftIconBoldDuotone = memo(
...
ArrowSquareLeftIconBoldDuotone.displayName = "ArrowSquareLeftIconBoldDuotone";
export { ArrowSquareLeftIconBoldDuotone };
