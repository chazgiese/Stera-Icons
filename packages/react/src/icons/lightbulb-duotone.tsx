    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M15.258 14.25a.75.75 0 0 1 .719.965c-.145.483-.227.96-.227 1.443V19c0 1.308-.914 2.4-2.137 2.679a1.75 1.75 0 0 1-3.226 0A2.75 2.75 0 0 1 8.25 19v-2.342c0-.482-.082-.96-.227-1.443a.75.75 0 0 1 .72-.965zm-5.58 1.5q.07.444.072.908V19c0 .69.56 1.25 1.25 1.25h2c.69 0 1.25-.56 1.25-1.25v-2.342q.002-.464.071-.908z"
          clipRule="evenodd"
        />
      </svg>
    ))
