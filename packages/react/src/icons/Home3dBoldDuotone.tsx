...
const Home3dBoldDuotone = memo(
  forwardRef<SVGSVGElement, Home3dBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M8.5 13a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-.9V14a1 1 0 0 1 1-1zM19.85 10.27q.15.15.15.35V11h-6v-1a1 1 0 0 0-.3-.7l-.29-.3h5.18z" />
