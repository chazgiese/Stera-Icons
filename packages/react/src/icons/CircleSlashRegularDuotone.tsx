...
const CircleSlashRegularDuotone = memo(
  forwardRef<SVGSVGElement, CircleSlashRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M4.95 6.01A9.25 9.25 0 0 0 18 19.05l1.06 1.06A10.75 10.75 0 0 1 3.89 4.95zM12 1.25a10.75 10.75 0 0 1 8.11 17.8l-1.06-1.06A9.25 9.25 0 0 0 6 4.95L4.95 3.9A10.7 10.7 0 0 1 12 1.25" />
...
export { CircleSlashRegularDuotone };
