...
const CursorTextFillDuotone = memo(
  forwardRef<SVGSVGElement, CursorTextFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M13.5 17.5A2.5 2.5 0 0 0 16 20h1a1.5 1.5 0 0 1 0 3h-1c-1.58 0-3-.66-4-1.73a5.5 5.5 0 0 0 1.5-3.77M8 1c1.58 0 3 .66 4 1.73a5.5 5.5 0 0 0-1.5 3.77A2.5 2.5 0 0 0 8 4H7a1.5 1.5 0 1 1 0-3z" />
