...
const GaugeLines33PercentIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M6.34 17.709a1 1 0 1 1 1.414 1.414l-1.06 1.06a1 1 0 0 1-1.415-1.413zM16.246 17.709a1 1 0 0 1 1.414 0l1.06 1.06a1 1 0 0 1-1.413 1.415l-1.06-1.06a1 1 0 0 1 0-1.415M6.343 7.807a1 1 0 0 1 1.299-.099v.001l.004.002.01.008.042.031.158.116a779 779 0 0 1 2.356 1.741c1.306.97 2.76 2.06 3.145 2.39q.03.026.057.053a2 2 0 0 1-2.828 2.828l-.053-.057c-.33-.385-1.42-1.84-2.39-3.145-.493-.664-.968-1.306-1.319-1.782-.175-.239-.32-.437-.422-.574l-.116-.158-.031-.042-.008-.01-.002-.004a1 1 0 0 1 .098-1.3M5 12.465a1 1 0 0 1 0 2H3.5a1 1 0 0 1 0-2zM20.5 12.465a1 1 0 0 1 0 2H19a1 1 0 0 1 0-2zM17.3 6.749a1 1 0 1 1 1.414 1.414l-1.06 1.06a1 1 0 0 1-1.415-1.413zM11.997 3.965A1 1 0 0 1 13 4.962l.005 1.505a1 1 0 0 1-2 .006L11 4.968a1 1 0 0 1 .997-1.003"
        />
      </svg>
    ))
);
GaugeLines33PercentIconFillDuotone.displayName =
  "GaugeLines33PercentIconFillDuotone";
export { GaugeLines33PercentIconFillDuotone };
