...
const ChartBarXYRegular = memo(
  forwardRef<SVGSVGElement, ChartBarXYRegularProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path fill="currentColor" d="M2 3.25c.41 0 .75.34.75.75v14l.01.76.04.22q.08.15.22.22l.22.04.76.01h18a.75.75 0 0 1 0 1.5H4q-.51 0-.88-.02a2 2 0 0 1-.78-.2 2 2 0 0 1-.87-.87 2 2 0 0 1-.2-.78q-.02-.36-.02-.88V4c0-.41.34-.75.75-.75" />
