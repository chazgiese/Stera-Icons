...
const PlugIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M10.757 4.758a6 6 0 1 1 8.46 8.51l-.152.143a2.25 2.25 0 0 1-3.125-.057l-.44-.44-.793.793a1 1 0 1 1-1.414-1.414l.792-.793L12.5 9.914l-.792.793a1 1 0 1 1-1.414-1.414l.792-.793-.438-.439a2.25 2.25 0 0 1-.057-3.125l.144-.152zm7.071 1.415a4 4 0 0 0-5.656 0l-.118.127a.25.25 0 0 0 .007.346l4.138 4.14.008.007.006.007 1.14 1.14a.25.25 0 0 0 .348.006l.127-.117a4 4 0 0 0 0-5.656"
          clipRule="evenodd"
        />
      </svg>
    ))
);
PlugIconBoldDuotone.displayName = "PlugIconBoldDuotone";
export { PlugIconBoldDuotone };
