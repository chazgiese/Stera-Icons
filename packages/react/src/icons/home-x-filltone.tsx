    ...
    ((
      ...
      >
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M9.237 2.882a4.5 4.5 0 0 1 5.526 0l5.5 4.279A4.5 4.5 0 0 1 22 10.713V17.5a4.5 4.5 0 0 1-4.5 4.5h-11A4.5 4.5 0 0 1 2 17.5v-6.789a4.5 4.5 0 0 1 1.737-3.551zm5.97 7.412a1 1 0 0 0-1.414 0L12 12.086l-1.793-1.792a1 1 0 1 0-1.414 1.414l1.793 1.793-1.793 1.793a1 1 0 0 0 1.414 1.414L12 14.915l1.793 1.793a1 1 0 0 0 1.414-1.414L13.414 13.5l1.793-1.793a1 1 0 0 0 0-1.414"
          clipRule="evenodd"
          opacity={0.4}
        />
        <path
