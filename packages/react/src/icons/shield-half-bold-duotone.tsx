...
const ShieldHalfIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M13 3.443V20.38q-.04.022-.081.043L12 20.88l-.919-.46L11 20.38V3.443l1-.375z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
ShieldHalfIconBoldDuotone.displayName = "ShieldHalfIconBoldDuotone";
export { ShieldHalfIconBoldDuotone };
