    ...
    ((
      ...
      >
        <g fill="currentColor" opacity={0.4}>
          <path d="M19.53 14.518A1 1 0 0 1 21 15.4V19c0 .803-.437 1.448-.965 1.916-.529.469-1.238.846-2.027 1.142-1.586.595-3.71.942-6.008.942s-4.422-.348-6.008-.942c-.79-.296-1.498-.673-2.027-1.142C3.437 20.448 3 19.803 3 19v-3.6a1 1 0 0 1 1.47-.882C6.102 15.386 8.828 16 12 16s5.898-.614 7.53-1.482M21 5v6.4a1 1 0 0 1-.53.883C18.453 13.357 15.37 14 12 14s-6.453-.643-8.47-1.717A1 1 0 0 1 3 11.4V5c0 .803.437 1.448.965 1.916.529.469 1.238.846 2.027 1.142C7.578 8.652 9.702 9 12 9s4.422-.348 6.008-.942c.79-.296 1.498-.673 2.027-1.142C20.563 6.448 21 5.803 21 5" />
        </g>
        <path
          fill="currentColor"
          fillRule="evenodd"
