...
const ChatBoxTextIconBold = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 11.5a1 1 0 1 1 0 2H8a1 1 0 1 1 0-2zM16 7.5a1 1 0 1 1 0 2H8a1 1 0 1 1 0-2z"
        />
        <path
          fill="currentColor"
          fillRule="evenodd"
...
ChatBoxTextIconBold.displayName = "ChatBoxTextIconBold";
export { ChatBoxTextIconBold };
