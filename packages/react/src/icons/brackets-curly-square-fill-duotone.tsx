...
const BracketsCurlySquareIconFillDuotone = memo(
...
BracketsCurlySquareIconFillDuotone.displayName =
  "BracketsCurlySquareIconFillDuotone";
export { BracketsCurlySquareIconFillDuotone };
