...
const TicketRegularDuotone = memo(
  forwardRef<SVGSVGElement, TicketRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M15 15.25c.41 0 .75.34.75.75v2.25h-1.5V16c0-.41.34-.75.75-.75M15 10.25c.41 0 .75.34.75.75v2a.75.75 0 0 1-1.5 0v-2c0-.41.34-.75.75-.75M15.75 5.75V8a.75.75 0 0 1-1.5 0V5.75z" />
