...
const MacWindowCursorIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M13.128 13.11c-.395-1.187.687-2.319 1.87-2.017l.114.033 7.817 2.606c1.457.486 1.42 2.56-.054 2.993l-3.206.942-.942 3.206c-.434 1.474-2.508 1.511-2.994.054z"
        />
      </svg>
    ))
);
MacWindowCursorIconFillDuotone.displayName = "MacWindowCursorIconFillDuotone";
export { MacWindowCursorIconFillDuotone };
