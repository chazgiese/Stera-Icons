...
const MoreCircleVerticalFilled = memo(
...
MoreCircleVerticalFilled.displayName = "MoreCircleVerticalFilled";
export { MoreCircleVerticalFilled };
export default MoreCircleVerticalFilled;
