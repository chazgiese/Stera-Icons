...
const BracketsSquareSquareIconFillDuotone = memo(
...
BracketsSquareSquareIconFillDuotone.displayName =
  "BracketsSquareSquareIconFillDuotone";
export { BracketsSquareSquareIconFillDuotone };
