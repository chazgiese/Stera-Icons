...
const GavelIconBoldDuotone = memo(
    ...
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          fillRule="evenodd"
          d="M3.707 10.779a2 2 0 0 1 2.828 0l4.243 4.242a2 2 0 0 1 0 2.828l-.707.708a2 2 0 0 1-2.829 0L3 14.314a2 2 0 0 1 0-2.828zm.707 2.12 4.242 4.243.708-.707-4.243-4.242zM11.486 3a2 2 0 0 1 2.828 0l4.244 4.242c.78.781.78 2.048 0 2.83l-.708.707a2 2 0 0 1-2.829 0L10.78 6.534a2 2 0 0 1 0-2.828zm.707 2.121 4.242 4.243.708-.708L12.9 4.414z"
          clipRule="evenodd"
        />
      </svg>
    ))
);
GavelIconBoldDuotone.displayName = "GavelIconBoldDuotone";
export { GavelIconBoldDuotone };
