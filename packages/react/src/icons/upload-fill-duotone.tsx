...
const UploadIconFillDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M12 2a1 1 0 0 1 .707.293l5.5 5.5A1 1 0 0 1 17.5 9.5H13V16a1 1 0 0 1-2 0V9.5H6.5a1 1 0 0 1-.707-1.707l5.5-5.5.073-.066A1 1 0 0 1 12 2"
        />
        <path
          fill="currentColor"
...
UploadIconFillDuotone.displayName = "UploadIconFillDuotone";
export { UploadIconFillDuotone };
