...
const OverlappingCirclesDashIconBold = memo(
...
OverlappingCirclesDashIconBold.displayName = "OverlappingCirclesDashIconBold";
export { OverlappingCirclesDashIconBold };
