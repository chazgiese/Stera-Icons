...
const GlobeIconFillDuotone = memo(
    ...
    ((
      ...
      >
        ...
        <g fill="currentColor" opacity={0.4}>
          <path d="M7.195 13a15.9 15.9 0 0 0 2.56 7.717A9.005 9.005 0 0 1 3.057 13zM20.943 13a9.005 9.005 0 0 1-6.699 7.717A15.9 15.9 0 0 0 16.804 13zM14.798 13A13.9 13.9 0 0 1 12 20.43 13.9 13.9 0 0 1 9.202 13zM9.755 3.282A15.9 15.9 0 0 0 7.195 11H3.057a9.01 9.01 0 0 1 6.698-7.718M12 3.568A13.9 13.9 0 0 1 14.798 11H9.202A13.9 13.9 0 0 1 12 3.568M14.244 3.282a9.01 9.01 0 0 1 6.7 7.718h-4.14a15.9 15.9 0 0 0-2.56-7.718" />
        </g>
      </svg>
    ))
);
GlobeIconFillDuotone.displayName = "GlobeIconFillDuotone";
export { GlobeIconFillDuotone };
