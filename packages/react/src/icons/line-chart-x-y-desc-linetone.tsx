  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M6.411 6.193a1 1 0 0 1 1.397.218l4.147 5.687 3.56-1.973a1 1 0 0 1 1.254.235l5 6a1.001 1.001 0 0 1-1.537 1.28l-4.471-5.364-3.61 1.999a1 1 0 0 1-1.292-.286l-4.666-6.4a1 1 0 0 1 .218-1.396"
        />
      </svg>
    ))
);
