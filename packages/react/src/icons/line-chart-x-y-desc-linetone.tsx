  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M5.324 6.263a1 1 0 0 1 1.413.061l4.828 5.267 2.468-2.234.077-.063a1 1 0 0 1 1.338.136l5.296 5.902a1 1 0 0 1-1.488 1.336l-4.625-5.154-2.46 2.227a1 1 0 0 1-1.408-.065l-5.5-6a1 1 0 0 1 .061-1.413"
        />
      </svg>
    ))
);
