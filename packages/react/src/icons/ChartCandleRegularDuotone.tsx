...
const ChartCandleRegularDuotone = memo(
  forwardRef<SVGSVGElement, ChartCandleRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.75 22a.75.75 0 0 1-1.5 0v-2.25h1.5zM17.75 20a.75.75 0 0 1-1.5 0v-2.25h1.5zM17 3.25c.41 0 .75.34.75.75v2.25h-1.5V4c0-.41.34-.75.75-.75M7 1.25c.41 0 .75.34.75.75v2.25h-1.5V2c0-.41.34-.75.75-.75" />
...
export { ChartCandleRegularDuotone };
