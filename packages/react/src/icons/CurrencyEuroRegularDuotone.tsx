...
const CurrencyEuroRegularDuotone = memo(
  forwardRef<SVGSVGElement, CurrencyEuroRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M7.29 13.25a17 17 0 0 0 .15 1.5H4a.75.75 0 0 1 0-1.5zM16 13.25a.75.75 0 0 1 0 1.5H8.95q-.11-.69-.16-1.5zM7.44 9.25a17 17 0 0 0-.15 1.5H4a.75.75 0 0 1 0-1.5zM16 9.25a.75.75 0 0 1 0 1.5H8.79q.05-.81.16-1.5z" />
...
export { CurrencyEuroRegularDuotone };
