  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M11.94 2.147c.945-.944 2.56-.275 2.56 1.06v4.794a1 1 0 0 1-2 0V4.415l-7.409 7.41a.25.25 0 0 0 0 .353l7.41 7.409V16a1 1 0 0 1 2 0v4.793c0 1.336-1.616 2.005-2.561 1.06l-8.263-8.262a2.25 2.25 0 0 1 0-3.182z"
        />
      </svg>
    ))
);
