...
const ChevronFullSquareDownIconBoldDuotone = memo(
...
ChevronFullSquareDownIconBoldDuotone.displayName =
  "ChevronFullSquareDownIconBoldDuotone";
export { ChevronFullSquareDownIconBoldDuotone };
