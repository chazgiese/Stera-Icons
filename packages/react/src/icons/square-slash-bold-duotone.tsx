...
const SquareSlashIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M19.444 18.03a4 4 0 0 1-1.414 1.414L4.555 5.97a4 4 0 0 1 1.414-1.414z"
          opacity={0.4}
        />
        <path
          fill="currentColor"
...
SquareSlashIconBoldDuotone.displayName = "SquareSlashIconBoldDuotone";
export { SquareSlashIconBoldDuotone };
