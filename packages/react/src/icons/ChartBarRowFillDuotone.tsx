...
const ChartBarRowFillDuotone = memo(
  forwardRef<SVGSVGElement, ChartBarRowFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} {...props}>
      <path d="M16.75 16c.69 0 1.25.56 1.25 1.25v2.5c0 .69-.56 1.25-1.25 1.25H5v-5zM12.75 9.5c.69 0 1.25.56 1.25 1.25v2.5c0 .69-.56 1.25-1.25 1.25H5v-5zM20.75 3c.69 0 1.25.56 1.25 1.25v2.5C22 7.44 21.44 8 20.75 8H5V3z" opacity={0.4} />
