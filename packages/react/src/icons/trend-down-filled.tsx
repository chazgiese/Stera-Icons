  ...
  IconProps >
    ((
      ...
      >
        <path
          fill="currentColor"
          d="M.793 4.293a1 1 0 0 1 1.414 0L9.5 11.586l2.793-2.793a1 1 0 0 1 1.414 0l5.793 5.793 2.293-2.293A1 1 0 0 1 23.5 13v6q-.001.125-.031.24l-.013.05a1 1 0 0 1-.125.264 1 1 0 0 1-.54.402l-.05.013-.047.011-.022.003Q22.588 20 22.5 20h-6a1 1 0 0 1-.707-1.707L18.086 16 13 10.914l-2.793 2.793a1 1 0 0 1-1.34.066l-.074-.066-8-8a1 1 0 0 1 0-1.414"
        />
      </svg>
    ))
);
