...
const SparkleSquareIconBoldDuotone = memo(
  ...
  IconProps >
    ((
      ...
      >
        ...
        <path
          fill="currentColor"
          d="M11.732 6.537a.3.3 0 0 1 .536 0l1.136 2.27a4 4 0 0 0 1.789 1.79l2.27 1.135a.3.3 0 0 1 0 .536l-2.27 1.136a4 4 0 0 0-1.79 1.789l-1.135 2.27a.3.3 0 0 1-.536 0l-1.136-2.27a4 4 0 0 0-1.789-1.79l-2.27-1.135a.3.3 0 0 1 0-.536l2.27-1.136a4 4 0 0 0 1.79-1.789z"
        />
      </svg>
    ))
);
SparkleSquareIconBoldDuotone.displayName = "SparkleSquareIconBoldDuotone";
export { SparkleSquareIconBoldDuotone };
