...
const AlignHorizontalCenterIconFilled = memo(
...
AlignHorizontalCenterIconFilled.displayName = "AlignHorizontalCenterIconFilled";
export { AlignHorizontalCenterIconFilled };
