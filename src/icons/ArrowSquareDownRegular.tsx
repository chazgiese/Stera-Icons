...
type ArrowSquareDownRegularProps = Omit<IconBaseProps, 'children'>;

const ArrowSquareDownRegular = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-down" {...props}>
