...
type XSquareRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const XSquareRegularDuotone = memo(
  forwardRef<SVGSVGElement, XSquareRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="x-square-duotone" {...props}>
