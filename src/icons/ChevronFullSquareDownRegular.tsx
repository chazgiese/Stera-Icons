...
type ChevronFullSquareDownRegularProps = Omit<IconBaseProps, 'children'>;

const ChevronFullSquareDownRegular = memo(
  forwardRef<SVGSVGElement, ChevronFullSquareDownRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-full-square-down" {...props}>
      <path fill="currentColor" d="M14.99 9.5a1 1 0 0 1 .79 1.61l-3 3.85a1 1 0 0 1-1.57 0L8.22 11.1a1 1 0 0 1 .8-1.61z" />
