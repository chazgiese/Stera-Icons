...
type PhoneIncomingBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const PhoneIncomingBoldDuotone = memo(
  forwardRef<SVGSVGElement, PhoneIncomingBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="phone-incoming-bold-duotone" {...props}>
