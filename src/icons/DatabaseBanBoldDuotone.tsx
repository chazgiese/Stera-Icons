...
type DatabaseBanBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const DatabaseBanBoldDuotone = memo(
  forwardRef<SVGSVGElement, DatabaseBanBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-ban-bold-duotone" {...props}>
