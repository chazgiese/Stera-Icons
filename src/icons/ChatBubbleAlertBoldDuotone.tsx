...
type ChatBubbleAlertBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const ChatBubbleAlertBoldDuotone = memo(
  forwardRef<SVGSVGElement, ChatBubbleAlertBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-bubble-alert-bold-duotone" {...props}>
...
ChatBubbleAlertBoldDuotone.displayName = 'ChatBubbleAlertBoldDuotone';

// Triple export pattern (lucide-react style)
export { ChatBubbleAlertBoldDuotone, ChatBubbleAlertBoldDuotone as ChatBubbleAlertBoldDuotoneIcon, ChatBubbleAlertBoldDuotone as SiChatBubbleAlertBoldDuotone };
export default ChatBubbleAlertBoldDuotone;
export type { ChatBubbleAlertBoldDuotoneProps };
