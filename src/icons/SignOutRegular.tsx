...
type SignOutRegularProps = Omit<IconBaseProps, 'children'>;

const SignOutRegular = memo(
  forwardRef<SVGSVGElement, SignOutRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="sign-out" {...props}>
