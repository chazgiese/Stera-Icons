...
type XSquareRegularProps = Omit<IconBaseProps, 'children'>;

const XSquareRegular = memo(
  forwardRef<SVGSVGElement, XSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="x-square" {...props}>
