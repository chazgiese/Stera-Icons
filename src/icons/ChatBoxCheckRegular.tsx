...
const ChatBoxCheckRegular = memo(
  forwardRef<SVGSVGElement, ChatBoxCheckRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-check" {...props}>
      <path fill="currentColor" d="M14.49 8.45a.75.75 0 0 1 1.02 1.1l-3.62 3.4-.31.28q-.16.15-.47.24-.4.1-.8-.06-.29-.14-.43-.3l-.26-.32-1.2-1.5a.75.75 0 1 1 1.17-.94l1.2 1.5q0 .02.03.05l.04-.04z" />
