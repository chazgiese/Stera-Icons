...
const ChartBarXYBold = memo(
  forwardRef<SVGSVGElement, ChartBarXYBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-bar-x-y-bold" {...props}>
      <path fill="currentColor" d="M3 4a1 1 0 0 1 1 1v12l.03.87q.04.06.1.1l.13.02L5 18h16a1 1 0 1 1 0 2H5q-.5 0-.9-.02a2 2 0 0 1-.87-.23 2.3 2.3 0 0 1-.98-.98c-.16-.3-.2-.6-.23-.87Q2 17.5 2 17V5a1 1 0 0 1 1-1" />
