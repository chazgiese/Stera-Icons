...
const ArrowSquareLeftRegular = memo(
  forwardRef<SVGSVGElement, ArrowSquareLeftRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-left" {...props}>
      <path fill="currentColor" d="M11.47 7.47a.75.75 0 1 1 1.06 1.06l-2.72 2.72H16a.75.75 0 0 1 0 1.5H9.81l2.72 2.72a.75.75 0 1 1-1.06 1.06l-4-4a.75.75 0 0 1 0-1.06z" />
