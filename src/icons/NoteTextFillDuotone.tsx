...
const NoteTextFillDuotone = memo(
  forwardRef<SVGSVGElement, NoteTextFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="note-text-fill-duotone" {...props}>
      <path fillRule="evenodd" d="M13.6 5c1.14 0 1.93 0 2.55.05.6.05.95.14 1.21.28a3 3 0 0 1 1.31 1.3c.14.27.23.62.28 1.22.05.62.05 1.41.05 2.55V12h-2.8q-.81 0-1.4.03c-.4.03-.78.1-1.16.3a3 3 0 0 0-1.31 1.3c-.2.39-.27.78-.3 1.17q-.04.59-.03 1.4V19h-1.6c-1.14 0-1.93 0-2.55-.05a3 3 0 0 1-1.21-.28 3 3 0 0 1-1.31-1.3 3 3 0 0 1-.28-1.22C5 15.53 5 14.74 5 13.6v-3.2c0-1.14 0-1.93.05-2.55.05-.6.14-.95.28-1.21a3 3 0 0 1 1.3-1.31 3 3 0 0 1 1.22-.28C8.47 5 9.26 5 10.4 5zm-5.1 5.13a.88.88 0 0 0 0 1.74H11a.88.88 0 0 0 0-1.74zm0-3a.87.87 0 1 0 0 1.75h7a.88.88 0 0 0 0-1.76z" clipRule="evenodd" opacity={0.4} />
        ...
        <path fill="currentColor" d="M11 10.13a.88.88 0 0 1 0 1.74H8.5a.88.88 0 0 1 0-1.74zM15.5 7.13a.88.88 0 0 1 0 1.75h-7a.87.87 0 1 1 0-1.76z" />
