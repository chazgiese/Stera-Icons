...
const HeartFillDuotone = memo(
  forwardRef<SVGSVGElement, HeartFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="heart-fill-duotone" {...props}>
      <path fill="currentColor" d="M16.29 5.25A3.73 3.73 0 0 1 20 9a6.6 6.6 0 0 1-1.36 3.71c-1.87 2.63-4.38 4.48-6.64 6.27-2.26-1.79-4.77-3.64-6.64-6.27A6.6 6.6 0 0 1 4 9a3.71 3.71 0 0 1 7.09-1.56 1 1 0 0 0 1.82 0 3.7 3.7 0 0 1 3.38-2.19" opacity={.4} />
