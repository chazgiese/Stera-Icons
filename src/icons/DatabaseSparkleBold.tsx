...
type DatabaseSparkleBoldProps = Omit<IconBaseProps, 'children'>;

const DatabaseSparkleBold = memo(
  forwardRef<SVGSVGElement, DatabaseSparkleBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-sparkle-bold" {...props}>
