...
const Clock9Fill = memo(
  forwardRef<SVGSVGElement, Clock9FillProps>((props, ref) => (
    <IconBase ref={ref} iconName="clock-9-fill" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20m0 4a1 1 0 0 0-1 1v4H8a1 1 0 1 0 0 2h4a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1" clipRule="evenodd" />
    </IconBase>
  ))
);
