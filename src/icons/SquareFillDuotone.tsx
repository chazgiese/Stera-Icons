...
const SquareFillDuotone = memo(
  forwardRef<SVGSVGElement, SquareFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="square-fill-duotone" {...props}>
      <path fill="currentColor" d="M13.6 5c1.14 0 1.93 0 2.55.05.6.05.95.14 1.21.28a3 3 0 0 1 1.31 1.3c.14.27.23.62.28 1.22.05.62.05 1.41.05 2.55v3.2c0 1.14 0 1.93-.05 2.55-.05.6-.14.95-.28 1.21a3 3 0 0 1-1.3 1.31 3 3 0 0 1-1.22.28c-.62.05-1.41.05-2.55.05h-3.2c-1.14 0-1.93 0-2.55-.05a3 3 0 0 1-1.21-.28 3 3 0 0 1-1.31-1.3 3 3 0 0 1-.28-1.22C5 15.53 5 14.74 5 13.6v-3.2c0-1.14 0-1.93.05-2.55.05-.6.14-.95.28-1.21a3 3 0 0 1 1.3-1.31 3 3 0 0 1 1.22-.28C8.47 5 9.26 5 10.4 5z" opacity={.4} />
