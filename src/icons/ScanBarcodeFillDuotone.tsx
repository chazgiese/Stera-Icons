...
const ScanBarcodeFillDuotone = memo(
  forwardRef<SVGSVGElement, ScanBarcodeFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="scan-barcode-fill-duotone" {...props}>
      <path d="M2 13.5c.83 0 1.5.67 1.5 1.5v3c0 .28.22.5.5.5h3a1.5 1.5 0 0 1 0 3H4A3.5 3.5 0 0 1 .5 18v-3c0-.83.67-1.5 1.5-1.5M22 13.5c.83 0 1.5.67 1.5 1.5v3a3.5 3.5 0 0 1-3.5 3.5h-3a1.5 1.5 0 0 1 0-3h3a.5.5 0 0 0 .5-.5v-3c0-.83.67-1.5 1.5-1.5M7 2.5a1.5 1.5 0 1 1 0 3H4a.5.5 0 0 0-.5.5v3a1.5 1.5 0 1 1-3 0V6A3.5 3.5 0 0 1 4 2.5zM20 2.5A3.5 3.5 0 0 1 23.5 6v3a1.5 1.5 0 0 1-3 0V6a.5.5 0 0 0-.5-.5h-3a1.5 1.5 0 0 1 0-3z" opacity={0.4} />
