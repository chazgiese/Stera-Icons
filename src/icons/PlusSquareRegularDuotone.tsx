...
type PlusSquareRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const PlusSquareRegularDuotone = memo(
  forwardRef<SVGSVGElement, PlusSquareRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="plus-square-duotone" {...props}>
