...
type DeviceTabletBoldProps = Omit<IconBaseProps, 'children'>;

const DeviceTabletBold = memo(
  forwardRef<SVGSVGElement, DeviceTabletBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="device-tablet-bold" {...props}>
