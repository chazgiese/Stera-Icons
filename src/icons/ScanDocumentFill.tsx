...
const ScanDocumentFill = memo(
  forwardRef<SVGSVGElement, ScanDocumentFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="scan-document-fill" {...props}>
