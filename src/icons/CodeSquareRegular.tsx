...
const CodeSquareRegular = memo(
  forwardRef<SVGSVGElement, CodeSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="code-square" {...props}>
      <path fill="currentColor" d="M12.27 7.82a.75.75 0 0 1 1.46.36l-2 8a.75.75 0 1 1-1.46-.36zM8.47 9.47a.75.75 0 1 1 1.06 1.06L8.06 12l1.47 1.47a.75.75 0 1 1-1.06 1.06l-2-2a.75.75 0 0 1 0-1.06zM14.47 9.47c.3-.3.77-.3 1.06 0l2 2a.75.75 0 0 1 0 1.06l-2 2a.75.75 0 1 1-1.06-1.06L15.94 12l-1.47-1.47a.75.75 0 0 1 0-1.06" />
