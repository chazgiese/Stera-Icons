...
type PhoneRegularProps = Omit<IconBaseProps, 'children'>;

const PhoneRegular = memo(
  forwardRef<SVGSVGElement, PhoneRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="phone" {...props}>
