...
type CylinderRegularProps = Omit<IconBaseProps, 'children'>;

const CylinderRegular = memo(
  forwardRef<SVGSVGElement, CylinderRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="cylinder" {...props}>
