...
type AudioBarsSquareRegularProps = Omit<IconBaseProps, 'children'>;

const AudioBarsSquareRegular = memo(
  forwardRef<SVGSVGElement, AudioBarsSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="audio-bars-square" {...props}>
