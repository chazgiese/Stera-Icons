...
type ChatBoxTextRegularProps = Omit<IconBaseProps, 'children'>;

const ChatBoxTextRegular = memo(
  forwardRef<SVGSVGElement, ChatBoxTextRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-text" {...props}>
...
ChatBoxTextRegular.displayName = 'ChatBoxTextRegular';
