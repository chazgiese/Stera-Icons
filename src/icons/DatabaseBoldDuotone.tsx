...
const DatabaseBoldDuotone = memo(
  forwardRef<SVGSVGElement, DatabaseBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-bold-duotone" {...props}>
      <path fill="currentColor" d="M6 11.7q0 0 .03.08t.2.23q.33.33 1.18.67c1.13.43 2.75.72 4.59.72s3.46-.29 4.59-.72q.85-.34 1.19-.67.15-.15.2-.23l.02-.08v2.54q-.33.16-.69.3c-1.4.55-3.29.86-5.31.86s-3.9-.31-5.31-.86q-.36-.14-.69-.3z" opacity={.4} />
