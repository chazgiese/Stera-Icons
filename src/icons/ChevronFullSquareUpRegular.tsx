...
type ChevronFullSquareUpRegularProps = Omit<IconBaseProps, 'children'>;

const ChevronFullSquareUpRegular = memo(
  forwardRef<SVGSVGElement, ChevronFullSquareUpRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-full-square-up" {...props}>
