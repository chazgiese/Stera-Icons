...
type ArrowSquareDownBoldProps = Omit<IconBaseProps, 'children'>;

const ArrowSquareDownBold = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-down-bold" {...props}>
