...
const TestTubeFullFillDuotone = memo(
  forwardRef<SVGSVGElement, TestTubeFullFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="test-tube-full-fill-duotone" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M16 4a.5.5 0 0 0-.5.5v14a3.5 3.5 0 1 1-7 0v-14A.5.5 0 0 0 8 4zm-5 4.5a1 1 0 0 0-1 1v9a2 2 0 1 0 4 0v-9a1 1 0 0 0-1-1z" clipRule="evenodd" opacity={.4} />
        <path fill="currentColor" d="M13 8.5a1 1 0 0 1 1 1v9a2 2 0 1 1-4 0v-9a1 1 0 0 1 1-1zM16 2a1 1 0 1 1 0 2H8a1 1 0 0 1 0-2z" />
    </IconBase>
  ))
);
