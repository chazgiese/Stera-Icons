...
const UmbrellaBoldDuotone = memo(
  forwardRef<SVGSVGElement, UmbrellaBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="umbrella-bold-duotone" {...props}>
      <path d="M12 12.5q.48 0 1 .13v6.87a1.5 1.5 0 0 0 3 0V19a1 1 0 1 1 2 0v.5a3.5 3.5 0 1 1-7 0v-6.87a4 4 0 0 1 1-.13M12 1a1 1 0 0 1 1 1v1.05a10 10 0 0 0-2 0V2a1 1 0 0 1 1-1" opacity={0.4} />
