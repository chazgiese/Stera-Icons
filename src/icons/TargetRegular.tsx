  ...
  forwardRef<SVGSVGElement, TargetRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="target" {...props}>
      <path fill="currentColor" d="M12 9.63a2.37 2.37 0 1 1 0 4.74 2.37 2.37 0 0 1 0-4.74" />
        <path fill="currentColor" fillRule="evenodd" d="M12 5.75a6.25 6.25 0 1 1 0 12.5 6.25 6.25 0 0 1 0-12.5m0 1.5a4.75 4.75 0 1 0 0 9.5 4.75 4.75 0 0 0 0-9.5" clipRule="evenodd" />
