...
type KeyAltRegularProps = Omit<IconBaseProps, 'children'>;

const KeyAltRegular = memo(
  forwardRef<SVGSVGElement, KeyAltRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="key-alt" {...props}>
