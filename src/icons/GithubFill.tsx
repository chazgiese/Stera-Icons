...
type GithubFillProps = Omit<IconBaseProps, 'children'>;

const GithubFill = memo(
  forwardRef<SVGSVGElement, GithubFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="github-fill" {...props}>
