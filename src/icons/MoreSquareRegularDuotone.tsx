...
type MoreSquareRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const MoreSquareRegularDuotone = memo(
  forwardRef<SVGSVGElement, MoreSquareRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="more-square-duotone" {...props}>
