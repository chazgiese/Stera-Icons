...
const CurveEaseRegularDuotone = memo(
  forwardRef<SVGSVGElement, CurveEaseRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="curve-ease-duotone" {...props}>
      <path d="M10.94 18.25a.75.75 0 0 1 0 1.5h-.44a.75.75 0 0 1 0-1.5zM14 18.25a.75.75 0 0 1 0 1.5h-.44a.75.75 0 0 1 0-1.5zM10.44 4.25a.75.75 0 0 1 0 1.5H10a.75.75 0 0 1 0-1.5zM13.5 4.25a.75.75 0 0 1 0 1.5h-.44a.75.75 0 0 1 0-1.5z" opacity={0.4} />
