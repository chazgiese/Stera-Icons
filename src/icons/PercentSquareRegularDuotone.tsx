...
type PercentSquareRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const PercentSquareRegularDuotone = memo(
  forwardRef<SVGSVGElement, PercentSquareRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="percent-square-duotone" {...props}>
