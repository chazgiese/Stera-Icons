...
const GaugeDots85PercentRegular = memo(
  forwardRef<SVGSVGElement, GaugeDots85PercentRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="gauge-dots-85-percent" {...props}>
      <path fill="currentColor" d="M7.23 15A1.25 1.25 0 1 1 9 16.77 1.25 1.25 0 0 1 7.23 15M15 15a1.25 1.25 0 1 1 1.77 1.77A1.25 1.25 0 0 1 15 15M12.06 10.25c.5.04 2.05.3 3.41.54l2.44.43.17.03.05.01a.75.75 0 0 1 0 1.48h-.05l-.17.04-2.44.43a61 61 0 0 1-3.47.54 1.75 1.75 0 1 1 .06-3.5M6.5 10.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M7.23 7.23A1.25 1.25 0 1 1 8.99 9a1.25 1.25 0 0 1-1.76-1.77M15 7.23A1.25 1.25 0 1 1 16.77 9 1.25 1.25 0 0 1 15 7.23M12 5.25a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5" />
...
export default GaugeDots85PercentRegular;
