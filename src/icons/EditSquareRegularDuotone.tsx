...
const EditSquareRegularDuotone = memo(
  forwardRef<SVGSVGElement, EditSquareRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="edit-square-duotone" {...props}>
      <path fill="currentColor" d="M11 2.25a.75.75 0 0 1 0 1.5H8A4.25 4.25 0 0 0 3.75 8v8c0 2.35 1.9 4.25 4.25 4.25h8c2.35 0 4.25-1.9 4.25-4.25v-3a.75.75 0 0 1 1.5 0v3A5.75 5.75 0 0 1 16 21.75H8A5.75 5.75 0 0 1 2.25 16V8A5.75 5.75 0 0 1 8 2.25z" opacity={.4} />
