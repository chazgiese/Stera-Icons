...
type AudioBarsSquareBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const AudioBarsSquareBoldDuotone = memo(
  forwardRef<SVGSVGElement, AudioBarsSquareBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="audio-bars-square-bold-duotone" {...props}>
