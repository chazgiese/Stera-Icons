...
type PlusSquareBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const PlusSquareBoldDuotone = memo(
  forwardRef<SVGSVGElement, PlusSquareBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="plus-square-bold-duotone" {...props}>
