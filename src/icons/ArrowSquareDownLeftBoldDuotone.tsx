...
type ArrowSquareDownLeftBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const ArrowSquareDownLeftBoldDuotone = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownLeftBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-down-left-bold-duotone" {...props}>
