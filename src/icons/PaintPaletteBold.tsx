...
type PaintPaletteBoldProps = Omit<IconBaseProps, 'children'>;

const PaintPaletteBold = memo(
  forwardRef<SVGSVGElement, PaintPaletteBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="paint-palette-bold" {...props}>
