...
const NodeMapRegularDuotone = memo(
  forwardRef<SVGSVGElement, NodeMapRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="node-map-duotone" {...props}>
      <path d="M9.27 13.24a3 3 0 0 0 .94 1.16l-3.23 2.61a3 3 0 0 0-.94-1.17zM16.51 14.8a3 3 0 0 0-.97 1.16l-1.8-1.52a3 3 0 0 0 .96-1.15zM16.25 9.9q.05.78.45 1.43l-1.7.52a3 3 0 0 0-.45-1.43zM10.94 9.2a3 3 0 0 0-1.23.86l-1.4-2a3 3 0 0 0 1.22-.87z" opacity={0.4} />
