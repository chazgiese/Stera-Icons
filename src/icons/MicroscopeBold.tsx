...
const MicroscopeBold = memo(
  forwardRef<SVGSVGElement, MicroscopeBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="microscope-bold" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M16 1a4 4 0 0 1 4 4v5.75c0 1.16-.88 2.11-2 2.24V13a2 2 0 1 1-4 0v-.01a2.25 2.25 0 0 1-2-2.24V8h-.5a6.5 6.5 0 1 0 0 13H20a1 1 0 1 1 0 2H4a1 1 0 1 1 0-2h2.03A8.5 8.5 0 0 1 11.5 6h.5V5a4 4 0 0 1 4-4m0 2a2 2 0 0 0-2 2v5.75q.02.23.25.25h3.5q.23-.02.25-.25V5a2 2 0 0 0-2-2" clipRule="evenodd" />
