...
type HomePlusRegularProps = Omit<IconBaseProps, 'children'>;

const HomePlusRegular = memo(
  forwardRef<SVGSVGElement, HomePlusRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="home-plus" {...props}>
