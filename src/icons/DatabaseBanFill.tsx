...
const DatabaseBanFill = memo(
  forwardRef<SVGSVGElement, DatabaseBanFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-ban-fill" {...props}>
      <path fill="currentColor" d="M4 13.58q.57.37 1.23.66c1.26.56 2.83.96 4.55 1.14q-.03.3-.03.62a6.25 6.25 0 0 0 4.18 5.9Q13 22 12 22c-2.02 0-3.9-.31-5.31-.86a6 6 0 0 1-1.81-1.05A2.4 2.4 0 0 1 4 18.3z" />
