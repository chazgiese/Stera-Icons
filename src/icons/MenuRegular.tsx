...
const MenuRegular = memo(
  forwardRef<SVGSVGElement, MenuRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="menu" {...props}>
      <path fill="currentColor" d="M20 17.25a.75.75 0 0 1 0 1.5H4a.75.75 0 0 1 0-1.5zM20 11.25a.75.75 0 0 1 0 1.5H4a.75.75 0 0 1 0-1.5zM20 5.25a.75.75 0 0 1 0 1.5H4a.75.75 0 0 1 0-1.5z" />
    </IconBase>
  ))
);
