...
type ChevronSquareUpRegularProps = Omit<IconBaseProps, 'children'>;

const ChevronSquareUpRegular = memo(
  forwardRef<SVGSVGElement, ChevronSquareUpRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-square-up" {...props}>
      <path fill="currentColor" d="M12 8.75q.31 0 .53.22l4 4a.75.75 0 1 1-1.06 1.06L12 10.56l-3.47 3.47a.75.75 0 1 1-1.06-1.06l4-4a.8.8 0 0 1 .53-.22" />
