...
type SearchSquareBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const SearchSquareBoldDuotone = memo(
  forwardRef<SVGSVGElement, SearchSquareBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="search-square-bold-duotone" {...props}>
