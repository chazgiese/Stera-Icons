...
type SkipForwardBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const SkipForwardBoldDuotone = memo(
  forwardRef<SVGSVGElement, SkipForwardBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="skip-forward-bold-duotone" {...props}>
