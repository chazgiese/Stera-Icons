...
const StopwatchBoldDuotone = memo(
  forwardRef<SVGSVGElement, StopwatchBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="stopwatch-bold-duotone" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 4.5a8.5 8.5 0 1 1 0 17 8.5 8.5 0 0 1 0-17m0 2a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13" clipRule="evenodd" opacity={.4} />
