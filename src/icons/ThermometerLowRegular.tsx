...
const ThermometerLowRegular = memo(
  forwardRef<SVGSVGElement, ThermometerLowRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="thermometer-low" {...props}>
      <path fill="currentColor" d="M12 11.25c.41 0 .75.34.75.75v1.11c0 .75.5 1.36 1 1.78a2.75 2.75 0 1 1-3.52 0c.52-.42 1.02-1.03 1.02-1.78V12c0-.41.34-.75.75-.75" />
