...
type HomePlusBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const HomePlusBoldDuotone = memo(
  forwardRef<SVGSVGElement, HomePlusBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="home-plus-bold-duotone" {...props}>
