...
type AlertSquareRegularProps = Omit<IconBaseProps, 'children'>;

const AlertSquareRegular = memo(
  forwardRef<SVGSVGElement, AlertSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="alert-square" {...props}>
