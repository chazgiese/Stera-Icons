...
const MacWindowCursorFill = memo(
  forwardRef<SVGSVGElement, MacWindowCursorFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="mac-window-cursor-fill" {...props}>
      <path fill="currentColor" d="m14.98 11.4.2.05 6.76 2.25a1.37 1.37 0 0 1-.05 2.61l-2.77.81-.81 2.77a1.37 1.37 0 0 1-2.6.05l-2.26-6.76c-.34-1 .53-1.96 1.53-1.79" />
