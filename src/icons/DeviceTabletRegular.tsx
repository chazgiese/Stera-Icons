...
type DeviceTabletRegularProps = Omit<IconBaseProps, 'children'>;

const DeviceTabletRegular = memo(
  forwardRef<SVGSVGElement, DeviceTabletRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="device-tablet" {...props}>
      <path fill="currentColor" d="M12 16a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3" />
