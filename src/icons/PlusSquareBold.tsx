...
type PlusSquareBoldProps = Omit<IconBaseProps, 'children'>;

const PlusSquareBold = memo(
  forwardRef<SVGSVGElement, PlusSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="plus-square-bold" {...props}>
