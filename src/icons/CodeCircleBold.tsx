...
const CodeCircleBold = memo(
  forwardRef<SVGSVGElement, CodeCircleBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="code-circle-bold" {...props}>
      <path fill="currentColor" d="M12.03 7.76a1 1 0 1 1 1.94.48l-2 8a1 1 0 1 1-1.94-.48zM7.8 9.3a1 1 0 1 1 1.4 1.4L7.92 12l1.3 1.3a1 1 0 1 1-1.42 1.4l-2-2a1 1 0 0 1 0-1.4zM14.8 9.3a1 1 0 0 1 1.4 0l2 2a1 1 0 0 1 0 1.4l-2 2a1 1 0 1 1-1.4-1.4l1.29-1.3-1.3-1.3a1 1 0 0 1 0-1.4" />
