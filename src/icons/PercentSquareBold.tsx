...
type PercentSquareBoldProps = Omit<IconBaseProps, 'children'>;

const PercentSquareBold = memo(
  forwardRef<SVGSVGElement, PercentSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="percent-square-bold" {...props}>
