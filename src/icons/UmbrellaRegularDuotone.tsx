...
const UmbrellaRegularDuotone = memo(
  forwardRef<SVGSVGElement, UmbrellaRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="umbrella-duotone" {...props}>
      <path d="M12 12.25q.37 0 .75.07v7.18a1.75 1.75 0 1 0 3.5 0V19a.75.75 0 0 1 1.5 0v.5a3.25 3.25 0 0 1-6.5 0v-7.18q.39-.06.75-.07M12 1.25c.41 0 .75.34.75.75v1.28a10 10 0 0 0-1.5 0V2c0-.41.34-.75.75-.75" opacity={0.4} />
