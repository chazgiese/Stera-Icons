...
const RotationLeftRegularDuotone = memo(
  forwardRef<SVGSVGElement, RotationLeftRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="rotation-left-duotone" {...props}>
      <path d="M5.81 5.81a.75.75 0 0 1 1.06 1.06A7.25 7.25 0 0 0 12 19.25h1.19l.75.75-.75.75H12A8.75 8.75 0 0 1 5.81 5.81M12.32 3.26a8.75 8.75 0 0 1 5.87 14.93.75.75 0 0 1-1.06-1.06 7.25 7.25 0 0 0-4.86-12.38H10.8L10.06 4l.75-.75h1.51" opacity={0.4} />
