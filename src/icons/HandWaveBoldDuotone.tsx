...
const HandWaveBoldDuotone = memo(
  forwardRef<SVGSVGElement, HandWaveBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="hand-wave-bold-duotone" {...props}>
      <path d="M2.63 16.07a1 1 0 0 1 1.3.56c.3.74 1.27 2.52 2.67 3.57a1 1 0 1 1-1.2 1.6 11.4 11.4 0 0 1-3.33-4.43 1 1 0 0 1 .56-1.3M19.5 1.5c1.35 0 2.47.67 3.24 1.51A4.6 4.6 0 0 1 24 6a1 1 0 0 1-2 0c0-.45-.24-1.1-.74-1.64a2.4 2.4 0 0 0-1.76-.86 1 1 0 0 1 0-2" opacity={0.4} />
