...
const ChartBarRowAscFillDuotone = memo(
  forwardRef<SVGSVGElement, ChartBarRowAscFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-bar-row-asc-fill-duotone" {...props}>
      <path d="M19.75 16c.69 0 1.25.56 1.25 1.25v2.5c0 .69-.56 1.25-1.25 1.25H5v-5zM15.75 9.5c.69 0 1.25.56 1.25 1.25v2.5c0 .69-.56 1.25-1.25 1.25H5v-5zM11.75 3c.69 0 1.25.56 1.25 1.25v2.5C13 7.44 12.44 8 11.75 8H5V3z" opacity={0.4} />
