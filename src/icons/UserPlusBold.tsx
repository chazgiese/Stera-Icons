...
type UserPlusBoldProps = Omit<IconBaseProps, 'children'>;

const UserPlusBold = memo(
  forwardRef<SVGSVGElement, UserPlusBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="user-plus-bold" {...props}>
