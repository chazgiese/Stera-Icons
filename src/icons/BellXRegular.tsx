...
const BellXRegular = memo(
  forwardRef<SVGSVGElement, BellXRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="bell-x" {...props}>
      <path fill="currentColor" d="M13.97 7.47a.75.75 0 0 1 1.06 1.06l-1.97 1.97 1.97 1.97a.75.75 0 0 1-1.06 1.06L12 11.56l-1.97 1.97a.75.75 0 0 1-1.06-1.06l1.97-1.97-1.97-1.97a.75.75 0 1 1 1.06-1.06L12 9.44z" />
