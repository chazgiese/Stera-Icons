...
type AudioBarsSquareBoldProps = Omit<IconBaseProps, 'children'>;

const AudioBarsSquareBold = memo(
  forwardRef<SVGSVGElement, AudioBarsSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="audio-bars-square-bold" {...props}>
