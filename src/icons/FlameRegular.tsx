...
const FlameRegular = memo(
  forwardRef<SVGSVGElement, FlameRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="flame" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 2.25h.11l.02.01.06.02.08.02.06.03.12.07.02.02h.01l.02.02.06.05a20 20 0 0 1 1.05.93A33 33 0 0 1 16.07 6a21 21 0 0 1 2.5 3.56 9 9 0 0 1 1.18 4.09c0 4.44-3.43 8.11-7.75 8.11s-7.75-3.67-7.75-8.11c0-1.4.5-2.8 1.18-4.09a21 21 0 0 1 2.5-3.56 33 33 0 0 1 3.5-3.5l.07-.05.02-.02.03-.02.12-.07.06-.03.08-.02.06-.02h.02zm-.02 10.3c-.3.3-.72.75-1.14 1.29-.85 1.1-1.59 2.42-1.59 3.66 0 1.03.4 1.69.91 2.1a3 3 0 0 0 3.68 0c.51-.41.91-1.07.91-2.1 0-1.24-.74-2.57-1.6-3.66a14 14 0 0 0-1.17-1.3m-.56-8.03c-.64.6-1.5 1.45-2.35 2.44-.85 1-1.7 2.13-2.32 3.3a7.4 7.4 0 0 0-1 3.38c0 1.99.83 3.76 2.12 4.96a5 5 0 0 1-.12-1.1c0-1.76 1.01-3.43 1.9-4.59a16 16 0 0 1 1.85-1.97h.01l.04-.04.12-.07.05-.03.09-.02.05-.02h.27l.06.02.08.02.06.03.12.07.04.03.01.01.16.14a14 14 0 0 1 1.68 1.83c.9 1.16 1.91 2.83 1.91 4.59q0 .6-.12 1.1a6.8 6.8 0 0 0 2.12-4.96c0-1.06-.38-2.21-1-3.38a19 19 0 0 0-2.32-3.3A31 31 0 0 0 12.01 4h-.02z" clipRule="evenodd" />
    </IconBase>
  ))
);
