...
type GithubRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const GithubRegularDuotone = memo(
  forwardRef<SVGSVGElement, GithubRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="github-duotone" {...props}>
...
GithubRegularDuotone.displayName = 'GithubRegularDuotone';
