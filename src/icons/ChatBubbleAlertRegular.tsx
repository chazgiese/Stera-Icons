...
type ChatBubbleAlertRegularProps = Omit<IconBaseProps, 'children'>;

const ChatBubbleAlertRegular = memo(
  forwardRef<SVGSVGElement, ChatBubbleAlertRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-bubble-alert" {...props}>
...
ChatBubbleAlertRegular.displayName = 'ChatBubbleAlertRegular';
