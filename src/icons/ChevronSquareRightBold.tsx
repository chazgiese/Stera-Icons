...
type ChevronSquareRightBoldProps = Omit<IconBaseProps, 'children'>;

const ChevronSquareRightBold = memo(
  forwardRef<SVGSVGElement, ChevronSquareRightBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-square-right-bold" {...props}>
      <path fill="currentColor" d="M9.8 7.3a1 1 0 0 1 1.4 0l4 4a1 1 0 0 1 0 1.4l-4 4a1 1 0 1 1-1.4-1.4l3.29-3.3-3.3-3.3a1 1 0 0 1 0-1.4" />
