...
const CylinderFillDuotone = memo(
  forwardRef<SVGSVGElement, CylinderFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="cylinder-fill-duotone" {...props}>
      <path fill="currentColor" d="M12 4c1.84 0 3.46.29 4.59.72q.85.34 1.19.67.15.15.2.23l.02.08q0 0-.03.08a1 1 0 0 1-.2.23q-.33.33-1.18.67c-1.13.43-2.75.72-4.59.72s-3.46-.29-4.59-.72A4 4 0 0 1 6.22 6a1 1 0 0 1-.2-.23L6 5.7q0 0 .03-.08a1 1 0 0 1 .2-.23q.33-.33 1.18-.67C8.54 4.3 10.16 4 12 4" opacity={.4} />
