...
const DeleteRegular = memo(
  forwardRef<SVGSVGElement, DeleteRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="delete" {...props}>
      <path fill="currentColor" d="M15.47 8.47a.75.75 0 0 1 1.06 1.06L14.06 12l2.47 2.47a.75.75 0 0 1-1.06 1.06L13 13.06l-2.47 2.47a.75.75 0 0 1-1.06-1.06L11.94 12 9.47 9.53a.75.75 0 1 1 1.06-1.06L13 10.94z" />
