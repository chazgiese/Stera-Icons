...
type ChatBubbleAlertBoldProps = Omit<IconBaseProps, 'children'>;

const ChatBubbleAlertBold = memo(
  forwardRef<SVGSVGElement, ChatBubbleAlertBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-bubble-alert-bold" {...props}>
...
ChatBubbleAlertBold.displayName = 'ChatBubbleAlertBold';

// Triple export pattern (lucide-react style)
export { ChatBubbleAlertBold, ChatBubbleAlertBold as ChatBubbleAlertBoldIcon, ChatBubbleAlertBold as SiChatBubbleAlertBold };
export default ChatBubbleAlertBold;
export type { ChatBubbleAlertBoldProps };
