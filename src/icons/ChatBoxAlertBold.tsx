...
type ChatBoxAlertBoldProps = Omit<IconBaseProps, 'children'>;

const ChatBoxAlertBold = memo(
  forwardRef<SVGSVGElement, ChatBoxAlertBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-alert-bold" {...props}>
