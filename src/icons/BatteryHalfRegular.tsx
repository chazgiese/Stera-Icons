...
const BatteryHalfRegular = memo(
  forwardRef<SVGSVGElement, BatteryHalfRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="battery-half" {...props}>
      <path fill="currentColor" d="M9.4 8.75q.4 0 .72.02.32 0 .67.17.5.27.77.77.17.35.17.67.02.3.02.72v1.8q0 .4-.02.72 0 .32-.17.67-.27.5-.77.77-.35.17-.67.17-.3.02-.72.02H6.6q-.4 0-.72-.02a2 2 0 0 1-.67-.17q-.5-.27-.77-.77a2 2 0 0 1-.17-.67q-.02-.3-.02-.72v-1.8q0-.4.02-.72 0-.32.17-.67.26-.5.77-.77.35-.17.67-.17.3-.02.72-.02z" />
