...
type BatteryHalfRegularProps = Omit<IconBaseProps, 'children'>;

const BatteryHalfRegular = memo(
  forwardRef<SVGSVGElement, BatteryHalfRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="battery-half" {...props}>
