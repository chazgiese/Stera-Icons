...
const CalendarPlusRegular = memo(
  forwardRef<SVGSVGElement, CalendarPlusRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="calendar-plus" {...props}>
      <path fill="currentColor" d="M12 12.25c.41 0 .75.34.75.75v1.75h1.75a.75.75 0 0 1 0 1.5h-1.75V18a.75.75 0 0 1-1.5 0v-1.75H9.5a.75.75 0 0 1 0-1.5h1.75V13c0-.41.34-.75.75-.75" />
