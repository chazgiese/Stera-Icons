...
const WrenchFillDuotone = memo(
  forwardRef<SVGSVGElement, WrenchFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="wrench-fill-duotone" {...props}>
      <path fill="currentColor" d="m14.84 4-2.39 2.4a1 1 0 0 0-.27.93l.72 3.03a1 1 0 0 0 .74.74l3.03.72a1 1 0 0 0 .93-.27l2.4-2.4a5.33 5.33 0 0 1-7.21 5.21 1 1 0 0 0-.95.14l-.1.1-4.93 4.92a1.65 1.65 0 0 1-2.33-2.33l4.93-4.92a1 1 0 0 0 .23-1.06 5.35 5.35 0 0 1 5.2-7.2" opacity={.4} />
