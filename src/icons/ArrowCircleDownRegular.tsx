...
type ArrowCircleDownRegularProps = Omit<IconBaseProps, 'children'>;

const ArrowCircleDownRegular = memo(
  forwardRef<SVGSVGElement, ArrowCircleDownRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-circle-down" {...props}>
