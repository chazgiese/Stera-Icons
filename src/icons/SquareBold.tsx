...
type SquareBoldProps = Omit<IconBaseProps, 'children'>;

const SquareBold = memo(
  forwardRef<SVGSVGElement, SquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="square-bold" {...props}>
