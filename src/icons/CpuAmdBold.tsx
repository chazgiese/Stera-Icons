...
type CpuAmdBoldProps = Omit<IconBaseProps, 'children'>;

const CpuAmdBold = memo(
  forwardRef<SVGSVGElement, CpuAmdBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="cpu-amd-bold" {...props}>
