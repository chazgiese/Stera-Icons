...
const BookOpenTextFill = memo(
  forwardRef<SVGSVGElement, BookOpenTextFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="book-open-text-fill" {...props}>
      <path fill="currentColor" d="M6.18 11.58a7 7 0 0 1 2.85.34.87.87 0 0 1-.56 1.66c-.6-.2-1.31-.32-2.15-.25a.88.88 0 0 1-.14-1.75M6.18 8.4a7 7 0 0 1 2.85.34.88.88 0 0 1-.56 1.65c-.6-.2-1.31-.31-2.15-.25a.87.87 0 0 1-.14-1.74" />
