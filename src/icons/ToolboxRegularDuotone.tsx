  ...
  forwardRef<SVGSVGElement, ToolboxRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="toolbox-duotone" {...props}>
      <path d="M15.25 12.25v1.5h-6.5v-1.5z" opacity={0.4} />
        ...
        <path fill="currentColor" d="M8 10.75c.41 0 .75.34.75.75v3a.75.75 0 0 1-1.5 0v-3c0-.41.34-.75.75-.75M16 10.75c.41 0 .75.34.75.75v3a.75.75 0 0 1-1.5 0v-3c0-.41.34-.75.75-.75M14.42 2.75a2 2 0 0 1 1.98 1.72l.25 1.78h-1.51l-.23-1.57a.5.5 0 0 0-.5-.43H9.59a.5.5 0 0 0-.5.43l-.22 1.57H7.35l.25-1.78a2 2 0 0 1 1.98-1.72z" />
    </IconBase>
  ))
);
