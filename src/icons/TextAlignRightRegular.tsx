...
const TextAlignRightRegular = memo(
  forwardRef<SVGSVGElement, TextAlignRightRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="text-align-right" {...props}>
      <path fill="currentColor" d="M21 17.25a.75.75 0 0 1 0 1.5H7a.75.75 0 0 1 0-1.5zM21 11.25a.75.75 0 0 1 0 1.5H11a.75.75 0 0 1 0-1.5zM21 5.25a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1 0-1.5z" />
    </IconBase>
  ))
);
