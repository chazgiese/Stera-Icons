...
const HourglassFullBoldDuotone = memo(
  forwardRef<SVGSVGElement, HourglassFullBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="hourglass-full-bold-duotone" {...props}>
      <path fill="currentColor" d="M15.99 7q-.01.34-.07.5a2 2 0 0 1-.35.68c-.16.2-.4.38-1.2.93L12 10.78 9.62 9.1a6 6 0 0 1-1.19-.93 2 2 0 0 1-.35-.67A2 2 0 0 1 8.01 7z" opacity={.4} />
