...
type LockPasswordBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const LockPasswordBoldDuotone = memo(
  forwardRef<SVGSVGElement, LockPasswordBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="lock-password-bold-duotone" {...props}>
