...
type ChatBoxTextBoldProps = Omit<IconBaseProps, 'children'>;

const ChatBoxTextBold = memo(
  forwardRef<SVGSVGElement, ChatBoxTextBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-text-bold" {...props}>
      <path fill="currentColor" d="M12 11.25a1 1 0 1 1 0 2H8.5a1 1 0 1 1 0-2zM15.5 7.75a1 1 0 1 1 0 2h-7a1 1 0 1 1 0-2z" />
...
export default ChatBoxTextBold;
