  ...
  forwardRef<SVGSVGElement, WandFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="wand-fill" {...props}>
      <path fill="currentColor" d="M12 17a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0v-3a1 1 0 0 1 1-1" />
        ...
        <path fill="currentColor" d="M6 11a1 1 0 1 1 0 2H3a1 1 0 1 1 0-2zM21 11a1 1 0 1 1 0 2h-3a1 1 0 1 1 0-2zM12 2a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0V3a1 1 0 0 1 1-1M3.8 3.8a1 1 0 0 1 1.4 0l1 1a1 1 0 1 1-1.4 1.4l-1-1a1 1 0 0 1 0-1.4M18.8 3.8a1 1 0 1 1 1.4 1.4l-1 1a1 1 0 1 1-1.4-1.4z" />
    </IconBase>
  ))
);
