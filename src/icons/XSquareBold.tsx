...
type XSquareBoldProps = Omit<IconBaseProps, 'children'>;

const XSquareBold = memo(
  forwardRef<SVGSVGElement, XSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="x-square-bold" {...props}>
      <path fill="currentColor" d="M8.3 8.3a1 1 0 0 1 1.4 0l2.3 2.29 2.3-2.3a1 1 0 0 1 1.4 1.42L13.43 12l2.29 2.29a1 1 0 0 1-1.42 1.41L12 13.41l-2.3 2.3a1 1 0 0 1-1.4-1.42L10.58 12l-2.3-2.3a1 1 0 0 1 0-1.4" />
