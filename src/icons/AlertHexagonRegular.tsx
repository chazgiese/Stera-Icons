...
type AlertHexagonRegularProps = Omit<IconBaseProps, 'children'>;

const AlertHexagonRegular = memo(
  forwardRef<SVGSVGElement, AlertHexagonRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="alert-hexagon" {...props}>
      <path fill="currentColor" d="M12 14.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 6.75c.41 0 .75.34.75.75v5a.75.75 0 1 1-1.5 0v-5c0-.41.34-.75.75-.75" />
