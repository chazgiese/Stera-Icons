...
const ShuffleBoldDuotone = memo(
  forwardRef<SVGSVGElement, ShuffleBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="shuffle-bold-duotone" {...props}>
      <path d="M8.4 14.2a1 1 0 0 1 1.6 1.2C9.02 16.7 7.73 18 6 18H3a1 1 0 0 1 0-2h3c.69 0 1.45-.53 2.4-1.8M17.8 3.8a1 1 0 0 1 1.4 0l2.5 2.5a1 1 0 0 1 0 1.4l-2.5 2.5a1 1 0 1 1-1.4-1.4l.79-.8H16c-.69 0-1.45.53-2.4 1.8A1 1 0 0 1 12 8.6c.97-1.3 2.26-2.6 4-2.6h2.59l-.8-.8a1 1 0 0 1 0-1.4" opacity={0.4} />
