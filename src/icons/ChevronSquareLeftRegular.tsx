...
type ChevronSquareLeftRegularProps = Omit<IconBaseProps, 'children'>;

const ChevronSquareLeftRegular = memo(
  forwardRef<SVGSVGElement, ChevronSquareLeftRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-square-left" {...props}>
