...
const ArrowSquareDownRightRegular = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownRightRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-down-right" {...props}>
      <path fill="currentColor" d="M14.83 8.42c.41 0 .75.34.75.75v5.66a.75.75 0 0 1-.75.75H9.17a.75.75 0 0 1 0-1.5h3.85L8.64 9.7A.75.75 0 1 1 9.7 8.64l4.38 4.38V9.17c0-.41.33-.75.75-.75" />
