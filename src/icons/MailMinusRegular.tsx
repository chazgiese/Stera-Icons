...
type MailMinusRegularProps = Omit<IconBaseProps, 'children'>;

const MailMinusRegular = memo(
  forwardRef<SVGSVGElement, MailMinusRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="mail-minus" {...props}>
