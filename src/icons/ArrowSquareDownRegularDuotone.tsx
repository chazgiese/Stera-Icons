...
type ArrowSquareDownRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const ArrowSquareDownRegularDuotone = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-down-duotone" {...props}>
