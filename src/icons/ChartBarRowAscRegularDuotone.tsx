...
const ChartBarRowAscRegularDuotone = memo(
  forwardRef<SVGSVGElement, ChartBarRowAscRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-bar-row-asc-duotone" {...props}>
      <path fill="currentColor" d="M18.25 15.92a.5.5 0 0 0-.5-.5h-12v-1.5h8.5a.5.5 0 0 0 .5-.5v-2.84a.5.5 0 0 0-.5-.5h-8.5v-1.5h5a.5.5 0 0 0 .5-.5V5.25a.5.5 0 0 0-.5-.5h-5v-1.5h5a2 2 0 0 1 2 2v2.83a2 2 0 0 1-.07.5h1.57a2 2 0 0 1 2 2v2.84a2 2 0 0 1-.07.5h1.57a2 2 0 0 1 2 2v2.83a2 2 0 0 1-2 2h-12v-1.5h12a.5.5 0 0 0 .5-.5z" opacity={.4} />
