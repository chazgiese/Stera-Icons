...
const ReceiptRegular = memo(
  forwardRef<SVGSVGElement, ReceiptRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="receipt" {...props}>
