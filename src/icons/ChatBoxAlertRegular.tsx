...
type ChatBoxAlertRegularProps = Omit<IconBaseProps, 'children'>;

const ChatBoxAlertRegular = memo(
  forwardRef<SVGSVGElement, ChatBoxAlertRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-alert" {...props}>
      <path fill="currentColor" d="M12 12.25a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 6.25c.41 0 .75.34.75.75v3a.75.75 0 0 1-1.5 0V7c0-.41.34-.75.75-.75" />
...
ChatBoxAlertRegular.displayName = 'ChatBoxAlertRegular';
