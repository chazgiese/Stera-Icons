...
const ChartBarSquareRegular = memo(
  forwardRef<SVGSVGElement, ChartBarSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-bar-square" {...props}>
      <path fill="currentColor" d="M8 9.25c.41 0 .75.34.75.75v7a.75.75 0 0 1-1.5 0v-7c0-.41.34-.75.75-.75M12 6.25c.41 0 .75.34.75.75v10a.75.75 0 0 1-1.5 0V7c0-.41.34-.75.75-.75M16 11.25c.41 0 .75.34.75.75v5a.75.75 0 0 1-1.5 0v-5c0-.41.34-.75.75-.75" />
