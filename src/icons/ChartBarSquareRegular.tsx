...
type ChartBarSquareRegularProps = Omit<IconBaseProps, 'children'>;

const ChartBarSquareRegular = memo(
  forwardRef<SVGSVGElement, ChartBarSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-bar-square" {...props}>
      <path fill="currentColor" d="M8.5 10.25c.41 0 .75.34.75.75v5a.75.75 0 0 1-1.5 0v-5c0-.41.34-.75.75-.75M12 7.25c.41 0 .75.34.75.75v8a.75.75 0 0 1-1.5 0V8c0-.41.34-.75.75-.75M15.5 12.25c.41 0 .75.34.75.75v3a.75.75 0 0 1-1.5 0v-3c0-.41.34-.75.75-.75" />
