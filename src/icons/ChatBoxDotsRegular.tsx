...
type ChatBoxDotsRegularProps = Omit<IconBaseProps, 'children'>;

const ChatBoxDotsRegular = memo(
  forwardRef<SVGSVGElement, ChatBoxDotsRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-dots" {...props}>
...
ChatBoxDotsRegular.displayName = 'ChatBoxDotsRegular';

// Triple export pattern (lucide-react style)
export { ChatBoxDotsRegular, ChatBoxDotsRegular as ChatBoxDotsRegularIcon, ChatBoxDotsRegular as SiChatBoxDotsRegular };
export default ChatBoxDotsRegular;
export type { ChatBoxDotsRegularProps };
