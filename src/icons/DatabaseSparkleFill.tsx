...
const DatabaseSparkleFill = memo(
  forwardRef<SVGSVGElement, DatabaseSparkleFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-sparkle-fill" {...props}>
      <path fill="currentColor" d="M4 13.58q.57.37 1.23.66c1.09.48 2.4.85 3.84 1.05a2.44 2.44 0 0 0 1.58 3.03l1.08.37a2.5 2.5 0 0 1 1.58 1.58l.37 1.08q.1.3.25.55Q13 22 12 22c-2.02 0-3.9-.31-5.31-.86a6 6 0 0 1-1.81-1.05A2.4 2.4 0 0 1 4 18.3zM15.57 11.28a.45.45 0 0 1 .86 0l.36 1.09a4.5 4.5 0 0 0 2.84 2.84l1.09.36c.4.14.4.72 0 .86l-1.09.36a4.5 4.5 0 0 0-2.84 2.84l-.36 1.09a.45.45 0 0 1-.86 0l-.36-1.09a4.5 4.5 0 0 0-2.84-2.84l-1.09-.36a.45.45 0 0 1 0-.86l1.09-.36a4.5 4.5 0 0 0 2.84-2.84z" />
...
export { DatabaseSparkleFill, DatabaseSparkleFill as DatabaseSparkleFillIcon, DatabaseSparkleFill as SiDatabaseSparkleFill };
export default DatabaseSparkleFill;
