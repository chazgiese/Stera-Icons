...
const AlarmClockFillDuotone = memo(
  forwardRef<SVGSVGElement, AlarmClockFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="alarm-clock-fill-duotone" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 4a8.5 8.5 0 1 1 0 17 8.5 8.5 0 0 1 0-17m0 3.5a1 1 0 0 0-1 1v3H8.5a1 1 0 1 0 0 2H12a1 1 0 0 0 1-1v-4a1 1 0 0 0-1-1" clipRule="evenodd" opacity={.4} />
