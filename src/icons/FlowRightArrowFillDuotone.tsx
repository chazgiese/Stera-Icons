  ...
  forwardRef<SVGSVGElement, FlowRightArrowFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="flow-right-arrow-fill-duotone" {...props}>
      <path fill="currentColor" d="m20.59 12-1 1h-8.7a5 5 0 0 0 0-2h8.7z" opacity={.4} />
        <path fill="currentColor" d="M16.3 6.3a1 1 0 0 1 1.4 0l5 5a1 1 0 0 1 0 1.4l-5 5a1 1 0 0 1-1.4-1.4l4.29-4.3-4.3-4.3a1 1 0 0 1 0-1.4M6 7a5 5 0 1 1 0 10A5 5 0 0 1 6 7" />
    </IconBase>
  ))
);
