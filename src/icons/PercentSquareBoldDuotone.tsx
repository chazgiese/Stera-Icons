...
type PercentSquareBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const PercentSquareBoldDuotone = memo(
  forwardRef<SVGSVGElement, PercentSquareBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="percent-square-bold-duotone" {...props}>
