...
const ChatBubbleFillDuotone = memo(
  forwardRef<SVGSVGElement, ChatBubbleFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-bubble-fill-duotone" {...props}>
      <path fill="currentColor" d="M12 4c4.53 0 8 3.24 8 7s-3.47 7-8 7q-1.1 0-2.1-.24a1 1 0 0 0-.6.04l-4.05 1.62.47-3.02a2 2 0 0 0-.4-1.56A6.4 6.4 0 0 1 4 11c0-3.76 3.47-7 8-7" opacity={.4} />
