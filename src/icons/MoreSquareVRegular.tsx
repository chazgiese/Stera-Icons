...
const MoreSquareVRegular = memo(
  forwardRef<SVGSVGElement, MoreSquareVRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="more-square-v" {...props}>
      <path d="M12 14.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.75M12 10.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74M12 6.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74" />
