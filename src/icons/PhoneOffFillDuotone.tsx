...
const PhoneOffFillDuotone = memo(
  forwardRef<SVGSVGElement, PhoneOffFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="phone-off-fill-duotone" {...props}>
      <path fill="currentColor" d="M12 8q2.74-.04 5.52.5C21 9.18 23 10.88 23 13.82c0 1.11 0 2.37-1.13 2.16l-3.12-.83c-2.41-.63-1.92-.97-1.92-2.17 0-1.66-3.3-1.44-4.83-1.44s-4.83-.22-4.83 1.44c0 1.2.5 1.54-1.92 2.17l-3.12.83C1 16.19 1 14.93 1 13.8c0-2.93 2-4.63 5.48-5.31Q9.26 7.96 12 8" opacity={.4} />
