...
const RocketFill = memo(
  forwardRef<SVGSVGElement, RocketFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="rocket-fill" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M11.58 1.1a1 1 0 0 1 .97.07 12 12 0 0 1 4.64 5.32 10 10 0 0 1 .73 3.01l2.79 2.8a1 1 0 0 1 .28.85l-1 6.5a1 1 0 0 1-1.52.7L14.71 18H9.3l-3.76 2.35a1 1 0 0 1-1.52-.7l-1-6.5a1 1 0 0 1 .28-.86L6.08 9.5q.1-1.47.73-3.01a12 12 0 0 1 4.64-5.32zM5.06 13.34l.7 4.5 1.9-1.19a15 15 0 0 1-1.47-4.43zm12.75-1.12a15 15 0 0 1-1.47 4.43l1.9 1.19.7-4.5zM12 7a1.75 1.75 0 1 0 0 3.5A1.75 1.75 0 0 0 12 7" clipRule="evenodd" />
