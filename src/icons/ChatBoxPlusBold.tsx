...
type ChatBoxPlusBoldProps = Omit<IconBaseProps, 'children'>;

const ChatBoxPlusBold = memo(
  forwardRef<SVGSVGElement, ChatBoxPlusBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-plus-bold" {...props}>
...
ChatBoxPlusBold.displayName = 'ChatBoxPlusBold';

// Triple export pattern (lucide-react style)
export { ChatBoxPlusBold, ChatBoxPlusBold as ChatBoxPlusBoldIcon, ChatBoxPlusBold as SiChatBoxPlusBold };
export default ChatBoxPlusBold;
export type { ChatBoxPlusBoldProps };
