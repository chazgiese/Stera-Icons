...
const FootballBold = memo(
  forwardRef<SVGSVGElement, FootballBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="football-bold" {...props}>
      <path fill="currentColor" d="M13.3 7.3a1 1 0 0 1 1.4 0l2 2a1 1 0 0 1-1.4 1.4l-.3-.29L13.41 12l.3.3a1 1 0 0 1-1.42 1.4l-.29-.29L10.41 15l.3.3a1 1 0 0 1-1.42 1.4l-2-2a1 1 0 1 1 1.42-1.4l.29.29L10.59 12l-.3-.3a1 1 0 1 1 1.42-1.4l.29.29L13.59 9l-.3-.3a1 1 0 0 1 0-1.4" />
