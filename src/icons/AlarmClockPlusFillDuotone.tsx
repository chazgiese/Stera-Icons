...
const AlarmClockPlusFillDuotone = memo(
  forwardRef<SVGSVGElement, AlarmClockPlusFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="alarm-clock-plus-fill-duotone" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 4a8.5 8.5 0 1 1 0 17 8.5 8.5 0 0 1 0-17m0 4.5a1 1 0 0 0-1 1v2H9a1 1 0 1 0 0 2h2v2a1 1 0 1 0 2 0v-2h2a1 1 0 1 0 0-2h-2v-2a1 1 0 0 0-1-1" clipRule="evenodd" opacity={.4} />
