...
type ChatBoxPlusRegularProps = Omit<IconBaseProps, 'children'>;

const ChatBoxPlusRegular = memo(
  forwardRef<SVGSVGElement, ChatBoxPlusRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-plus" {...props}>
...
ChatBoxPlusRegular.displayName = 'ChatBoxPlusRegular';

// Triple export pattern (lucide-react style)
export { ChatBoxPlusRegular, ChatBoxPlusRegular as ChatBoxPlusRegularIcon, ChatBoxPlusRegular as SiChatBoxPlusRegular };
export default ChatBoxPlusRegular;
export type { ChatBoxPlusRegularProps };
