...
type PlayRectangleRegularProps = Omit<IconBaseProps, 'children'>;

const PlayRectangleRegular = memo(
  forwardRef<SVGSVGElement, PlayRectangleRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="play-rectangle" {...props}>
