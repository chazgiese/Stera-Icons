...
const ChevronSquareDownBold = memo(
  forwardRef<SVGSVGElement, ChevronSquareDownBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-square-down-bold" {...props}>
      <path fill="currentColor" d="M15.8 9.3a1 1 0 0 1 1.4 1.4l-4.5 4.5a1 1 0 0 1-1.4 0l-4.5-4.5a1 1 0 1 1 1.4-1.4l3.8 3.79z" />
