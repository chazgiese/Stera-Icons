...
const DatabaseSparkleFillDuotone = memo(
  forwardRef<SVGSVGElement, DatabaseSparkleFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-sparkle-fill-duotone" {...props}>
      <path d="M4.47 14.52a16 16 0 0 0 6.11 1.44 2.15 2.15 0 0 0 1.18 3.07l.7.24a3.7 3.7 0 0 1 2.27 2.27l.24.7q.1.28.26.52-1.52.23-3.23.24c-2.3 0-4.42-.35-6-.94q-1.22-.44-2.04-1.14A2.6 2.6 0 0 1 3 19v-5.26z" opacity={0.4} />
