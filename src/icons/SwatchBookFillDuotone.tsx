...
const SwatchBookFillDuotone = memo(
  forwardRef<SVGSVGElement, SwatchBookFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="swatch-book-fill-duotone" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M9.5 2A2.5 2.5 0 0 1 12 4.5V17a5 5 0 0 1-10 0V4.5A2.5 2.5 0 0 1 4.5 2zM7 15.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3" clipRule="evenodd" />
