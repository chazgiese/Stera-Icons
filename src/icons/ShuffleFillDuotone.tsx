...
const ShuffleFillDuotone = memo(
  forwardRef<SVGSVGElement, ShuffleFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="shuffle-fill-duotone" {...props}>
      <path d="M8.4 14.2a1 1 0 1 1 1.6 1.2C9.02 16.7 7.73 18 6 18H3a1 1 0 0 1 0-2h3c.69 0 1.45-.53 2.4-1.8M18.12 3.58a1 1 0 0 1 1.09.21l2.5 2.5a1 1 0 0 1 0 1.42l-2.5 2.5a1 1 0 0 1-1.71-.71V8H16c-.69 0-1.45.53-2.4 1.8A1 1 0 0 1 12 8.6c.97-1.3 2.26-2.6 4-2.6h1.5V4.5a1 1 0 0 1 .62-.92" opacity={0.4} />
