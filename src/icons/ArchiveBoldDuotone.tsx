...
const ArchiveBoldDuotone = memo(
  forwardRef<SVGSVGElement, ArchiveBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="archive-bold-duotone" {...props}>
      <path d="M22 14.2q.01 1.23-.04 2.05a4 4 0 0 1-.4 1.57 4 4 0 0 1-1.74 1.74c-.49.25-1 .35-1.57.4q-.82.05-2.05.04H7.8q-1.23.01-2.05-.04a4 4 0 0 1-1.57-.4 4 4 0 0 1-1.74-1.74 4 4 0 0 1-.4-1.57Q2 15.43 2 14.2v-3.7l.37.23q.49.22.96.25L4 11v3.2c0 .86 0 1.44.04 1.89.03.44.1.66.18.82q.3.57.87.87c.16.08.38.15.82.18.45.04 1.03.04 1.89.04h8.4c.86 0 1.44 0 1.89-.04.44-.03.66-.1.82-.18a2 2 0 0 0 .87-.87c.08-.16.15-.38.18-.82.04-.45.04-1.03.04-1.89V11q.37 0 .67-.02A2.5 2.5 0 0 0 22 10.5z" opacity={.4} />
