...
const RotationRightBoldDuotone = memo(
  forwardRef<SVGSVGElement, RotationRightBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="rotation-right-bold-duotone" {...props}>
      <path d="M16.95 5.64a1 1 0 0 1 1.41 0 9 9 0 0 1-6.03 15.35L12 21h-.59l-1-1 1-1h.85a7 7 0 0 0 4.69-11.95 1 1 0 0 1 0-1.41M13.59 4l-1 1h-.85a7 7 0 0 0-4.69 11.95 1 1 0 0 1-1.41 1.41 9 9 0 0 1 6.03-15.35L12 3h.59z" opacity={0.4} />
