...
const DeviceLaptopRegularDuotone = memo(
  forwardRef<SVGSVGElement, DeviceLaptopRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="device-laptop-duotone" {...props}>
      <path fill="currentColor" d="M20.25 14.49q.12.16.2.36l1.2 3a1.75 1.75 0 0 1-1.63 2.4H3.98a1.75 1.75 0 0 1-1.63-2.4l1.2-3q.08-.2.2-.36v.01c0 .41.34.75.75.75h.68q-.17 0-.23.16l-1.2 3c-.07.16.05.34.23.34h16.04c.18 0 .3-.18.23-.34l-1.2-3a.3.3 0 0 0-.23-.16h.68c.41 0 .75-.34.75-.75z" opacity={.4} />
