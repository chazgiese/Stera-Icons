...
type AlertSquareRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const AlertSquareRegularDuotone = memo(
  forwardRef<SVGSVGElement, AlertSquareRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="alert-square-duotone" {...props}>
