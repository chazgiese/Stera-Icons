...
type BatteryFullBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const BatteryFullBoldDuotone = memo(
  forwardRef<SVGSVGElement, BatteryFullBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="battery-full-bold-duotone" {...props}>
