...
const HourglassEmptyBoldDuotone = memo(
  forwardRef<SVGSVGElement, HourglassEmptyBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="hourglass-empty-bold-duotone" {...props}>
      <path fill="currentColor" d="M15.7 16a2 2 0 0 1 .22.5c.07.24.08.52.08 1.5v1H8v-1c0-.98 0-1.26.08-1.5a2 2 0 0 1 .23-.5z" opacity={.4} />
