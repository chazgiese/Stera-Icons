...
const CubePackageFillDuotone = memo(
  forwardRef<SVGSVGElement, CubePackageFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="cube-package-fill-duotone" {...props}>
      <path d="M11 12.59v7.65c-.34-.14-.8-.38-1.62-.84l-2.6-1.45c-1.26-.7-1.68-.94-1.99-1.27a3 3 0 0 1-.64-1.1c-.14-.41-.15-.9-.15-2.35v-2.46c0-1.1 0-1.65.07-2.03zM19.93 8.74c.06.38.07.93.07 2.03v2.46c0 1.44-.01 1.94-.15 2.36a3 3 0 0 1-.64 1.09c-.3.33-.73.58-1.99 1.27l-2.6 1.45c-.83.46-1.28.7-1.62.84v-7.65l2.48-1.38q.02.36.02 1.11V13a1 1 0 0 0 2 0v-.68c0-.88 0-1.54-.16-2.15zM13.55 9l.88.5L12 10.87 5.12 7.03c.3-.23.78-.5 1.66-.99l.72-.4zM11.4 3.64a3 3 0 0 1 1.2 0c.42.08.83.3 2.02.96l2.6 1.44c.88.5 1.35.76 1.66 1l-2.55 1.4c-.45-.44-1.04-.75-1.81-1.19L9.56 4.5a7 7 0 0 1 1.84-.86" opacity={0.4} />
