...
type ChevronSquareLeftBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const ChevronSquareLeftBoldDuotone = memo(
  forwardRef<SVGSVGElement, ChevronSquareLeftBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-square-left-bold-duotone" {...props}>
