...
const ClipboardTextRegular = memo(
  forwardRef<SVGSVGElement, ClipboardTextRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="clipboard-text" {...props}>
      <path fill="currentColor" d="M15 14a.75.75 0 0 1 0 1.5H9A.75.75 0 0 1 9 14zM15 10.5a.75.75 0 0 1 0 1.5H9a.75.75 0 0 1 0-1.5z" />
