...
type SquareRegularProps = Omit<IconBaseProps, 'children'>;

const SquareRegular = memo(
  forwardRef<SVGSVGElement, SquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="square" {...props}>
