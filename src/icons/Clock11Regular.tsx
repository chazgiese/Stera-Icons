...
const Clock11Regular = memo(
  forwardRef<SVGSVGElement, Clock11RegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="clock-11" {...props}>
      <path fill="currentColor" d="M12 6.25c.41 0 .75.34.75.75v5.06a1 1 0 0 1-.07.25l-.03.05-.04.07-.05.06-.13.13h-.02l-.04.03-.07.04h-.02l-.09.03-.09.02h-.01l-.09.01h-.06l-.11-.02-.07-.02-.07-.03-.06-.03-.07-.04-.04-.04-.14-.15v-.01l-.03-.04-2-3.46a.75.75 0 0 1 1.3-.75l.6 1.04V7c0-.41.34-.75.75-.75" />
