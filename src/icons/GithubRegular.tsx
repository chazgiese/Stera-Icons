...
type GithubRegularProps = Omit<IconBaseProps, 'children'>;

const GithubRegular = memo(
  forwardRef<SVGSVGElement, GithubRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="github" {...props}>
