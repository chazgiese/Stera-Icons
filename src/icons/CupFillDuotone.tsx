...
const CupFillDuotone = memo(
  forwardRef<SVGSVGElement, CupFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="cup-fill-duotone" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M19.84 9.02A3.5 3.5 0 0 1 19.5 16h-.99a8 8 0 0 1-6.92 4H10.4a8 8 0 0 1-7.97-7.37L2 7.18c.09.74.69 1.2 1.11 1.46.52.3 1.21.55 1.98.74 1.55.4 3.63.62 5.9.62s4.35-.23 5.9-.62c.77-.19 1.46-.43 1.98-.74.42-.25 1.02-.72 1.1-1.46zm-.28 3.6q-.05.72-.23 1.38h.17a1.5 1.5 0 0 0 .19-2.99z" clipRule="evenodd" opacity={.4} />
