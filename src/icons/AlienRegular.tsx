...
type AlienRegularProps = Omit<IconBaseProps, 'children'>;

const AlienRegular = memo(
  forwardRef<SVGSVGElement, AlienRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="alien" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 2.25a8.84 8.84 0 0 1 8.75 8.93c0 2.13-1.07 4.05-2.37 5.6a22 22 0 0 1-4.1 3.67 3.9 3.9 0 0 1-4.55 0c-1.2-.85-2.8-2.12-4.11-3.67-1.3-1.55-2.37-3.47-2.37-5.6 0-4.92 3.9-8.93 8.75-8.93m0 1.5a7.34 7.34 0 0 0-7.25 7.43c0 1.63.83 3.21 2.02 4.63a20 20 0 0 0 3.82 3.4c.86.6 1.96.6 2.82 0 1.16-.8 2.64-1.98 3.82-3.4 1.2-1.42 2.02-3 2.02-4.63A7.34 7.34 0 0 0 12 3.75" clipRule="evenodd" />
