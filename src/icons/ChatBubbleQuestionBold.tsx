...
type ChatBubbleQuestionBoldProps = Omit<IconBaseProps, 'children'>;

const ChatBubbleQuestionBold = memo(
  forwardRef<SVGSVGElement, ChatBubbleQuestionBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-bubble-question-bold" {...props}>
      <path fill="currentColor" d="M12 13a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 6.75c1.31 0 2.5 1.01 2.5 2.4 0 .97-.6 1.78-1.4 2.15l-.1.06v.01a1 1 0 0 1-2-.12c0-.99.8-1.54 1.25-1.75q.26-.15.25-.35c0-.16-.16-.4-.5-.4-.32 0-.5.21-.52.33a1 1 0 0 1-1.96-.42A2.5 2.5 0 0 1 12 6.75" />
...
export default ChatBubbleQuestionBold;
