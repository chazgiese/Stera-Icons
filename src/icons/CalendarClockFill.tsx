...
const CalendarClockFill = memo(
  forwardRef<SVGSVGElement, CalendarClockFillProps>((props, ref) => (
    <IconBase ref={ref} iconName="calendar-clock-fill" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M16.5 11.5a5 5 0 1 1 0 10 5 5 0 0 1 0-10m0 2.38c-.48 0-.87.39-.87.87v1.75q.01.47.38.73l1.5 1a.88.88 0 0 0 .98-1.46l-1.11-.74v-1.28c0-.48-.4-.87-.88-.87" clipRule="evenodd" />
