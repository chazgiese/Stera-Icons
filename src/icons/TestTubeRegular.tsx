...
const TestTubeRegular = memo(
  forwardRef<SVGSVGElement, TestTubeRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="test-tube" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M16.5 1.25a.75.75 0 0 1 .08 1.5h-.16a.75.75 0 0 0-.67.75V19a3.75 3.75 0 1 1-7.5 0V3.5c0-.39-.3-.7-.67-.75h-.16a.75.75 0 0 1 .08-1.5zM9.75 19a2.25 2.25 0 0 0 4.5 0V2.75h-4.5z" clipRule="evenodd" />
    </IconBase>
  ))
);
