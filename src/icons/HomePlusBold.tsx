...
type HomePlusBoldProps = Omit<IconBaseProps, 'children'>;

const HomePlusBold = memo(
  forwardRef<SVGSVGElement, HomePlusBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="home-plus-bold" {...props}>
      <path fill="currentColor" d="M12 8.5a1 1 0 0 1 1 1v2h2a1 1 0 1 1 0 2h-2v2a1 1 0 1 1-2 0v-2H9a1 1 0 0 1 0-2h2v-2a1 1 0 0 1 1-1" />
