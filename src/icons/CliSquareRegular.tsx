...
type CliSquareRegularProps = Omit<IconBaseProps, 'children'>;

const CliSquareRegular = memo(
  forwardRef<SVGSVGElement, CliSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="cli-square" {...props}>
