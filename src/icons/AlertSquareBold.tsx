...
type AlertSquareBoldProps = Omit<IconBaseProps, 'children'>;

const AlertSquareBold = memo(
  forwardRef<SVGSVGElement, AlertSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="alert-square-bold" {...props}>
