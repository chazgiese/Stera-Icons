...
type MoreSquareBoldProps = Omit<IconBaseProps, 'children'>;

const MoreSquareBold = memo(
  forwardRef<SVGSVGElement, MoreSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="more-square-bold" {...props}>
