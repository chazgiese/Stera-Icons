...
type MoreSquareRegularProps = Omit<IconBaseProps, 'children'>;

const MoreSquareRegular = memo(
  forwardRef<SVGSVGElement, MoreSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="more-square" {...props}>
      <path fill="currentColor" d="M8 10.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74M12 10.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74M16 10.63a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74" />
