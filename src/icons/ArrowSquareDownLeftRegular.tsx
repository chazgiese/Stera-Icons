...
type ArrowSquareDownLeftRegularProps = Omit<IconBaseProps, 'children'>;

const ArrowSquareDownLeftRegular = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownLeftRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-down-left" {...props}>
      <path fill="currentColor" d="M15.47 7.47a.75.75 0 1 1 1.06 1.06l-6.72 6.72H15a.75.75 0 0 1 0 1.5H8a.75.75 0 0 1-.75-.75V9a.75.75 0 0 1 1.5 0v5.19z" />
