...
const SignatureXBoldDuotone = memo(
  forwardRef<SVGSVGElement, SignatureXBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="signature-x-bold-duotone" {...props}>
      <path d="M7.86 17q-.67 1.1-1.35 2H2a1 1 0 0 1 0-2zM22 17a1 1 0 1 1 0 2H8.96q.63-.95 1.2-2zM4.3 11.3a1 1 0 1 1 1.4 1.4l-.79.8.8.8a1 1 0 0 1-1.42 1.4l-.79-.79-.8.8a1 1 0 1 1-1.4-1.42l.79-.79-.8-.8a1 1 0 0 1 1.42-1.4l.79.79z" opacity={0.4} />
