...
type ArrowSquareRightBoldProps = Omit<IconBaseProps, 'children'>;

const ArrowSquareRightBold = memo(
  forwardRef<SVGSVGElement, ArrowSquareRightBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-right-bold" {...props}>
      <path fill="currentColor" d="M11.3 7.3a1 1 0 0 1 1.4 0l4 4a1 1 0 0 1 0 1.4l-4 4a1 1 0 1 1-1.4-1.4l2.29-2.3H8a1 1 0 1 1 0-2h5.59l-2.3-2.3a1 1 0 0 1 0-1.4" />
