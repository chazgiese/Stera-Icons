...
type ArrowSquareDownBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const ArrowSquareDownBoldDuotone = memo(
  forwardRef<SVGSVGElement, ArrowSquareDownBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="arrow-square-down-bold-duotone" {...props}>
