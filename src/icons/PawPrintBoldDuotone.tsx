...
const PawPrintBoldDuotone = memo(
  forwardRef<SVGSVGElement, PawPrintBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="paw-print-bold-duotone" {...props}>
      <path d="M4 7.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6m0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2M20 7.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6m0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2M8.5 2.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6m0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2M15.5 2.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6m0 2a1 1 0 1 0 0 2 1 1 0 0 0 0-2" opacity={0.4} />
