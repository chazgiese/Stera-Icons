...
type ChatBoxDotsRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const ChatBoxDotsRegularDuotone = memo(
  forwardRef<SVGSVGElement, ChatBoxDotsRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-dots-duotone" {...props}>
      <path fill="currentColor" d="M7.75 9.25a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M12 9.25a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5M16.25 9.25a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5" />
...
ChatBoxDotsRegularDuotone.displayName = 'ChatBoxDotsRegularDuotone';

// Triple export pattern (lucide-react style)
export { ChatBoxDotsRegularDuotone, ChatBoxDotsRegularDuotone as ChatBoxDotsRegularDuotoneIcon, ChatBoxDotsRegularDuotone as SiChatBoxDotsRegularDuotone };
export default ChatBoxDotsRegularDuotone;
export type { ChatBoxDotsRegularDuotoneProps };
