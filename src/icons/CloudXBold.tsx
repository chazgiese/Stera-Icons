...
const CloudXBold = memo(
  forwardRef<SVGSVGElement, CloudXBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="cloud-x-bold" {...props}>
      <path fill="currentColor" d="M13.3 10.3a1 1 0 1 1 1.4 1.4L13.42 13l1.3 1.3a1 1 0 1 1-1.42 1.4L12 14.42l-1.3 1.3a1 1 0 1 1-1.4-1.42L10.58 13l-1.3-1.3a1 1 0 1 1 1.42-1.4L12 11.58z" />
