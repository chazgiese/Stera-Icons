...
type AnnotationRegularProps = Omit<IconBaseProps, 'children'>;

const AnnotationRegular = memo(
  forwardRef<SVGSVGElement, AnnotationRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="annotation" {...props}>
      <path fillRule="evenodd" d="M5.5 15.75a2.75 2.75 0 1 1 0 5.5 2.75 2.75 0 0 1 0-5.5m0 1.5a1.25 1.25 0 1 0 0 2.5 1.25 1.25 0 0 0 0-2.5" clipRule="evenodd" />
