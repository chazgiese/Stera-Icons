...
const GaugeLines85PercentBoldDuotone = memo(
  forwardRef<SVGSVGElement, GaugeLines85PercentBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="gauge-lines-85-percent-bold-duotone" {...props}>
...
export { GaugeLines85PercentBoldDuotone, GaugeLines85PercentBoldDuotone as GaugeLines85PercentBoldDuotoneIcon, GaugeLines85PercentBoldDuotone as SiGaugeLines85PercentBoldDuotone };
export default GaugeLines85PercentBoldDuotone;
