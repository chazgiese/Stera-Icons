...
const Clock3Fill = memo(
  forwardRef<SVGSVGElement, Clock3FillProps>((props, ref) => (
    <IconBase ref={ref} iconName="clock-3-fill" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20m0 4a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1h4a1 1 0 1 0 0-2h-3V7a1 1 0 0 0-1-1" clipRule="evenodd" />
    </IconBase>
  ))
);
