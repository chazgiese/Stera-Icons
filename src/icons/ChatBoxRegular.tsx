...
type ChatBoxRegularProps = Omit<IconBaseProps, 'children'>;

const ChatBoxRegular = memo(
  forwardRef<SVGSVGElement, ChatBoxRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box" {...props}>
...
ChatBoxRegular.displayName = 'ChatBoxRegular';

// Triple export pattern (lucide-react style)
export { ChatBoxRegular, ChatBoxRegular as ChatBoxRegularIcon, ChatBoxRegular as SiChatBoxRegular };
export default ChatBoxRegular;
export type { ChatBoxRegularProps };
