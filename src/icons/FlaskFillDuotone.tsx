...
const FlaskFillDuotone = memo(
  forwardRef<SVGSVGElement, FlaskFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="flask-fill-duotone" {...props}>
      <path fill="currentColor" d="M14.75 8.98q0 .82.4 1.56l3.9 7.14c1 1.84-.33 4.07-2.42 4.07H7.37a2.75 2.75 0 0 1-2.41-4.07l3.9-7.14q.38-.74.39-1.56V4h5.5z" opacity={.4} />
