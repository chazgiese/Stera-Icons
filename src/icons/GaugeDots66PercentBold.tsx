...
const GaugeDots66PercentBold = memo(
  forwardRef<SVGSVGElement, GaugeDots66PercentBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="gauge-dots-66-percent-bold" {...props}>
      <path fill="currentColor" d="M7.05 14.83a1.5 1.5 0 1 1 2.12 2.12 1.5 1.5 0 0 1-2.12-2.12M14.83 14.83a1.5 1.5 0 1 1 2.12 2.12 1.5 1.5 0 0 1-2.12-2.12M15.75 6.89a1 1 0 0 1 1.32 1.44l-.04.04-.1.14-1.41 2.03a60 60 0 0 1-2.1 2.87 2 2 0 1 1-2.78-2.88c.4-.34 1.7-1.26 2.82-2.05l2.17-1.51.04-.03zM6.5 10.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3M17.5 10.5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3M7.05 7.05a1.5 1.5 0 1 1 2.12 2.12 1.5 1.5 0 0 1-2.12-2.12M12 5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3" />
