...
type ChevronSquareUpBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const ChevronSquareUpBoldDuotone = memo(
  forwardRef<SVGSVGElement, ChevronSquareUpBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-square-up-bold-duotone" {...props}>
