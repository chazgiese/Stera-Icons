...
const ScanFillDuotone = memo(
  forwardRef<SVGSVGElement, ScanFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="scan-fill-duotone" {...props}>
      <path d="M3 15.5c.83 0 1.5.67 1.5 1.5v2c0 .28.22.5.5.5h2a1.5 1.5 0 0 1 0 3H5A3.5 3.5 0 0 1 1.5 19v-2c0-.83.67-1.5 1.5-1.5M19 1.5A3.5 3.5 0 0 1 22.5 5v2a1.5 1.5 0 0 1-3 0V5a.5.5 0 0 0-.5-.5h-2a1.5 1.5 0 0 1 0-3z" opacity={0.4} />
