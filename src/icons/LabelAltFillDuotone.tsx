...
const LabelAltFillDuotone = memo(
  forwardRef<SVGSVGElement, LabelAltFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="label-alt-fill-duotone" {...props}>
      <path fill="currentColor" d="m20.06 6-3.04 4.26a3 3 0 0 0 0 3.48L20.06 18H8.03a1 1 0 0 1-.81-.42l-3.58-5a1 1 0 0 1 0-1.16l3.58-5A1 1 0 0 1 8.03 6z" opacity={.4} />
