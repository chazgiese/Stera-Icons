...
type InfoSquareBoldProps = Omit<IconBaseProps, 'children'>;

const InfoSquareBold = memo(
  forwardRef<SVGSVGElement, InfoSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="info-square-bold" {...props}>
