...
const DatabaseXFillDuotone = memo(
  forwardRef<SVGSVGElement, DatabaseXFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-x-fill-duotone" {...props}>
      <path d="M4.47 14.52c1.59.84 4.22 1.45 7.28 1.48l-.37.38a3 3 0 1 0 4.24 4.24l.38-.38.38.38c.63.63 1.48.92 2.3.87.12 0 .2.19.1.24q-.37.18-.77.33c-1.59.6-3.71.94-6.01.94s-4.42-.35-6-.94q-1.22-.44-2.04-1.14A2.6 2.6 0 0 1 3 19v-5.26z" opacity={0.4} />
