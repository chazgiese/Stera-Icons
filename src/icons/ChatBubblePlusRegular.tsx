...
type ChatBubblePlusRegularProps = Omit<IconBaseProps, 'children'>;

const ChatBubblePlusRegular = memo(
  forwardRef<SVGSVGElement, ChatBubblePlusRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-bubble-plus" {...props}>
...
ChatBubblePlusRegular.displayName = 'ChatBubblePlusRegular';
