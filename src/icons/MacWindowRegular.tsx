...
type MacWindowRegularProps = Omit<IconBaseProps, 'children'>;

const MacWindowRegular = memo(
  forwardRef<SVGSVGElement, MacWindowRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="mac-window" {...props}>
