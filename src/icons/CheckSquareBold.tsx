...
type CheckSquareBoldProps = Omit<IconBaseProps, 'children'>;

const CheckSquareBold = memo(
  forwardRef<SVGSVGElement, CheckSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="check-square-bold" {...props}>
