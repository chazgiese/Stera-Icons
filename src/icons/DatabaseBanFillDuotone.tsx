...
const DatabaseBanFillDuotone = memo(
  forwardRef<SVGSVGElement, DatabaseBanFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="database-ban-fill-duotone" {...props}>
      <path d="M4.47 14.52a16 16 0 0 0 6.11 1.44q-.08.5-.08 1.04a6.5 6.5 0 0 0 3.74 5.88Q13.16 23 12 23c-2.3 0-4.42-.35-6-.94q-1.22-.44-2.04-1.14A2.6 2.6 0 0 1 3 19v-5.26z" opacity={0.4} />
