...
const CheckCircleRegular = memo(
  forwardRef<SVGSVGElement, CheckCircleRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="check-circle" {...props}>
      <path fill="currentColor" d="M15.45 8.74a.75.75 0 1 1 1.1 1.02l-4.88 5.32-.3.31q-.15.17-.46.29-.42.13-.84-.02-.3-.14-.45-.3l-.28-.33-1.92-2.3a.75.75 0 0 1 1.16-.96l1.91 2.3.04.04.04-.04z" />
