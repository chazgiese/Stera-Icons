...
const BookOpenTextRegular = memo(
  forwardRef<SVGSVGElement, BookOpenTextRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="book-open-text" {...props}>
      <path fill="currentColor" d="M6.19 11.71a7 7 0 0 1 2.8.33.75.75 0 0 1-.48 1.42 5 5 0 0 0-2.2-.26.75.75 0 0 1-.12-1.49M6.19 8.52a7 7 0 0 1 2.8.33.75.75 0 0 1-.48 1.43 5 5 0 0 0-2.2-.26.75.75 0 1 1-.12-1.5M15 12.04a7 7 0 0 1 2.81-.33.75.75 0 0 1-.12 1.5 5 5 0 0 0-2.2.25.75.75 0 1 1-.48-1.42M15 8.85a7 7 0 0 1 2.81-.33.75.75 0 0 1-.12 1.5 5 5 0 0 0-2.2.26.75.75 0 0 1-.48-1.43" />
