...
type ChevronFullSquareDownBoldProps = Omit<IconBaseProps, 'children'>;

const ChevronFullSquareDownBold = memo(
  forwardRef<SVGSVGElement, ChevronFullSquareDownBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-full-square-down-bold" {...props}>
