...
type CliSquareBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const CliSquareBoldDuotone = memo(
  forwardRef<SVGSVGElement, CliSquareBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="cli-square-bold-duotone" {...props}>
