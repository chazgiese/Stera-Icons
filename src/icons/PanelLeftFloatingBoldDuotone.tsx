...
const PanelLeftFloatingBoldDuotone = memo(
  forwardRef<SVGSVGElement, PanelLeftFloatingBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="panel-left-floating-bold-duotone" {...props}>
      <path fill="currentColor" d="M9 6.5a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H6.5a2 2 0 0 1-2-2v-7c0-1.1.9-2 2-2z" opacity={.4} />
