...
type ChevronFullSquareRightRegularProps = Omit<IconBaseProps, 'children'>;

const ChevronFullSquareRightRegular = memo(
  forwardRef<SVGSVGElement, ChevronFullSquareRightRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-full-square-right" {...props}>
