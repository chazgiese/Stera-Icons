...
const CoffeeMugBoldDuotone = memo(
  forwardRef<SVGSVGElement, CoffeeMugBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="coffee-mug-bold-duotone" {...props}>
      <path fill="currentColor" fillRule="evenodd" d="M18.25 6.04 18.2 7h.47a3 3 0 0 1 3 3.1l-.1 3a3 3 0 0 1-3 2.9h-.69a4.9 4.9 0 0 1-4.2 4.58q-2.94.43-5.89 0a4.9 4.9 0 0 1-4.2-4.68l-.35-9.86v-.01c.01.73.5 1.25.92 1.56q.5.35 1.16.6l.27 7.64a2.9 2.9 0 0 0 2.49 2.77c1.76.26 3.56.26 5.32 0a2.9 2.9 0 0 0 2.5-2.77l.26-7.64q.66-.26 1.16-.6c.42-.31.9-.83.92-1.57zM17.97 14h.61a1 1 0 0 0 1-.97l.1-3a1 1 0 0 0-1-1.03h-.54z" clipRule="evenodd" opacity={.4} />
