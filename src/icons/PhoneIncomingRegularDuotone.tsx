...
type PhoneIncomingRegularDuotoneProps = Omit<IconBaseProps, 'children'>;

const PhoneIncomingRegularDuotone = memo(
  forwardRef<SVGSVGElement, PhoneIncomingRegularDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="phone-incoming-duotone" {...props}>
      <path fill="currentColor" d="M19.97 2.97a.75.75 0 1 1 1.06 1.06l-5.22 5.22H20a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1-.75-.75V4a.75.75 0 0 1 1.5 0v4.19z" opacity={.4} />
