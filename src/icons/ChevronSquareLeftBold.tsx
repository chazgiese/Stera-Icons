...
type ChevronSquareLeftBoldProps = Omit<IconBaseProps, 'children'>;

const ChevronSquareLeftBold = memo(
  forwardRef<SVGSVGElement, ChevronSquareLeftBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-square-left-bold" {...props}>
      <path fill="currentColor" d="M12.8 7.3a1 1 0 1 1 1.4 1.4L10.92 12l3.3 3.3a1 1 0 1 1-1.42 1.4l-4-4a1 1 0 0 1 0-1.4z" />
