...
const FolderFillDuotone = memo(
  forwardRef<SVGSVGElement, FolderFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="folder-fill-duotone" {...props}>
      <path fill="currentColor" d="M21.5 14.7q.01 1.23-.04 2.05a4 4 0 0 1-.4 1.57 4 4 0 0 1-1.74 1.74c-.49.25-1 .35-1.57.4q-.82.05-2.05.04H8.3q-1.23.01-2.05-.04a4 4 0 0 1-1.57-.4 4 4 0 0 1-1.74-1.74c-.25-.49-.35-1-.4-1.57q-.05-.82-.04-2.05V9.5h19z" />
