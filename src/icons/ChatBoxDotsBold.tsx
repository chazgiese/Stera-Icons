...
type ChatBoxDotsBoldProps = Omit<IconBaseProps, 'children'>;

const ChatBoxDotsBold = memo(
  forwardRef<SVGSVGElement, ChatBoxDotsBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chat-box-dots-bold" {...props}>
...
ChatBoxDotsBold.displayName = 'ChatBoxDotsBold';

// Triple export pattern (lucide-react style)
export { ChatBoxDotsBold, ChatBoxDotsBold as ChatBoxDotsBoldIcon, ChatBoxDotsBold as SiChatBoxDotsBold };
export default ChatBoxDotsBold;
export type { ChatBoxDotsBoldProps };
