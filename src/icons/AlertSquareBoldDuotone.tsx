...
type AlertSquareBoldDuotoneProps = Omit<IconBaseProps, 'children'>;

const AlertSquareBoldDuotone = memo(
  forwardRef<SVGSVGElement, AlertSquareBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="alert-square-bold-duotone" {...props}>
