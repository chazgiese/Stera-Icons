...
const Clock2Regular = memo(
  forwardRef<SVGSVGElement, Clock2RegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="clock-2" {...props}>
      <path fill="currentColor" d="M12 6.25c.41 0 .75.34.75.75v3.7l2.34-1.35a.75.75 0 0 1 .75 1.3l-3.46 2-.08.04h-.02l-.09.03-.09.02h-.01l-.09.01h-.06l-.11-.02-.07-.02-.07-.03-.06-.03-.06-.04-.06-.05-.13-.14v-.01l-.03-.04-.05-.1-.02-.08-.02-.09v-.01l-.01-.09V7c0-.41.34-.75.75-.75" />
