...
type PlusSquareRegularProps = Omit<IconBaseProps, 'children'>;

const PlusSquareRegular = memo(
  forwardRef<SVGSVGElement, PlusSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="plus-square" {...props}>
