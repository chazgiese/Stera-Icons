...
const HourglassFillDuotone = memo(
  forwardRef<SVGSVGElement, HourglassFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="hourglass-fill-duotone" {...props}>
      <path d="M14.38 14.89c.8.55 1.03.73 1.19.93a2 2 0 0 1 .35.67c.07.25.08.53.08 1.5V19H8v-1c0-.98 0-1.26.08-1.5a2 2 0 0 1 .35-.68c.16-.2.4-.37 1.2-.93L12 13.22zM16 5v1c0 .98 0 1.26-.08 1.5a2 2 0 0 1-.35.68c-.16.2-.4.38-1.2.93L12 10.78 9.62 9.1a6 6 0 0 1-1.19-.93 2 2 0 0 1-.35-.67A6 6 0 0 1 8 6V5z" opacity={0.4} />
