...
const AnnotationFillDuotone = memo(
  forwardRef<SVGSVGElement, AnnotationFillDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="annotation-fill-duotone" {...props}>
      <path d="M5.5 15.75a2.75 2.75 0 1 1 0 5.5 2.75 2.75 0 0 1 0-5.5M13 11.25a.75.75 0 0 1 0 1.5h-3a.75.75 0 0 1 0-1.5zM16 7.75a.75.75 0 0 1 0 1.5h-6a.75.75 0 0 1 0-1.5z" />
