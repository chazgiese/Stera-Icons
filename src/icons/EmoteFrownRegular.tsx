...
const EmoteFrownRegular = memo(
  forwardRef<SVGSVGElement, EmoteFrownRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="emote-frown" {...props}>
      <path fill="currentColor" d="M12 13.5c1.55 0 2.95.69 3.83 1.78a.75.75 0 0 1-1.16.94A3.4 3.4 0 0 0 12 15c-1.1 0-2.07.5-2.67 1.22a.75.75 0 0 1-1.16-.94A5 5 0 0 1 12 13.5M9 8.38a1.38 1.38 0 1 1 0 2.75 1.38 1.38 0 0 1 0-2.76M15 8.38a1.37 1.37 0 1 1 0 2.74 1.37 1.37 0 0 1 0-2.74" />
