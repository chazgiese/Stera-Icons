...
type ChevronFullSquareLeftRegularProps = Omit<IconBaseProps, 'children'>;

const ChevronFullSquareLeftRegular = memo(
  forwardRef<SVGSVGElement, ChevronFullSquareLeftRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="chevron-full-square-left" {...props}>
