...
type MinusSquareBoldProps = Omit<IconBaseProps, 'children'>;

const MinusSquareBold = memo(
  forwardRef<SVGSVGElement, MinusSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="minus-square-bold" {...props}>
