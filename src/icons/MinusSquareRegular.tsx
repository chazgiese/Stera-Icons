...
type MinusSquareRegularProps = Omit<IconBaseProps, 'children'>;

const MinusSquareRegular = memo(
  forwardRef<SVGSVGElement, MinusSquareRegularProps>((props, ref) => (
    <IconBase ref={ref} iconName="minus-square" {...props}>
      <path fill="currentColor" d="M16 11.25a.75.75 0 0 1 0 1.5l-8-.01a.75.75 0 0 1 0-1.5z" />
