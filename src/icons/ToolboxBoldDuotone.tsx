  ...
  forwardRef<SVGSVGElement, ToolboxBoldDuotoneProps>((props, ref) => (
    <IconBase ref={ref} iconName="toolbox-bold-duotone" {...props}>
      <path d="M15 12v2H9v-2z" opacity={0.4} />
        ...
        <path fill="currentColor" d="M8 10.5a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0v-3a1 1 0 0 1 1-1M16 10.5a1 1 0 0 1 1 1v3a1 1 0 1 1-2 0v-3a1 1 0 0 1 1-1M14.42 2.5c1.12 0 2.07.82 2.22 1.93L16.87 6h-2.02l-.19-1.29a.25.25 0 0 0-.24-.21H9.58c-.12 0-.23.1-.24.21L9.15 6H7.13l.23-1.57A2.25 2.25 0 0 1 9.58 2.5z" />
    </IconBase>
  ))
);
