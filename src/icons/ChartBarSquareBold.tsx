...
type ChartBarSquareBoldProps = Omit<IconBaseProps, 'children'>;

const ChartBarSquareBold = memo(
  forwardRef<SVGSVGElement, ChartBarSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="chart-bar-square-bold" {...props}>
