...
const CodeSquareBold = memo(
  forwardRef<SVGSVGElement, CodeSquareBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="code-square-bold" {...props}>
      <path fill="currentColor" d="M12.55 7.18a1 1 0 1 1 1.9.64l-3 9a1 1 0 1 1-1.9-.64zM7.3 9.3a1 1 0 1 1 1.4 1.4L7.42 12l1.3 1.3a1 1 0 1 1-1.42 1.4l-2-2a1 1 0 0 1 0-1.4zM15.3 9.3a1 1 0 0 1 1.4 0l2 2a1 1 0 0 1 0 1.4l-2 2a1 1 0 1 1-1.4-1.4l1.29-1.3-1.3-1.3a1 1 0 0 1 0-1.4" />
