...
const CalculatorBold = memo(
  forwardRef<SVGSVGElement, CalculatorBoldProps>((props, ref) => (
    <IconBase ref={ref} iconName="calculator-bold" {...props}>
